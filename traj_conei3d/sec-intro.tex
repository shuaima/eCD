...
\sed enabled line simplification methods have been developed for batch algorithms (\eg Douglas-Peucker based algorithm \dpa-\sed \cite{Meratnia:Spatiotemporal}) and online algorithms (\eg\ \squishe \cite{Muckell:Compression}).
