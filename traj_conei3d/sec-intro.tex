...
%\textcolor{blue}{Hence, it is more challenging to implement such an \sed enabled, linear complexity line simplification algorithm than that a \ped enabled algorithm.}
...
Section 6 summarizes related works and conclusion is in Section 7.
