...
\stitle{{Contributions}}. To this end, we propose two faste one-pass error bounded \lsa algorithms using \sed for compressing trajectories with good compression ratios. % error bounded
