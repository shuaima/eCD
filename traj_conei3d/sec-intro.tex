...
%{For execution time,} 
Algorithms \cist and \cista are on average ($14.21$, $18.19$, $17.06$, $9.98$), ($2.84$, $3.45$, $3.69$, $2.86$) and \textcolor{blue}{($925.25$, $7888.26$, $40041.59$, $8528.76$)} times faster than \dps, \squishe and \textcolor{blue}{the optimal \lsa algorithm} on datasets (\sercar, \geolife, \mopsi, \pricar), respectively.
