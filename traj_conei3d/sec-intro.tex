...
However, these methods still have a high time and/or space complexity, which hinders their utilities in resource-constrained devices. %\cite{Lin:Operb}
