...
\textcolor{blue}{Indeed, a moving object in real life is not necessary moving strictly along a line segment or with a uniform speed, hence, the synchronized data points are virtual points that could be computed easily.}
