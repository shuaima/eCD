...
We propose two one-pass error bounded \lsa algorithms using \sed for compressing trajectories in a fast way and with good compression ratios. % error bounded
