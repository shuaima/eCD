...
our local synchronous distance checking technique. Algorithm \cist belongs strong simplification that only has original points in its output, while algorithm \cista belongs weak simplification that allows interpolated data points in its output.
...
Section 3 presents local synchronous distance checking approach.
Section 4 presents the one-pass error bounded trajectory simplification algorithms \cist and \cista.
