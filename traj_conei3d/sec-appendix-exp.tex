...
\stitle{Exp-4.3: Impacts of distance metrics on efficiency (\ped vs \sed)}.
To evaluate the impacts of distance metrics on execution time, we also fixed {$m$=$16$} and varied $\epsilon$ from $10$ meters to $200$ meters on the entire four datasets, respectively.
