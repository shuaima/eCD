...
\newcommand{\cia}{\kw{SI}}
\newcommand{\cpia}{\kw{RPolyInter}} % convex polygon intersection algorithm
...
\newcommand{\pcircle}[1]{{$\mathcal{O}_c{#1}$}}
...
{X. Lin, J. Jiang, S. Ma \MakeLowercase{\textit{et al.}}: One-Pass Trajectory Simplification Using the Synchronous Euclidean Distance}
