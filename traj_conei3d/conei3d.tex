...
In terms of compression ratio, \cist is comparable with \dps, the existing \sed enabled \lsa algorithm with the distinct compression ratio, and is {$20\%$} better than \squishe on average; and \cista is {$20\%$} and {$40\%$} better than \dps and \squishe, respectively.
\end{abstract}
