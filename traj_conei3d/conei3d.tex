...
In terms of execution time, \cist and \cista are \textcolor[rgb]{1.00,0.00,0.00}{$2.5$ times faster} than \squishe, the fastest existing \sed enabled \lsa algorithm.
