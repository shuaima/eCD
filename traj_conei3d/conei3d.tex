...
\author{Xuelian~Lin,
        ...
        Yimeng~Zuo,
        Chunming~Hu
\IEEEcompsocitemizethanks{\IEEEcompsocthanksitem XL. Lin, JH. Jiang, S. Ma (correspondence), YM. Zuo and CM. Hu are
with SKLSDE lab, School of Computer Science and Engineering, Beihang University, China.\protect\\
...
In terms of compression ratio, \cist is comparable with \dpa, the existing \lsa algorithm with the best compression ratio, and is {$18.9\%$} better than \squishe on average.
\end{abstract}
...
This work is supported in part by NSFC (U1636210), 973 program ({2014CB340300}), NSFC ({61322207\&61421003}), and Beijing Advanced Innovation Center for Big Data and Brain Computing.
