...
In terms of execution time, \cist and \cista are one time more faster than \squishe, the fastest existing \sed enabled \lsa algorithm.
In terms of compression ratio, \cist is comparable with \dps, the existing \sed enabled \lsa algorithm with the distinct compression ratio, and is {$21.3\%$} better than \squishe on average; and \cista is {$19.8\%$} and {$42.5\%$} better than \dps and \squishe, respectively.
\end{abstract}
