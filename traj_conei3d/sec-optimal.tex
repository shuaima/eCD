...
Based on the Spatio-temporal cones and their fast intersection techniques, we develop a fast near optimal trajectory simplification algorithm using \sed, achieving $O(n^2)$ time.
...
%
If the checking of intersection of circles are approximately replaced by the checking of intersection of regular polygons, we get another reachability graph $G'=$ (\trajec{T}, $E')$.
