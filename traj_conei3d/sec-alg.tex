...
\textcolor{blue}{By allowing data interpolations, it extends the radius of the base circles of the spatio-temporal cones in \cist from $\epsilon/2$ to $\epsilon$, so as to get better compression ratios than \cist.}
