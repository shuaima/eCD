...
\stitle{Algorithm \cist}. It takes as input a trajectory $\dddot{\mathcal{T}}$, an error bound $\epsilon$ and the number $m$ of regular polygons, and returns a simplified  piece-wise line representation $\overline{\mathcal{T}}$ of $\dddot{\mathcal{T}}$.
