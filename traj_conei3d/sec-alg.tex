...
It takes as input a trajectory \trajec{T}${[P_0, \ldots, P_n]}$, an error bound $\epsilon$ and the number $m$ of edges for generating inscribed
...
is the directly result of Corollary~\ref{prop-circle-intersection}.
