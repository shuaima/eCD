...
regular polygons, it returns a simplified trajectory $\overline{\mathcal{T}}$,
...
\sstab (1) If $P_{s+k} \in G^*_k$ \wrt $t_c=P_{s+k}.t$, then $Q$ is simply $P_{s+k}$.
