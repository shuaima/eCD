...
\textcolor{blue}{By allowing data interpolation, it extends the radius of the base circles of spatio-temporal cones in \cist from $\epsilon/2$ to $\epsilon$, which leads to better compression ratios than \cist.
