...
\subsection{Near Optimal Simplification}
{\color{blue}
...
point t in \trajec{T} and each edge $(v_r,v_s)$ is in E if and only if the error
...
$\epsilon - graph$ of \trajec{T}. The second step is to find the shortest path
