...
It is worth pointing out that the \cia based algorithms  run in $O(n)$ time and $O(1)$ space, and are one-pass algorithms,
\textcolor{blue}{and it is also obviously that the \cia mechanism is not applicable for \sed.}
