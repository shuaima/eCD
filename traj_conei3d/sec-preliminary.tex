...
\textcolor{blue}{The using of \sed brings poorer compression ratios compared with \ped, however, both spatial and temporal informtion of data points are taken into account \cite{Meratnia:Spatiotemporal}, and the compressed data using \sed is suitable for spatio-temporal queries.}
