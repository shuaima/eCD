...
Then we describe the sector intersection mechanism and show how this mechanism can be used to fast the \lsa algorithms using \ped and why it can not work with \sed.
