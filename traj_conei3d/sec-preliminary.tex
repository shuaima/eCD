...
\hline\hline
 $P$ & A data point \\
\hline
 $\dddot{\mathcal{T}}$ & A trajectory, \ie a sequence of data points\\
\hline
$\mathcal{L}$ & A directed line segment  \\
\hline
$\overline{\mathcal{T}}$&  A piece-wise line representation of trajectory $\dddot{\mathcal{T}}$ \\
\hline
...
\hline
$E^j$ & A group of polygon edges labeled with $j$\\
\hline
\circle{} & The synchronous circle of a point \\
\hline
