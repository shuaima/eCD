...
We then describe the optimal \lsa algorithm and the \textit{sector intersection} mechanism, and show how this mechanism can be used to fast the \lsa algorithms using \ped and why it cannot work with \sed.
