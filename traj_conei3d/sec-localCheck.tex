...
Proposition~\ref{prop-circle-intersection} tells us that the intersection checking of  spatio-temporal cone can be reduced to simply check the intersection of cone projection circles on a plane.
