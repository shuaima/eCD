...
The red dashed circle \pcircle{(P^c_{s+i+1}, r^c_{s+i+1})} on plane ``$t-P_{s+i}.t=0$" in Figure~\ref{fig:cis} is the projection circle of cone \cone{(P_s, \mathcal{O}(P_{s+i+1}, \epsilon))} on the plane.
