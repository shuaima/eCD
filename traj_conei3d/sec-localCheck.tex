...
Let $\mathcal{G}_{s+i}$ ($i\in[1, k]$) be the inscribed regular polygons of the cone projection  circle \pcircle{(P^c_{s+i}, r^c_{s+i})},
and $E^j$ ($j\in[1, m]$) be the group of $k$ edges labeled with $j$ in $\mathcal{G}_{s+i}$ ($i\in[1, k]$).
