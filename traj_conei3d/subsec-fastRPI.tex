...
We then present our faster algorithm for the computation of inscribed regular polygons that makes of the advance rules in terms of Propositions \ref{prop-rule1} and \ref{prop-rule2}.
