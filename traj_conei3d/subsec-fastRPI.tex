...
The intersecton of inscribed regular polygons can be implemented by algorithm \cpia~\cite{ORourke:Intersection} in Figure~\ref{alg:c-poly-inter}. 
...
To achieve this, we develop two extra \emph{advance rules} for the intersection of inscribed regular polygons.
