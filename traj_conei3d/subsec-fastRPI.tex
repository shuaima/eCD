...
\textcolor{blue}{The intersecton of inscribed regular polygons can be implemented by algorithm \cpia~\cite{ORourke:Intersection} in Figure~\ref{alg:c-poly-inter}. }
