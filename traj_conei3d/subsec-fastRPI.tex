...
Recall that \textcolor{blue}{the intersection of inscribed regular polygons can be computed by the convex polygon intersection algorithm \cpia~\cite{ORourke:Intersection} in Figure~\ref{alg:c-poly-inter}. }
...
We then present our faster algorithm for computing the intersection of inscribed regular polygons that makes of the advance rules in terms of Propositions \ref{prop-rule1} and \ref{prop-rule2}.
