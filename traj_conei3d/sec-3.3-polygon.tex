...
%
The presented approximate polygon intersection algorithm is indeed a customized version of the \cpia algorithm.
%
...
In each of these categories, an extension is developed, as follows.
...
\mat{0ex}{
	...
	\icc \>\hspace{3ex} Else \\
	\icc \>\hspace{6ex} {\emph{Moves on $A$ and/or $B$ under rule 3 or 4.}}\\
