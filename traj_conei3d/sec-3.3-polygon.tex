...
This process can be compacted to a one-step moving, \ie directly moving $A$ from Figure~\ref{fig:c-poly-inter}.(1) to Figure~\ref{fig:c-poly-inter}.(5), by the properties of regular polygon.
