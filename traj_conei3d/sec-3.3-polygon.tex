...
\begin{proof}
(1)By equation (4), edge $A$ is indeed moved from the original position to its opposite position \wrt the edge on $\mathcal{G}_{k+1}$ with the same edge group as edge $B$.
