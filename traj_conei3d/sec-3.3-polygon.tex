...
Considering the regular polygons each having a fixed number of edges, marked from $1$ to $M$, we save vertexes or edges of a polygon in a array of fixed size. This policy alow us to quickly address an edge or vertex by its index.
