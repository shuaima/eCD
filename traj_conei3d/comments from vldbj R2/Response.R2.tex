...
We have checked the comments and responses, and confirmed that most comments had been addressed in both response letter and the paper except three comments, \ie~{R2W1}, {R2C7} and {R3C4-2}, that were majorly addressed in response letter only. For R2W1, please refer to R1Ca. We then list R2C7 and R3C4-2 as below for convenience:
\begin{itemize}
...
(1) For {R2C7}, we have clarified the importance of Theorem 8 (Theorem 7 in the revised version) in the begin of Section 4, where the response to R2C7 in the preview response letter is absorbed.

(2) For {R3C4-2}, \textcolor{blue}{we have evaluated a familiar application named ``track playback" under the raw and simplified trajectories. The results are reported in Appendix: Application.}
