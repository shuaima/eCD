...
The results are reported in Figure~\ref{fig:m-poly-time},~\ref{fig:m-time-cist} and ~\ref{fig:m-time-cista}.
...
The results are reported in Figures~\ref{fig:m-cr-cist},~\ref{fig:m-cr-cista},~\ref{fig:m-error-cist} and ~\ref{fig:m-error-cista}.
