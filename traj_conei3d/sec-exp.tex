...
%\vspace{0.5ex}
\ni\emph{(5) Running time}. \cist and \cista are the fastest algorithms. Let $M=20$, they are on average ($17.9$, $12.2$, $15.3$, \textcolor[rgb]{1.00,0.50,0.50}{{$3.7$}}) and {($2.3$, $2.4$, $2.9$, {$2.4$}) times faster than \dps and \squishe on (\truck, \sercar, \geolife, \pricar), respectively.
The efficiency advantage of algorithms \cist and \cista enlarges with the increase of the size of trajectories.
