...
All tests were run on an \textcolor[rgb]{1.00,0.00,0.00}{x64-based  PC with 8 Intel(R) Core(TM) i7-6700 CPU @ 3.40GHz  and 8GB of memory, and each test was repeated
...
\begin{figure*}[tb!]
\centering
\includegraphics[scale = 0.250]{figures/Exp-M-time-truck.png}
\includegraphics[scale = 0.250]{figures/Exp-M-time-service.png}
...
\begin{figure*}[tb!]
\centering
\includegraphics[scale = 0.250]{figures/Exp-M-cr-truck.png}
\includegraphics[scale = 0.250]{figures/Exp-M-cr-service.png}
...
\begin{figure*}[tb!]
\centering
\includegraphics[scale = 0.250]{figures/Exp-M-error-truck.png}
\includegraphics[scale = 0.250]{figures/Exp-M-error-service.png}
