...
%}
%\textcolor{blue}{
%As for efficiency, we use the full dataset, and exclude algorithm \cisto.
%}
...
\begin{figure*}[tb!]
\centering
\includegraphics[scale = 0.28]{Figures/Exp-CR-epsilon-service.png}
\includegraphics[scale = 0.28]{Figures/Exp-CR-epsilon-geolife.png}
\includegraphics[scale = 0.28]{Figures/Exp-CR-epsilon-mopsi.png}
\includegraphics[scale = 0.28]{Figures/Exp-CR-epsilon-private.png}
\vspace{-1ex}
...
\begin{figure*}[tb!]
\centering
\includegraphics[scale = 0.280]{Figures/Exp-CR-size-service.png}
\includegraphics[scale = 0.280]{Figures/Exp-CR-size-geolife.png}
\includegraphics[scale = 0.280]{Figures/Exp-CR-size-mopsi.png}
\includegraphics[scale = 0.280]{Figures/Exp-CR-size-private.png}
\vspace{-1ex}
...
%\vspace{0.5ex}
\stitle{Exp-1.2: Impacts of the error bound $\epsilon$ on compression ratios}.
...
\ni {(3)} \textcolor{blue}{Algorithm \cisto has the best compression ratios in the strong simplification algorithms.}

\ni {(4)} Algorithm \cist is better than \squishe, {comparable} with \dps and worse than \cisto, in term of compression ratios on all datasets and for all $\epsilon$.
The compression ratios of \cist are on average {($79.5\%$, $79.5\%$, $66.0\%$,
$72.7\%$), ($109.1\%$, $109.7\%$, $113.5\%$, $109.2\%$)} and \textcolor{red}{($109.1\%$, $109.7\%$, $113.5\%$, $109.2\%$)} of \squishe,
...
$10.6\%$, $3.5\%$, $3.6\%$), ($14.6\%$, $9.7\%$, $3.1\%$, $3.4\%$)} and \textcolor{red}{($109.1\%$, $109.7\%$, $113.5\%$, $109.2\%$)}
 on  {datasets (\sercar, \geolife, \mopsi, \pricar)}, respectively.

\ni {(5)} Algorithm \cista has better compression ratios than \dpa, \squishe and \cist, and is comparable with \cisto on all datasets and for all $\epsilon$.
The compression ratios of \cista are on average ($57.9\%$, $58.8\%$, $48.4\%$,
$54.6\%$), ($79.6\%$, $81.2\%$, $83.3\%$, $82.1\%$),\textcolor{red}{($57.9\%$, $58.8\%$, $48.4\%$,
...
%\vspace{0.5ex}
\stitle{Exp-1.3: Impacts of trajectory sizes on compression ratios}.
...
\ni(1) The compression ratios of these algorithms from the best to the worst are \cista and \cisto, \dps, \cist and \squishe, on all datasets and for \textcolor{blue}{nearly} all sizes of trajectories. %, which is consistent with Figure~\ref{fig:cr-m16}.
...
\begin{figure*}[tb]
\centering
\includegraphics[scale = 0.280]{Figures/Exp-error-epsilon-service.png}
\includegraphics[scale = 0.280]{Figures/Exp-error-epsilon-geolife.png}
\includegraphics[scale = 0.280]{Figures/Exp-error-epsilon-mopsi.png}
\includegraphics[scale = 0.280]{Figures/Exp-error-epsilon-private.png}
\vspace{-1ex}
...
\begin{figure*}[tb!]
\centering
\includegraphics[scale = 0.280]{Figures/Exp-error-size-service.png}
\includegraphics[scale = 0.280]{Figures/Exp-error-size-geolife.png}
\includegraphics[scale = 0.280]{Figures/Exp-error-size-mopsi.png}
\includegraphics[scale = 0.280]{Figures/Exp-error-size-private.png}
\vspace{-1ex}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\vspace{0.5ex}
\stitle{Exp-2.2: Impacts of the error bound $\epsilon$ on average errors}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\vspace{0.5ex}
\stitle{Exp-2.3: Impacts of trajectory sizes on average errors}.
...
\ni(1) The average errors of these algorithms from the smallest to the largest are \squishe, \dps, \cist, \cisto and \cista, on all datasets and for all trajectory sizes. %, which is consistent with Figure~\ref{fig:ae-m16}.
...
\begin{figure*}[tb!]
	\centering
	\includegraphics[scale = 0.28]{Figures/Exp-M-poly-time-ratio-service.png}
	\includegraphics[scale = 0.28]{Figures/Exp-M-poly-time-ratio-geolife.png}
	\includegraphics[scale = 0.28]{Figures/Exp-M-poly-time-ratio-mopsi.png}
	\includegraphics[scale = 0.28]{Figures/Exp-M-poly-time-ratio-private.png}
	\vspace{-1ex}
...
\begin{figure*}[tb!]
	\centering
	\includegraphics[scale = 0.280]{Figures/Exp-M-e-60-time-service.png}
	\includegraphics[scale = 0.280]{Figures/Exp-M-e-60-time-geolife.png}
	\includegraphics[scale = 0.280]{Figures/Exp-M-e-60-time-mopsi.png}
	\includegraphics[scale = 0.280]{Figures/Exp-M-e-60-time-private.png}
	\vspace{-1ex}
...
\begin{figure*}[tb!]
\centering
\includegraphics[scale = 0.280]{Figures/Exp-time-epsilon-service.png}
\includegraphics[scale = 0.280]{Figures/Exp-time-epsilon-geolife.png}
\includegraphics[scale = 0.280]{Figures/Exp-time-epsilon-mopsi.png}
\includegraphics[scale = 0.280]{Figures/Exp-time-epsilon-private.png}
\vspace{-1ex}
...
\begin{figure*}[tb!]
\centering
\includegraphics[scale = 0.280]{Figures/Exp-time-size-service.png}
\includegraphics[scale = 0.280]{Figures/Exp-time-size-geolife.png}
\includegraphics[scale = 0.280]{Figures/Exp-time-size-mopsi.png}
\includegraphics[scale = 0.280]{Figures/Exp-time-size-private.png}
\vspace{-1ex}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\vspace{0.5ex}
\stitle{{Exp-3.2}:  Impacts of the error bound $\epsilon$ on efficiency.}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\vspace{0.5ex}
\stitle{{Exp-3.3}: Impacts of trajectory sizes on efficiency}.
...
The compression ratios of algorithms \cist, \cisto and \cista are on average ($79.5\%$, $79.5\%$, $66.0\%$, $72.7\%$) \textcolor{red}{($79.5\%$, $79.5\%$, $66.0\%$, $72.7\%$)} and ($57.9\%$, $58.8\%$, $48.4\%$, $54.6\%$) of \squishe
and ($109.1\%$, $109.7\%$, $113.5\%$, $109.2\%$), \textcolor{red}{($79.5\%$, $79.5\%$, $66.0\%$, $72.7\%$)} and ($79.6\%$, $81.2\%$, $83.3\%$, $82.1\%$) of \dps on {datasets} (\sercar, \geolife,\mopsi, \pricar), respectively.
%And They have a better performance on trajectories with higher sampling rates.


%\sstab\emph{(4) Average errors}. {Algorithms \cist,\cisto and \cista all have higher average errors than the other algorithms for the benefit of efficiency, and algorithm \cista has obvious higher average errors than \cist as the former essentially forms spatio-temporal cones with a radius of $\epsilon$.}
...
($14.21$, $18.19$, $4.47$, $9.98$) and ($2.84$, $3.45$, $2.65$, $2.86$) times faster than algorithms \dps and \squishe on {datasets} (\sercar, {\geolife},\mopsi,\pricar), respectively.
