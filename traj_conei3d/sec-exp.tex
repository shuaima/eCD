...
Where, the compression ratio of $M=12$ is average \textcolor[rgb]{1.00,0.00,0.00}{{$100.88\%$}} of $M=20$ on all datasets and for all $\epsilon$.
...
Where, the average error of $M=12$ is average \textcolor[rgb]{1.00,0.00,0.00}{{$98.4\%$}} of $M=20$.
