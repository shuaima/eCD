...
More specially, the compression ratio decreases (a) fast when $M < 12$, (b) slow when $M \in [12, 20]$, and (c) very slow when $M  > 20$.
...
\vspace{-2ex}
\caption{\small Evaluation of running time: fixed error bound with $\epsilon=200m$, and varying $M$.}
