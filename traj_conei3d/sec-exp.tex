...
\vspace{-3ex}
\caption{\small Effectiveness evaluation: Compression ratios.(\cist, \cista, \dpa, \squishe  $\times$ $M = 10, {20}$ )}
\label{fig:cr}
\vspace{-1.0ex}
\end{figure*}
...
\vspace{-3ex}
\caption{\small Effectiveness evaluation: Average errors.(\cist, \cista, \dpa, \squishe  $\times$ $M = 10, {20}$ )}
\label{fig:ae}
\vspace{-1ex}
\end{figure*}
