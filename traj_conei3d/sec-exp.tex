...
\includegraphics[scale = 0.240]{figures/Exp-CR-size-geolife.png}
\includegraphics[scale = 0.240]{figures/Exp-CR-size-private.png}
\vspace{-1ex}
...
\ni (2) \textcolor{blue}{Dataset} \pricar has the lowest compression ratios, compared with \textcolor{blue}{datasets} \truck, \sercar and \geolife, due to its highest sampling rate,
...
The compression ratios of \cist are on average ($91.8\%$, $79.3\%$, $71.9\%$, {$72.7\%$}) and ($113.2\%$, $109.2\%$, $108.0\%$, $109.1\%$) of \squishe and \dps on \textcolor{blue}{datasets} (\truck, \sercar, \geolife, \pricar), respectively.
For example, when $\epsilon$ = $40$ meters, the compression ratios of algorithms \squishe, \cist and \dps are ($31.3\%$, $19.9\%$, $8.0\%$, $4.9\%$), ($30.0\%$, $16.1\%$, $5.8\%$, $3.6\%$) and ($26.9\%$, $14.7\%$, $5.4\%$, $3.4\%$) on \textcolor{blue}{datasets} (\truck, \sercar, \geolife, \pricar), respectively.

\ni {(4)} Algorithm \cista has {the best} compression ratios on all datasets and for all $\epsilon$.
The compression ratios of \cista are on average ($64.4\%$, $57.7\%$, $53.8\%$, {$54.6\%$}) and ($79.2\%$, $79.5\%$, $80.9\%$, $82.0\%$) of algorithms \squishe and \dps on \textcolor{blue}{datasets} (\truck, \sercar, \geolife, \pricar), respectively.
For example, when $\epsilon$ = $40$ meters, the compression ratios of algorithm \cista are ($21.8\%$, $11.5\%$, $4.3\%$, $2.7\%$) on \textcolor{blue}{datasets} (\truck, \sercar, \geolife, \pricar), respectively.
...
\begin{figure*}[tb!]
\centering
\includegraphics[scale = 0.240]{figures/Exp-time-size-truck.png}
\includegraphics[scale = 0.240]{figures/Exp-time-size-service.png}
\includegraphics[scale = 0.240]{figures/Exp-time-size-geolife.png}
\includegraphics[scale = 0.240]{figures/Exp-time-size-private.png}
\vspace{-1ex}
