...
fixed {$M$=$16$} and $\epsilon$=$60m$, and varying the size \trajec{|T|} of trajectories from $1K$ points to $10K$ points.
%
...
We fixed {$M$=$16$} and $\epsilon = 60m$, and varying the size \trajec{|T|} of trajectories from $1K$ points to $10K$ points.
%
...
\ni(3) The execution time of algorithm \cpia and algorithm \rpia are on average $(92.5\%, 93.5\%, 96.0\%, 97.0\%)$ and  $(89.0\%, 90.5\%, 92.5\%, 96.5\%)$ of the entire compression on (\truck, \sercar, \geolife, \pricar), respectively.
...
%\vspace{0.5ex}
\ni\emph{(5) Running time}. \cist and \cista are on average ($20.7$, $14.2$, $18.2$, $10.0$) times faster than \dps, and ($2.7$, $2.8$, $3.4$, {$2.9$}) times faster than \squishe on (\truck, \sercar, {\geolife}, \pricar), respectively.The efficiency advantage of \cist and \cista enlarges with the increase of the size of trajectories.
