...
Where, the compression ratio of $M=10$ is average \textcolor[rgb]{1.00,0.00,0.00}{$101.263730\%$} of $M=20$.
...
For all $\epsilon$, the compression ratios of \cist are on average ($112.9\%$, $108.8\%$, $107.6\%$, $108.7\%$) and ($91.5\%$, $79.1\%$, $71.6\%$, {$72.5\%$}) of \dpa and \squishe on (\truck, \sercar, \geolife, \pricar), respectively.
For example, when $\epsilon = 40m$, the compression ratios are ($26.9\%$, $14.7\%$, $5.4\%$, $3.4\%$), ($29.9\%$, $16.0\%$, $5.8\%$, $3.6\%$) and ($31.3\%$, $19.9\%$, $8.0\%$, $4.9\%$) of \dpa, \cist and \squishe on (\truck, \sercar, \geolife, \pricar), respectively.
...
For all $\epsilon$, the compression ratios of \cista are on average ($79.0\%$, $79.3\%$, $80.7\%$, $81.7\%$) and ($64.3\%$, $57.6\%$, $53.7\%$, {$54.4\%$}) of \dpa and \squishe on (\truck, \sercar, \geolife, \pricar), respectively.
...
Where, the average error of $M=10$ is average \textcolor[rgb]{1.00,0.00,0.00}{$97.5\%$} of $M=20$.
...
\cist and \cista are on average ($17.9$, $12.2$, $15.3$, {$3.7$}) times faster than \dpa, and {($2.3$, $2.4$, $2.9$, {$2.4$}) times faster} than \squishe on (\truck, \sercar, {\geolife}, \pricar), respectively.
...
\ni\textcolor[rgb]{1.00,0.00,0.00}{(2)} Algorithms \cist and \cista are the fastest \sed enabled \lsa algorithms, and are {($6.3$--$10.1$, $4.0$--$6.7$, $2.4$--$7.0$, $3.5$--$6.3$)} times faster than \dpa,
...
%\vspace{0.5ex}
\ni\emph{\textcolor[rgb]{1.00,0.00,0.00}{(3)} Compression ratios}. \cist is comparable with \dps and \cista is better than \dps. The compression ratios of \cist and \cista are on average ($91.5\%$, $79.1\%$, $71.6\%$, {$72.5\%$}) and ($64.3\%$, $57.6\%$, $53.7\%$, {$54.4\%$}) of \squishe and ($112.9\%$, $108.8\%$, $107.6\%$, $108.7\%$) and ($79.0\%$, $79.3\%$, $80.7\%$, $81.7\%$) of \dps on (\truck, \sercar, \geolife, \pricar), respectively.
...
%\vspace{0.5ex}
\ni\emph{(5) Running time}. \cist and \cista are the fastest algorithms, which are on average ($17.9$, $12.2$, $15.3$, {$3.7$}) times faster than \dps, and {($2.3$, $2.4$, $2.9$, {$2.4$}) times faster than \squishe on (\truck, \sercar, \geolife, \pricar), respectively. The efficiency advantage of algorithm \cist and \cista enlarges with the increase of the size of trajectories.
