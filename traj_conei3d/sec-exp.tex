...
\ni(3) When varying $m$, the compression ratios of algorithms \cist and \cista decrease (a) fast when $m < 12$, (b) slowly when $m \in [12, 20]$, and (c) very slow when $m > 20$. Hence, \emph{the region range of $[12, 20]$ is the good candidate region for $m$ in terms of compression ratios.}
