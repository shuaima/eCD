...
%\vspace{0.5ex}
\ni\emph{\textcolor[rgb]{1.00,0.00,0.00}{(3)} Compression ratios}. \cist is comparable with \dps and \cista is better than \dps. The compression ratios of \cist and \cista are on average ($92.3\%$, $80.0\%$, $72.4\%$, {$73.5\%$}) and ($92.3\%$, $80.0\%$, $72.4\%$, {$73.5\%$}) of \squishe and ($114.7\%$, $110.6\%$, $109.0\%$, $110.7\%$) and ($114.7\%$, $110.6\%$, $109.0\%$, $110.7\%$) of \dps on (\truck, \sercar, \geolife, \pricar), respectively. 
...
%\vspace{0.5ex}
\ni\emph{(5) Running time}. \cist and \cista are the fastest algorithms, which are on average ($13.5$, $9.6$, $11.8$, {$2.8$}) times faster than \dps, and {($1.7$, $1.8$, $2.2$, {$1.7$}) times faster than \squishe on (\truck, \sercar, \geolife, \pricar), respectively. The efficiency advantage of algorithm \cist and \cista enlarges with the increase of the size of trajectories.
