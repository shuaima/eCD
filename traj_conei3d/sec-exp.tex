...
\sstab \emph{(1) Datasets}. In almost all the tests, the behaviors of all algorithms across all datasets are quite similar, \eg the compression ratio of each algorithm has approximately an exponential relation to $\epsilon$ and the average error of each algorithm has a linear relation to $\epsilon$.
