...
\includegraphics[scale = 0.24]{figures/Exp-M-time-service.png}
...
\begin{figure*}[tb!]
\centering
\includegraphics[scale = 0.24]{figures/Exp-M-cr-truck.png}
\includegraphics[scale = 0.24]{figures/Exp-M-cr-service.png}
...
\begin{figure*}[tb!]
\centering
\includegraphics[scale = 0.24]{figures/Exp-M-error-truck.png}
\includegraphics[scale = 0.24]{figures/Exp-M-error-service.png}
...
\stitle{Exp-1: Impacts of parameter $M$ on efficiency.}
...
\stitle{Exp-2: Impacts of parameter $M$ on effectiveness}.
...
CR: (\textcolor[rgb]{0.00,0.07,1.00}{curves: 2 algorithms \cista- \rpia and \cista- \cpia $\times$  three $\epsilon = 20, 80, 200$}).
...
CR: (\textcolor[rgb]{0.00,0.07,1.00}{curves: four algorithms \cist, \cista, \dpa, \squishe  $\times$  three $M = 10, {20}$ ? }).
...
\includegraphics[scale = 0.24]{figures/Exp-error-epsilon-geolife.png}
\includegraphics[scale = 0.24]{figures/Exp-error-epsilon-private.png}
\vspace{-3ex}
...
\includegraphics[scale = 0.24]{figures/Exp-time-size-geolife.png}
\includegraphics[scale = 0.24]{figures/Exp-time-size-private.png}
\vspace{-3ex}
