...
\textcolor{blue}{\osed~is ``optimal" in compression ratio, not in error. Actually, it has the worst average error among all strong line simplification algorithms. Also, better compression ratios are usually accompanied with larger errors.}
