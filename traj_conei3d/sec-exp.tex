...
%\vspace{-1ex}
\caption{\small Evaluation of compression ratios: fixed with $m=16$ and varying
  error bound $\epsilon$(compare ped with sed).}
\label{fig:cr-m16-ped}
%\vspace{-1.0ex}
\end{figure*}
...
\stitle{Exp-1.5: Impacts of distance metrics on compression ratios (\ped vs \sed)}.

\textcolor{red}{Jiangjh: four lines: DP-PED, DP-SED, CISED, Sleeve}
...
\begin{figure*}[tb]
	...
	%\vspace{-1ex}
	\caption{\small Evaluation of average errors: fixed with $m=16$ and varying
    error bound $\epsilon$(compare ped with sed).}
	\label{fig:ae-m16-ped}
	%\vspace{-1ex}
\end{figure*}
...
\stitle{Exp-2.5: Impacts of distance metrics on average errors (\ped vs \sed)}.
...
%\vspace{-1ex}
\caption{\small Evaluation of running time: fixed with $m=16$ and varying error
  bounds $\epsilon$(compare ped with sed).}
\label{fig:time-epsilon-ped}
%\vspace{-1ex}
\end{figure*}
...
\stitle{Exp-3.5: Impacts of distance metrics on efficiency (\ped vs \sed)}.
\textcolor{red}{Jiangjh: four lines: DP-PED, DP-SED, CISED, Sleeve}
