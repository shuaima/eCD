...
\ni {(3)} \textcolor{blue}{Algorithm \cisto has better compression ratios than other algorithms except \cista.}

\ni {(4)} Algorithm \cist has better compression ratios than \squishe, is {comparable} with \dps and is worse than \cisto, on all datasets and for all $\epsilon$.
...
\ni(2) Algorithms \cist,\cisto and \cista have lager average errors compared with \dps and \squishe.
...
\textcolor{blue}{Algorithm \cisto is more than ten times slower than other algorithms including \dpa. It is not necessary to report its detailed running time.}
