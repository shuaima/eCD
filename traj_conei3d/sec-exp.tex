...
%
 This is because algorithm CISED-W allows data interpolations, thus by Proposition \ref{prop-circle-intersection}, it extends the radius of the base circles of the spatio-temporal cones from $\epsilon/2$ in CISED-S to $\epsilon$ in CISED-W to contain more points.
