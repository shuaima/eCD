...
\begin{figure*}[tb!]
\centering
\includegraphics[scale = 0.275]{Figures/Exp-CR-epsilon-service.png}\hspace{3ex}
\includegraphics[scale = 0.275]{Figures/Exp-CR-epsilon-geolife.png}\hspace{3ex}
\includegraphics[scale = 0.275]{Figures/Exp-CR-epsilon-mopsi.png}\hspace{3ex}
\includegraphics[scale = 0.275]{Figures/Exp-CR-epsilon-private.png}
%\vspace{-1ex}
...
\includegraphics[scale = 0.2750]{Figures/Exp-CR-size-mopsi.png}\hspace{3ex}
\includegraphics[scale = 0.2750]{Figures/Exp-CR-size-private.png}
%\vspace{-1ex}
...
%\vspace{0.5ex}
\stitle{Exp-1.2: Impacts of the error bound $\epsilon$ on compression ratios (VS. \dps and \squishe)}.
...
\ni {(3)} Algorithm \cist is better than \squishe {and comparable} with \dps on all datasets and for all $\epsilon$.
...
To evaluate the impacts of error bound $\epsilon$ on compression ratios, we fixed {$m$=$16$}, the middle of $[12, 20]$, and varied $\epsilon$ from $10$ to $200$ meters on the first $1K$ points of a trajectory of the selected 10 trajectories on four datasets, respectively.
...
\ni {(2)} Algorithm \cista is comparable with the optimal algorithm on all datasets and for all $\epsilon$.
...
\ni(1) The compression ratios of these algorithms from the best to the worst are \cista, \dps, \cist and \squishe, on all datasets and for \textcolor{blue}{nearly} all sizes of trajectories. %, which is consistent with Figure~\ref{fig:cr-m16}.
...
\begin{figure*}[tb!]
	...
	\includegraphics[scale = 0.2750]{Figures/Exp-M-e-60-error-mopsi.png}\hspace{3ex}
	\includegraphics[scale = 0.2750]{Figures/Exp-M-e-60-error-private.png}
	%\vspace{-1ex}
...
\begin{figure*}[tb]
	\centering
	\includegraphics[scale = 0.2750]{Figures/Exp-error-epsilon-service.png}\hspace{3ex}
	\includegraphics[scale = 0.2750]{Figures/Exp-error-epsilon-geolife.png}\hspace{3ex}
	\includegraphics[scale = 0.2750]{Figures/Exp-error-epsilon-mopsi.png}\hspace{3ex}
	\includegraphics[scale = 0.2750]{Figures/Exp-error-epsilon-private.png}
	%\vspace{-1ex}
...
\begin{figure*}[tb]
	\centering
	\includegraphics[scale = 0.2750]{Figures/Exp-opt-error-epsilon-service.png}\hspace{3ex}
	\includegraphics[scale = 0.2750]{Figures/Exp-opt-error-epsilon-geolife.png}\hspace{3ex}
...
\begin{figure*}[tb!]
	...
	\includegraphics[scale = 0.2750]{Figures/Exp-error-size-mopsi.png}\hspace{3ex}
	\includegraphics[scale = 0.2750]{Figures/Exp-error-size-private.png}
	%\vspace{-1ex}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\vspace{0.5ex}
\stitle{Exp-2.2: Impacts of the error bound $\epsilon$ on average errors (VS. \dps and \squishe)}.
...
To evaluate the average errors of these algorithms, we fixed {$m$=$16$}, and
varied $\epsilon$ from $10$ meters to $200$ meters on the first $1K$ points of a trajectory of the selected 10 trajectories on four datasets, respectively. 
...
\begin{figure*}[tb!]
	...
	\includegraphics[scale = 0.275]{Figures/Exp-M-poly-time-ratio-private.png}
%	\vspace{-1ex}
...
\begin{figure*}[tb!]
	\centering
	\includegraphics[scale = 0.275]{Figures/Exp-M-e-60-time-service.png}\hspace{3ex}
	\includegraphics[scale = 0.275]{Figures/Exp-M-e-60-time-geolife.png}\hspace{3ex}
	\includegraphics[scale = 0.275]{Figures/Exp-M-e-60-time-mopsi.png}\hspace{3ex}
	\includegraphics[scale = 0.275]{Figures/Exp-M-e-60-time-private.png}
%	\vspace{-1ex}
...
\includegraphics[scale = 0.275]{Figures/Exp-time-epsilon-mopsi.png}\hspace{3ex}
\includegraphics[scale = 0.275]{Figures/Exp-time-epsilon-private.png}
%\vspace{-1ex}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\vspace{0.5ex}
\stitle{{Exp-3.2}:  Impacts of the error bound $\epsilon$ on efficiency (VS. \dps and \squishe).}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\vspace{0.5ex}
\stitle{{Exp-3.3}: Impacts of the error bound $\epsilon$ on efficiency (VS. The optimal algorithm).}
To evaluate the impacts of $\epsilon$ on efficiency, we fixed $m$ = $16$,
and varied $\epsilon$ from $10$ meters to $200$ meters on the first $1K$ points of a trajectory of the selected 10 trajectories on four datasets, respectively.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\vspace{0.5ex}
\stitle{{Exp-3.4}: Impacts of trajectory sizes on efficiency}.
