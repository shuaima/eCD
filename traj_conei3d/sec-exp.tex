...
\textcolor{blue}{The near optimal algorithm \cisto is the slowest and is more than ten times slower than other algorithms including \dpa on all datasets and for all $\epsilon$. It is not necessary to report all the detailed running time of \cisto in this section.}
