...
\begin{figure*}[tb!]
\centering
\includegraphics[scale = 0.3]{Figures/Exp-opt-CR-epsilon-service.png}
\includegraphics[scale = 0.3]{Figures/Exp-opt-CR-epsilon-geolife.png}
\includegraphics[scale = 0.3]{Figures/Exp-opt-CR-epsilon-mopsi.png}
\includegraphics[scale = 0.3]{Figures/Exp-opt-CR-epsilon-private.png}
%\vspace{-1ex}
\caption{\small Evaluation of compression ratios: fixed with $m=16$ and varying error bound $\epsilon$.}
...
$54.6\%$), ($79.6\%$, $81.2\%$, $83.3\%$, $82.1\%$) and {($73.0\%$,
  $74.0\%$, $73.4\%$, $75.1\%$) of algorithms
...
%\vspace{0.5ex}
\stitle{Exp-1.3: \textcolor{red}{Impacts of the error bound $\epsilon$ on compression ratios (VS. the optimal algorithm)}}.
...
The compression ratios of \cist are on average ($134.3\%$, $133.3\%$, $148.4\%$, $135.4\%$) of the optimal algorithm on {datasets (\sercar, \geolife, \mopsi, \pricar)}, respectively.
For example, when $\epsilon$ = $40$ meters, the compression ratios of algorithms
\cist and the optimal are 
($15.9\%$,$10.6\%$, $3.5\%$, $3.6\%$) and {($12.2\%$, $8.1\%$, $2.4\%$, $2.6\%$)}
...
The compression ratios of \cista are on average  ($98.1\%$,	$98.7\%$, $108.9\%$, $101.7\%$)} of the optimal algorithm
 on {datasets (\sercar, \geolife, \mopsi, \pricar)}, respectively.
For example, when $\epsilon$ = $40$ meters, the compression ratios of algorithm
\cista are ($11.4\%$, $7.8\%$, $2.5\%$, $2.7\%$) on datasets (\sercar, \geolife,\mopsi, \pricar), respectively.

\stitle{Exp-1.4: Impacts of trajectory sizes on compression ratios (VS. \dps and \squishe)}.
...
\begin{figure*}[tb]
	\centering
	\includegraphics[scale = 0.30]{Figures/Exp-opt-error-epsilon-service.png}
	\includegraphics[scale = 0.30]{Figures/Exp-opt-error-epsilon-geolife.png}
	\includegraphics[scale = 0.30]{Figures/Exp-opt-error-epsilon-mopsi.png}
	\includegraphics[scale = 0.30]{Figures/Exp-opt-error-epsilon-private.png}
	%\vspace{-1ex}
	\caption{\small Evaluation of average errors: fixed with $m=16$ and varying error bound $\epsilon$.}
...
of \dps and ($188.5\%$, $181.7\%$, $228.1\%$, $214.3\%$) and 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\vspace{0.5ex}
\stitle{Exp-2.3: \textcolor{red}{Impacts of the error bound $\epsilon$ on average errors (VS. The optimal algorithm)}}.
To evaluate the average errors of these algorithms, we fixed {$m$=$16$}, and
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\vspace{0.5ex}
\stitle{Exp-2.4: Impacts of trajectory sizes on average errors (VS. \dps and \squishe)}.
...
\begin{figure*}[tb!]
\centering
\includegraphics[scale = 0.30]{Figures/Exp-opt-time-epsilon-service.png}
\includegraphics[scale = 0.30]{Figures/Exp-opt-time-epsilon-geolife.png}
\includegraphics[scale = 0.30]{Figures/Exp-opt-time-epsilon-mopsi.png}
\includegraphics[scale = 0.30]{Figures/Exp-opt-time-epsilon-private.png}
%\vspace{-1ex}
\caption{\small Evaluation of running time: fixed with $m=16$ and varying error bounds $\epsilon$.}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\vspace{0.5ex}
\stitle{{Exp-3.3}:  \textcolor{red}{Impacts of the error bound $\epsilon$ on efficiency (VS. The optimal algorithm).}}
To evaluate the impacts of $\epsilon$ on efficiency, we fixed $m$ = $16$,
...
They are on average ($14.21$, $18.19$, $17.06$, $9.98$) times faster than the optimal algorithm on
{datasets} ( \sercar, {\geolife},\mopsi, \pricar), respectively.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\vspace{0.5ex}
\stitle{{Exp-3.4}: Impacts of trajectory sizes on efficiency (VS. \dps and \squishe)}.
