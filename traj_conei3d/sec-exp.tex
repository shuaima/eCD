...
\vspace{0.5ex}
\ni \emph{(1) Mopsi trajectory data} (\mopsi) is the GPS trajectories collected by \eat{10,368} trucks equipped with GPS sensors in China
...
$90.5\%$, $92.5\%$, $96.5\%$)} of the entire compression  time on {datasets}
