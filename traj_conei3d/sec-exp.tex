...
\textcolor{blue}{For the optimal \lsa algorithm, because it has both high time and space complexities, \ie $O(n^3)$ time and $O(n^2)$ space, it is just impossible to run it on the entire datasets (resulting in out of memory). Hence, we also build four \textit{small datasets} for it, each dataset includes 10 middle-size trajectories selected from the corresponding dataset.}
...
%\vspace{0.5ex}
\stitle{\textcolor{blue}{Exp-1.3: Impacts of the error bound $\epsilon$ on compression ratios (VS. The optimal algorithm)}.}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\vspace{0.5ex}
\stitle{\textcolor{blue}{Exp-2.3: Impacts of the error bound $\epsilon$ on average errors (VS. The optimal algorithm)}.}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\vspace{0.5ex}
\stitle{\textcolor{blue}{Exp-3.3: Impacts of the error bound $\epsilon$ on efficiency (VS. The optimal algorithm)}.}
...
\sstab\emph{(5) Running time}. \textcolor{blue}{Algorithms \cist and \cista are the fastest.} They are on average
