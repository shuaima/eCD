...
In particular, the state-of-the-art sub-optimal line simplification approaches fall into three categories, \ie \emph{batch algorithms}, \emph{online algorithms} and \emph{one-pass algorithms}.
