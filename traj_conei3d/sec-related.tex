...
\textcolor{blue}{\ped and \sed are the most commonly used metric in trajectory simplification. The former usually brings better compression ratios while the later reserves temporal information in the result trajectories.}

\textcolor{blue}{We next introduce the related work on piece-wise line based trajectory compression from two aspects: optimal methods and sub-optimal methods}.
...
{However, both LISSED and ISSED are cumulative errors which have different effectiveness compared with \sed.}
