...
\textcolor{blue}{\ped and \sed are the most commonly used metric in trajectory simplification. The former usually brings a better compression ratios while the later reserves temporal information in the result trajectories.}
