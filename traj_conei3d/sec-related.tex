...
%
It is worth pointing out that the sector intersection algorithms\cite{Williams:Longest, Sklansky:Cone, Dunham:Cone, Zhao:Sleeve}, and algorithms \fbqsa~\cite{Liu:BQS} and \operb \cite{Lin:Operb}, all use the \ped, %perpendicular Euclidean distances,
