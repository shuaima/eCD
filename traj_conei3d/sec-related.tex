...
Then a new distance metric, the synchronous Euclidean distances (\sed), was developed after the \lsa algorithms were introduced to compress trajectory.}
...
\textcolor{blue}{
There are also semantics based trajectory compression methods that are orthogonal to line simplification based methods (see~\cite{Lin:Operb, Han:Compress} for more details), and these methods may be combined with each other to further improve the effectiveness of trajectory compression.}
