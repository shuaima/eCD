...
{The paper has been revised according to the comments of Reviewer \#4. In particular, we have pointed out that the  ``optimal'' LS algorithm is compression optimal and added explanations on this algorithm in Section 5.2.2.
...
We have also added explanations on this algorithm in Section 5.2.2.
