...
{The paper has been revised according to the comments of referees. In particular, we have renamed ``Optimal LS Algorithm" as ``Compression Optimal LS algorithm" and added some explanation about this algorithm in Section 5.2.2.
...
We have also added some explanation about this algorithm in Section 5.2.2.
Thanks!
