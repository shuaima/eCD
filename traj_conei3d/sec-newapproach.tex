...
%\end{definition}
In Figure~\ref{fig:sed3d}, \eg point $P_i$ has a synchronous circles $\mathcal{O}(P_i, \epsilon)$. Any point $P'_i$ in the circle has a distance to $P_i$, \ie $|P_iP'_i|$, less than $\epsilon$.
