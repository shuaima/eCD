...
\section{Local One-Pass Distances Checking}

In this section, we first analyze the properties of synchronized points and \sed, then we present a local one-pass \sed checking method by extending the cone intersection for \ped checking in Section~\ref{sub-ci-ped}.
