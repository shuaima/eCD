...
%
After 7 steps of moving of $\vv{A}$ or $\vv{B}$, edges $\vv{A}$ and $\vv{B}$ intersect on point $P_2$  as shown in Figure~\ref{fig:c-poly-inter}.(3).
%
Then edge $\vv{B}$ moves on a step, and makes $\vv{A} \bigcap \vv{B} = \emptyset$ as shown in Figure~\ref{fig:c-poly-inter}.(4). After 6 steps of moving of edge $\vv{B}$ or $\vv{A}$, both edges $\vv{A}$ and $\vv{B}$ have finished their cycles as shown in Figure~\ref{fig:c-poly-inter}.(5).
%
