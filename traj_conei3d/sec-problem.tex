...
%
After 7 steps of moving of $\vv{A}$ or $\vv{B}$ as the similar routine of above, edges $\vv{A}$ and $\vv{B}$ intersect on point $P_2$  as shown in Figure~\ref{fig:c-poly-inter}.(3).
%
Then edge $\vv{B}$ moves on a step, and makes $\vv{A} \bigcap \vv{B} = \emptyset$ as shown in Figure~\ref{fig:c-poly-inter}.(4). 
