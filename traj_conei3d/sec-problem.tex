...
We \textcolor[rgb]{0.00,0.07,1.00}{optimize} a convex polygon intersection algorithm based on the one in~\cite{ORourke:Intersection}, which is shown in Figure~\ref{alg:c-poly-inter}.
