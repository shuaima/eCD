...
Yes have fixed these grammatical mistakes, and refined our paper.
...
Theorem 8 clearly tells the contribution of our paper, and the techniques developed are nontrivial at all.
...
Yes, we have added a comment on this in the summary (the first bullet) in Section 5.2. Thanks for the suggestions!
...
good compression ratios at the same time. Also note
that CISED-W may output data points not from the
input data points.
...
Finally, different applications many have different requirements to reach a balance among multiple metrics, and we concentrate on designing the algorithm and testing it with common metrics in this work, and let the application developers/users to decide which algorithm to choose.
