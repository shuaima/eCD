...
\author{
Shuai Ma$^1$\hspace{5ex}   Liang Duan$^1$\hspace{5ex} Wenfei Fan$^{1, 2}$\hspace{5ex}  Chunming Hu$^1$\\
\vspace{0.3ex}
$^1$ SKLSDE lab, Beihang University, China\\
$^2$ University of Edinburgh, UK\\
\vspace{0.3ex}
\{mashuai, duanl, hucm\}@buaa.edu.cn \hspace{5ex} wenfei@inf.ed.ac.uk
}
\date{}
%\pagestyle{plain} % for adding page number
...
\stitle{Acknowledgments}.  Ma is supported in part by  NSFC {\small 61322207}, NGFR 973 {\small 2014CB340300}, and  SRF for ROCS, SEM.
