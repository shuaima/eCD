...
\author{
Shuai Ma\hspace{5ex}   Liang Duan\hspace{5ex} Wenfei Fan\hspace{5ex}  Chunming Hu \\
\vspace{0.3ex}
...
({\CINDs}~\cite{CINDs}), denoted by {\pCFDs} and \pCINDs, respectively,
...
\stitle{Acknowledgments}.  Ma is supported in part by  NSFC {\small 61322207}, NGFR 973 {\small 2014CB340304}, and  SRF for ROCS, SEM.
