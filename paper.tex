...
\author{Shuai~Ma,~\IEEEmembership{Senior Member,~IEEE,}
        Liang~Duan,
        Wenfei~Fan,
        and~Chunming~Hu% <-this % stops a space
\IEEEcompsocitemizethanks{\IEEEcompsocthanksitem S. Ma, L. Duan and C. Hu are with the SKLSDE lab, the School of Computer Science and Engineering, Beihang University, China.\protect\\
% note need leading \protect in front of \\ to get a newline within \thanks as
% \\ is fragile and will error, could use \hfil\break instead.
E-mail: \{mashuai, duanl, hucm\}@buaa.edu.cn.
\IEEEcompsocthanksitem W. Fan is the RCBD center, Beihang University, China and the School of Informatics, Edinburgh University, UK.\protect\\
...
({\CFDs}~\cite{CFDs}) and conditional inclusion dependencies
({\CINDs}~\cite{tcs-CINDs}), denoted by {\pCFDs} and \pCINDs, respectively,
by specifying patterns of data values with $\ne, <, \le, >$ and
$\ge$ predicates.
As data quality rules, {\pCFDs} and \pCINDs are able to capture
errors that commonly arise in practice but cannot be detected
by \CFDs and \CINDs.
We establish two sets of results for central technical
problems associated with {\pCFDs} and \pCINDs.
(a) One concerns the satisfiability and implication problems for {\pCFDs} and
\pCINDs, taken  separately or together. These are important for, \eg deciding
whether data quality rules are dirty themselves, and for removing
redundant rules.
We show that despite the increased expressive power,
the static analyses of  {\pCFDs} and \pCINDs retain the same complexity
as their \CFDs and \CINDs counterparts.
%in the absence of finite domain attributes.
(b) The other concerns validation of {\pCFDs} and \pCINDs.
We show that given a set $\Sigma$ of {\pCFDs} and \pCINDs on a database $D$,
...
of $\Sigma$. }%EAT
This provides
commercial \rdms with an immediate capability to detect errors
based on {\pCFDs} and \pCINDs.
%\keywords{\vspace{-1ex}functional dependency, inclusion dependency, data quality}
%databases %computational complexities, data quality,
\end{abstract}

% Note that keywords are not normally used for peerreview papers.
\begin{IEEEkeywords}
Conditional dependencies, built-in predicates, reasoning, detection
\end{IEEEkeywords}}
...
\section*{Acknowledgments}
 Ma is supported in part by  973 program ({\small No. 2014CB340300}) and NSFC ({\small No. 61322207}).
Fan is supported in part by 973
Programs {\small 2012CB316200} and
{\small 2014CB340302}, {\small NSFC 61133002},
Guangdong Innovative Research Team Program
{\small 2011D005} and Shenzhen Peacock Program
{\small 1105100030834361}  of China,
as well as {\small EPSRC EP/J015377/1, UK}.
