...
This work is supported in part by  973 program ({\small No. 2014CB340300}) and NSFC ({\small No. 61322207}).
Fan is supported in part by 973
Program ({\small No. 2012CB316200}), NSFC ({\small No. 61133002}),
Guangdong Innovative Research Team Program
({\small 2011D005}), Shenzhen Peacock Program
({\small 1105100030834361}) of China, and EPSRC ({\small  EP/J015377/1) of UK.
...
\vspace{-6ex}
\begin{IEEEbiography}{Shuai Ma} is currently a professor at the School of Computer Science and Engineering, Beihang University.
...
He is a recipient of the Best Paper Award for VLDB 2010,  and the Best Challenge Paper Award for WISE 2013. His  research interests include database theory and systems, social data analysis and data intensive computing. 
\end{IEEEbiography}
\vspace{-6ex}
\begin{IEEEbiography}{Liang Duan} is currently a PhD student in the School of Computer Science and Engineering, Beihang University, supervised by Prof. Shuai Ma. He received his MS degree in computer software and theory from Yunnan University in 2014, and BS degree in computer science and technology from Beihang University in 2009. His research interests lie in the areas of databases and social data analysis.
\end{IEEEbiography}
\vspace{-6ex}
\begin{IEEEbiography}{Wenfei Fan} is currently Professor (Chair) of Web Data Management in
...
Yangtze River Scholar, China.  He received his PhD from the
...
theory and systems, in particular data quality, data
integration, distributed query processing, query languages,
recommender systems, social networks and Web services.
\end{IEEEbiography}
\vspace{-6ex}
\begin{IEEEbiography}{Chunming Hu} is currently Professor (Chair) of Web Data Management in
the School of Informatics, University of Edinburgh, UK.
He is a Fellow of the Royal Society of Edinburgh, UK,  a
National Professor of the Thousand-Talent Program and a
Yangtze River Scholar, China.
\end{IEEEbiography}
\vspace{-6ex}
\begin{IEEEbiography}{Wenguang Chen} is currently a Professor at the Department of Computer Science, School of Electronic Engineering and Computer Science, Peking University. He obtained his PhD degree from Peking University in 2009.  His research interests include database theory and systems, and social data analysis.
\end{IEEEbiography}
\vfill
