...
\stitle{Proof of Proposition~\ref{pro-sketch-graph}}: We show this by contradiction. Assume first there is a cycle $B_1, v_1, B_2, v_2, \ldots$, $B_k, v_k, B_1$ in a sketch graph $\mathbb{G}$ of graph $G$,
