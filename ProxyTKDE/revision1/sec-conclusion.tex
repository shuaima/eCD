...
%
%First, we are to extend \metis~\cite{Karypis98} with optimization techniques to further reduce the number of boundary nodes.
%
We are to extend our techniques for dynamic graphs, as real-life networks are typically dynamic~\cite{fcs-biggraph}.
%
%extend our techniques for other types real-life datasets that could be modeled as weighted undirected graphs, \eg social networks.
%
