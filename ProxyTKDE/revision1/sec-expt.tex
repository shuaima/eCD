...
\hline
                                &  \multicolumn{1}{c|}{Proxies}   &  \multicolumn{1}{c|}{Nodes in \dras}  & \multicolumn{1}{c|}{Extra $\spacec$} & \multicolumn{1}{c|}{Space of $G$} & \multicolumn{1}{c|}{Space of $G'$} & \multicolumn{1}{c|}{$\timec$}\\
  \raisebox{1.5ex}[0pt]{Graphs} &  \multicolumn{1}{c|}{(\#, \%)}  &  \multicolumn{1}{c|}{(\#, \%)}  & \multicolumn{1}{c|}{(MB)} & \multicolumn{1}{c|}{(MB)} & \multicolumn{1}{c|}{(MB)} & \multicolumn{1}{c|}{(Sec.)}\\
\hline\hline
...
\stitle{Efficiency.}
In the \dblp graph, proxies can be found in about 6 seconds. In the \dblpone graph, it only takes 1.5 seconds to find all proxies.
