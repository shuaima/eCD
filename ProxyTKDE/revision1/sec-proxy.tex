...
Intuitively, one simply looks at the graph by removing $u$ from $G$ and the newly
\ccs created, and a proxy of $u$ is simply a union of such \ccs whose total size is at most $c\cdot\lfloor\sqrt{|V|}\rfloor - 1$.
