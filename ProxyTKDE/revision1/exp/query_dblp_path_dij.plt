...
set output "query_dblp_path_dj.eps"
set size 0.6, 0.3
set grid
...
plot "query_dblp_path_dij.txt" using ($1):($3) title 'Proxy+Dijkstra' with linespoints linetype 4 pointtype 8 lc 0,\
"query_dblp_path_dij.txt" using ($1):($2) title 'Dijkstra' with linespoints linetype 5 pointtype 6 lc 0