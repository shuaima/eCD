...
set output "query_eus_dist_ah.eps"
set size 0.6, 0.3
set grid
...
set ytics ("50" 50, "100" 100, "150" 150, "200" 200, "250" 250)
...
plot "query_eus_dist_ah.txt" using ($1):($2) title 'Proxy+AH' with linespoints linetype 4 pointtype 8 lc 0,\
"query_eus_dist_ah.txt" using ($1):($3) title 'AH' with linespoints linetype 5 pointtype 6 lc 0