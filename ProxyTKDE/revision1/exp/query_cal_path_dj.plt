...
set output "query_cal_path_dj.eps"
set size 0.6, 0.3
set grid
...
set ytics ("10^3" 1000, "10^{4}" 10000,  "10^5" 100000)
...
plot "query_cal_path_dj.txt" using ($1):($2) title 'Proxy+ArcFlag' with linespoints linetype 4 pointtype 8 lc 0,\
"query_cal_path_dj.txt" using ($1):($3) title 'ArcFlag' with linespoints linetype 1 pointtype 6 lc 0