...
set output "query_cal_path_tnr.eps"
set size 0.6, 0.3
set grid
...
set ytics ("10^{1.5}" 31.623, "10^{2}" 100, "10^{2.5}" 316.23,  "10^{3}" 1000, "10^{3.5}" 3162.3)
...
plot "query_cal_path_tnr.txt" using ($1):($3) title 'Proxy+TNR' with linespoints linetype 4 pointtype 8 lc 0,\
"query_cal_path_tnr.txt" using ($1):($2) title 'TNR' with linespoints linetype 1 pointtype 6 lc 0