...
set output "query_col_path_ah.eps"
set size 0.6, 0.3
set grid
...
plot "query_col_path_ah.txt" using ($1):($2) title 'Proxy+AH' with linespoints linetype 4 pointtype 8 lc 0,\
"query_col_path_ah.txt" using ($1):($3) title 'AH' with linespoints linetype 5 pointtype 6 lc 0