...
set output "query_wus_path_tnr.eps"
set size 0.6, 0.3
set grid
...
set ytics ("10^{1}" 10, "10^{2}" 100, "10^{3}" 1000, "10^{4}" 10000)
...
plot "query_wus_path_tnr.txt" using ($1):($3) title 'Proxy+TNR' with linespoints linetype 4 pointtype 8 lc 0,\
"query_wus_path_tnr.txt" using ($1):($2) title 'TNR' with linespoints linetype 5 pointtype 6 lc 0