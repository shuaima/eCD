...
set output "query_q3_dist_ah.eps"
set size 0.6, 0.3
set grid
...
set ytics ("10^1" 10, "10^{1.5}" 31.6277, "10^2" 100)
...
#set key 1,2300
plot "query_q3_dist_ah.tab" using ($1):($2) title 'Proxy+AH' with linespoints linetype 4 pointtype 8 lc 0,\
"query_q3_dist_ah.tab" using ($1):($3) title 'AH' with linespoints linetype 5 pointtype 6 lc 0
