...
set output "query_dblp_dist_tnr.eps"
set size 0.6, 0.3
set grid
...
plot "query_dblp_dist_tnr.txt" using ($1):($3) title 'Proxy+TNR' with linespoints linetype 4 pointtype 8 lc 0,\
"query_dblp_dist_tnr.txt" using ($1):($2) title 'TNR' with linespoints linetype 5 pointtype 6 lc 0