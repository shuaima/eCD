...
set output "query_cus_dist_dj.eps"
set size 0.6, 0.3
set grid
...
set ytics ("10^{4}" 10000,  "10^5" 100000, "10^6" 1000000, "10^7" 10000000)
...
plot "query_cus_dist_dj.txt" using ($1):($2) title 'Proxy+ArcFlag' with linespoints linetype 4 pointtype 8 lc 0,\
"query_cus_dist_dj.txt" using ($1):($3) title 'ArcFlag' with linespoints linetype 5 pointtype 6 lc 0