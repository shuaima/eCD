...
set output "query_usa_dist_ah.eps"
set size 0.6, 0.3
set grid
...
set ytics ("200" 200, "400" 400, "600" 600, "800" 800)
...
plot "query_usa_dist_ah.txt" using ($1):($2) title 'Proxy+AH' with linespoints linetype 4 pointtype 8 lc 0,\
"query_usa_dist_ah.txt" using ($1):($3) title 'AH' with linespoints linetype 1 pointtype 6 lc 0