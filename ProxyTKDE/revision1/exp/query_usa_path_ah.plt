...
set output "query_usa_path_ah.eps"
set size 0.6, 0.3
set grid
...
set ytics ("300" 300, "600" 600, "900" 900, "1200" 1200, "1500" 1500)
...
plot "query_usa_path_ah.txt" using ($1):($2) title 'Proxy+AH' with linespoints linetype 4 pointtype 8 lc 0,\
"query_usa_path_ah.txt" using ($1):($3) title 'AH' with linespoints linetype 5 pointtype 6 lc 0