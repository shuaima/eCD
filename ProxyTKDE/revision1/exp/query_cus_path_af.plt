...
set output "query_cus_path_af.eps"
set size 0.6, 0.3
set grid
...
set ytics ("10^{3.5}" 3162.77, "10^{4}" 10000, "10^{4.5}" 31627.7)
...
plot "query_cus_path_af.txt" using ($1):($2) title 'Proxy+ArcFlag' with linespoints linetype 4 pointtype 8 lc 0,\
"query_cus_path_af.txt" using ($1):($3) title 'ArcFlag' with linespoints linetype 1 pointtype 6 lc 0