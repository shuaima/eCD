...
set output "query_wus_path_ah.eps"
set size 0.6, 0.3
set grid
...
set ytics ("100" 100, "200" 200, "300" 300, "400" 400, "500" 500)
...
plot "query_wus_path_ah.txt" using ($1):($2) title 'Proxy+AH' with linespoints linetype 4 pointtype 8 lc 0,\
"query_wus_path_ah.txt" using ($1):($3) title 'AH' with linespoints linetype 1 pointtype 6 lc 0