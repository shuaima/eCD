...
set output "query_q7_dist_tnr.eps"
set size 0.6, 0.3
set grid
...
#set key 1,2300
plot "query_q7_dist_tnr.txt" using ($1):($2) title 'Proxy+TNR' with linespoints linetype 4 pointtype 8 lc 0,\
"query_q7_dist_tnr.txt" using ($1):($3) title 'TNR' with linespoints linetype 5 pointtype 6 lc 0