...
set output "query_eus_path_dj.eps"
set size 0.6, 0.3
set grid
...
plot "query_eus_path_dj.txt" using ($1):($2) title 'Proxy+ArcFlag' with linespoints linetype 4 pointtype 8 lc 0,\
"query_eus_path_dj.txt" using ($1):($3) title 'ArcFlag' with linespoints linetype 5 pointtype 6 lc 0