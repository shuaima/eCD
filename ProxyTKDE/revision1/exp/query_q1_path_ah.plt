...
set output "query_q1_path_ah.eps"
set size 0.6, 0.3
set grid
...
#set key 1,2300
plot "query_q1_path_ah.tab" using ($1):($2) title 'Proxy+AH' with linespoints linetype 4 pointtype 8 lc 0,\
"query_q1_path_ah.tab" using ($1):($3) title 'AH' with linespoints linetype 1 pointtype 6 lc 0
