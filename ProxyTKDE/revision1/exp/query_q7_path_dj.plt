...
set output "query_q7_path_dj.eps"
set size 0.6, 0.3
set grid
...
plot "query_q7_path.tab" using ($1):($6) title 'Proxy+Dijkstra' with linespoints linetype 4 pointtype 8 lc 0,\
"query_q7_path.tab" using ($1):($7) title 'Dijkstra' with linespoints linetype 5 pointtype 6 lc 0
