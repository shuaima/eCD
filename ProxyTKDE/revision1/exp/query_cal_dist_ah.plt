...
set output "query_cal_dist_ah.eps"
set size 0.6, 0.3
set grid
...
set ytics ("10" 10, "40" 40, "70" 70,  "100" 100)
...
plot "query_cal_dist_ah.txt" using ($1):($2) title 'Proxy+AH' with linespoints linetype 4 pointtype 8 lc 0,\
"query_cal_dist_ah.txt" using ($1):($3) title 'AH' with linespoints linetype 5 pointtype 6 lc 0