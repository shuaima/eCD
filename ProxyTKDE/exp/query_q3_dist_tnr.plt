...
set output "query_q3_dist_tnr.eps"
set size 0.6, 0.3
set grid
...
set ytics ("10^{0.5}" 3.162,"10^{1}" 10, "10^{1.5}" 31.62, "10^{2}" 100, "10^{2.5}" 316.2)
...
#set key 1,2300
plot "query_q3_dist_tnr.txt" using ($1):($2) title 'Proxy+TNR' with linespoints linetype 4 pointtype 8 lc 0,\
"query_q3_dist_tnr.txt" using ($1):($3) title 'TNR' with linespoints linetype 5 pointtype 6 lc 0