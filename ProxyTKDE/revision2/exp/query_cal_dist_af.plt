...
set output "query_cal_dist_af.eps"
set size 0.6, 0.3
set grid
...
plot "query_cal_dist_af.txt" using ($1):($2) title 'Proxy+ArcFlag' with linespoints linetype 4 pointtype 8 lc 0,\
"query_cal_dist_af.txt" using ($1):($3) title 'ArcFlag' with linespoints linetype 1 pointtype 6 lc 0