...
set output "query_dblp_path_af.eps"
set size 0.6, 0.3
set grid
...
set ytics ("10^{2}" 100, "10^{2.5}" 316, "10^{3}" 1000)
...
"query_dblp_dist_af.txt" using ($1):($2) title 'ArcFlag' with linespoints linetype 1 pointtype 6 lc 0