...
\raisebox{1.5ex}[0pt]{\bf \# of nodes} &  & {\bf 2} & {\bf 4} & {\bf 6} & {\bf 8} & {\bf 10} & {\bf 12}  \\ \hline \hline

 \multirow{2}{*}{$6\times 10^6$} & Proxies (\#: \%) & (108783: 18.1) & (67315: 11.2) & (46908: 7.9) & (35927: 6.0) &  (29015: 5.0) & \\ \cline{2-8}
                       & Nodes in \dras (\#: \%)    & (172802: 28.8) & (76931: 12.8) & (50606: 8.4) & (37898: 6.3) &  (30197: 5.0) &  \\ \hline
 \multirow{2}{*}{$8\times 10^6$} & Proxies (\#: \%) &  &  &  &  &  & \\ \cline{2-8}
                       & Nodes in \dras (\#: \%) &  &  &  &  &  &  \\ \hline
 \multirow{2}{*}{$10\times 10^6$}& Proxies (\#: \%) &  &  &  &  &  &  \\ \cline{2-8}
                       & Nodes in \dras (\#: \%) &  &  &  &  &  &    \\ \hline
 \multirow{2}{*}{$12\times 10^6$}& Proxies (\#: \%) &  &  &  &  &  &  \\ \cline{2-8}
                       & Nodes in \dras (\#: \%) &  &  &   &  &  &   \\ \hline
\end{tabular}
%\end{small}
\end{center}
