...
\raisebox{1.5ex}[0pt]{\bf Graphs} & \raisebox{1.5ex}[0pt]{\bf Methods} & {\bf Q1} & {\bf Q2} & {\bf Q3} & {\bf Q4} & {\bf Q5} & {\bf Q6} & {\bf Q7}  \\ \hline \hline
 ...
 \multirow{2}{*}{DBLP14} & Dijkstra & 2.1          & 3   & 4.6 & 10.5 & 34 & 287 & 13,935 \\ \cline{2-9}
                       & Proxy+Dijkstra & {\bf1.8} & {\bf2.5} & {\bf3.5} & {\bf5.5} & {\bf12} & {\bf84} & {\bf3,332} \\ \hline
 \multirow{2}{*}{CO}     & Dijkstra & 113 & 395 & 1,427 & 4,669 & 10,963 & 26,289 & 62,194 \\ \cline{2-9}
                       & Proxy+Dijkstra & {\bf105} & {\bf368} & {\bf1,296} & {\bf4,240} & {\bf10,274} & {\bf24,962} & {\bf59,816} \\ \hline
 \multirow{2}{*}{FL}     & Dijkstra & 444 & 1,648 & 5,701 & 16,684 & 45,184 & 137,532 & 360,603 \\ \cline{2-9}
                       & Proxy+Dijkstra & {\bf323} & {\bf1,173} & {\bf3,800} & {\bf10,719} & {\bf28,915} & {\bf86,020}  & {\bf226,303} \\ \hline
 \multirow{2}{*}{CA}     & Dijkstra & 873 & 3,066 & 10,422 & 32,365 & 89,983 & 237,625 & 543,870 \\ \cline{2-9}
                       & Proxy+Dijkstra & {\bf640} & {\bf2,226} & {\bf7,439}  & {\bf22,699} & {\bf61,405} & {\bf159,870} & {\bf359,532} \\ \hline
 \multirow{2}{*}{E-US}   & Dijkstra & 869 & 3,283 & 12,080 & 44,275 & 155,196 & 519,541 & 1,681,470 \\ \cline{2-9}
                       & Proxy+Dijkstra & {\bf672} & {\bf2,503} & {\bf9,051}  & {\bf31,749} & {\bf107,962} & {\bf354,352} & {\bf956,205} \\ \hline
 \multirow{2}{*}{W-US}   & Dijkstra & 2,219 & 9,255 & 20,829 & 57,122 & 163,115 & 473,679 & 1,514,990 \\ \cline{2-9}
                       & Proxy+Dijkstra & {\bf1,587} & {\bf5,059} & {\bf14,104} & {\bf37,537} & {\bf105,377} & {\bf305,627} & {\bf961,300} \\ \hline
 \multirow{2}{*}{C-US}   & Dijkstra & 2,419 & 8,119 & 28,468 & 102,945 & 408,656 & 1,639,260 & 5,868,220 \\ \cline{2-9}
                       & Proxy+Dijkstra & {\bf1,508} & {\bf4,876} & {\bf16,649} & {\bf59,777} & {\bf244,552} & {\bf978,000} & {\bf3,553,810} \\ \hline
\end{tabular}
%\end{small}
\end{center}
\end{table*}
...
\multirow{2}{*}{DBLP14} & \arcflag & 70.4 & {\bf71.5} & {\bf72.9} & 75.1 & 79.5 & 88.9 & 134.1 \\ \cline{2-9}
                       & Proxy+\arcflag& {\bf70.1} & 74 & 74.7 & {\bf73.4} & {\bf74.9} & {\bf79.6} & {\bf123.4} \\ \hline
\multirow{2}{*}{CO}     & \arcflag & 120 & 246 & 437 & 772 & 1,158 & 1,600 & 2,274 \\ \cline{2-9}
                       & Proxy+\arcflag& {\bf84} & {\bf168} & {\bf317} & {\bf582} & {\bf943} & {\bf1,475} & {\bf2,008} \\ \hline
\multirow{2}{*}{FL}     & \arcflag & 339 & 692 & 1,170 & 1,739 & 2,431 & 3,132 & 4,028 \\ \cline{2-9}
                       & Proxy+\arcflag& {\bf233} & {\bf491} & {\bf890} & {\bf1,413} & {\bf2,076} & {\bf2,599} & {\bf3,360} \\ \hline
\multirow{2}{*}{CA}     & \arcflag & 540 & 960 & 1,566 & 2,394 & 3,400 & 4,840 & 6,391 \\ \cline{2-9}
                       & Proxy+\arcflag& {\bf386} & {\bf737} & {\bf1,268} & {\bf1,955} & {\bf2,855} & {\bf4,332} & {\bf5,566} \\ \hline
\multirow{2}{*}{E-US}   & \arcflag & 613 & 1,258 & 2,212 & 3,485 & 5,383 & 7,970 & 11,007 \\ \cline{2-9}
                       & Proxy+\arcflag& {\bf429} & {\bf923} & {\bf1,699} & {\bf2,796} & {\bf4,468} & {\bf6,968} & {\bf10,090} \\ \hline
\multirow{2}{*}{W-US}   & \arcflag & 1,036 & 1,906 & 3,089 & 4,435 & 6,478 & 8,722 & 11,602 \\ \cline{2-9}
                       & Proxy+\arcflag& {\bf737} & {\bf1,380} & {\bf2,373} & {\bf3,612} & {\bf5,539} & {\bf7,663} & {\bf10,651} \\ \hline
\multirow{2}{*}{C-US}   & \arcflag & 1,474 & 2,943 & 5,006 & 7,905 & 12,439 & 19,316 & 28,959 \\ \cline{2-9}
                       & Proxy+\arcflag& {\bf983} & {\bf2,065} & {\bf3,740} & {\bf6,283} & {\bf10,402} & {\bf16,495} & {\bf26,074} \\ \hline
\end{tabular}
%\end{small}
\end{center}
\end{table*}
...
\multirow{2}{*}{CO}& \ah & {\bf7.8} & {\bf9.3} & {\bf17.2} & {\bf26.5} & {\bf37.4} & {\bf51.5} & 67.1 \\ \cline{2-9}
                  &Proxy+\ah & {\bf7.8} & 10.9 & {\bf17.2} & 28.1 & 37.5 & 53 & {\bf59.3} \\ \hline
\multirow{2}{*}{FL} &\ah & {\bf10.9} & {\bf15.6} & {\bf23.4} & {\bf29.7} & {\bf40.5} & 56.2 & 59.3 \\ \cline{2-9}
                  & Proxy+\ah& 12.4 & 17.2 & 23.5 & {\bf29.7} & {\bf40.5} & {\bf54.6} & {\bf57.7} \\ \hline
\multirow{2}{*}{CA} &\ah & {\bf18.7} & {\bf28} & {\bf42.1} & 56.2 & 68.6 & 88.9 & 101.4 \\ \cline{2-9}
                  & Proxy+\ah& {\bf18.7} & 28.1 & {\bf42.1} & {\bf54.6} & {\bf67.1} & {\bf85.8} & {\bf99.8} \\ \hline
\multirow{2}{*}{E-US}&\ah& {\bf20.3} & {\bf34.3} & 57.7 & 96.7 & 159.1 & 235.5 & {\bf257.4} \\ \cline{2-9}
                  & Proxy+\ah& 21.9 & {\bf34.3} & {\bf56.2} & {\bf93.6} & {\bf152.8} & {\bf232.4} & 258.9 \\ \hline
\multirow{2}{*}{W-US}&\ah& {\bf24.9} & 39 & 56.2 & 74.9 & 107.6 & 149.8 & 188.7 \\ \cline{2-9}
                  & Proxy+\ah& 26.6 & {\bf37.5} & {\bf53} & {\bf73.3} & {\bf104.5} & {\bf146.6} & {\bf185.6} \\ \hline

\multirow{2}{*}{C-US}&\ah& 39 & {\bf70.2} & 135.7 & 244.9 & 402.5 & 603.7 & {\bf762} \\ \cline{2-9}
                  & Proxy+\ah& {\bf37.3} & {\bf70.2} & {\bf129.5} & {\bf235.5} & {\bf385.3} & {\bf580.3} & 769.1 \\ \hline
\end{tabular}
%\end{small}
\end{center}
\end{table*}
...
\multirow{2}{*}{DBLP14} & \arcflag & {\bf63.7} & {\bf64.2} & 74.9 & 75.1 & 79.5 & 87.4 & 134 \\ \cline{2-9}
                       & Proxy+\arcflag& 70.1 & 71.5 & {\bf70.9} & {\bf74.1} & {\bf74.8} & {\bf79.6} & {\bf123} \\ \hline
\multirow{2}{*}{CO} & \arcflag & 120 & 245 & 438 & 775 & 1,148 & 1,597 & 4,031 \\ \cline{2-9}
                  & Proxy+\arcflag & {\bf90} & {\bf177} & {\bf330} & {\bf604} & {\bf976} & {\bf1,535} & {\bf3,534} \\ \hline
\multirow{2}{*}{FL} & \arcflag & 336 & 689 & 1,166 & 1,738 & 2,425 & 3,146 & 4,028 \\ \cline{2-9}
                  & Proxy+\arcflag & {\bf241} & {\bf502} & {\bf908} & {\bf1,444} & {\bf2,138} & {\bf2,751} & {\bf3,360} \\ \hline
\multirow{2}{*}{CA} & \arcflag & 539 & 965 & 1,566 & 2,387 & 3,400 & 4,833 & 6,391 \\ \cline{2-9}
                  & Proxy+\arcflag & {\bf393} & {\bf742} & {\bf1,268} & {\bf1,985} & {\bf2,855} & {\bf4,420} & {\bf5,566} \\ \hline
\multirow{2}{*}{E-US}&\arcflag & 619 & 1,266 & 2,212 & 3,487 & 5,383 & 7,959 & 11,007 \\ \cline{2-9}
                  & Proxy+\arcflag & {\bf442} & {\bf946} & {\bf1,742} & {\bf2,873} & {\bf4,468} & {\bf7,173} & {\bf10,090} \\ \hline
\multirow{2}{*}{W-US}&\arcflag & 1,043 & 1,903 & 3,086 & 4,441 & 6,457 & 8,718 & 11,634 \\ \cline{2-9}
                  & Proxy+\arcflag & {\bf757} & {\bf1,411} & {\bf2,423} & {\bf3,708} & {\bf5,699} & {\bf7,932} & {\bf11,169} \\ \hline
\multirow{2}{*}{C-US}&\arcflag & 1,486 & 2,958 & 5,006 & 7,992 & 12,439 & 19,517 & 28,670 \\ \cline{2-9}
                  & Proxy+\arcflag & {\bf1,006} & {\bf2,098} & {\bf3,740} & {\bf6,463} & {\bf10,402} & {\bf16,974} & {\bf25,104} \\ \hline
\end{tabular}
%\end{small}
\end{center}
\end{table*}
...
\multirow{2}{*}{CO} & \ah & {\bf7.8} & {\bf14} & {\bf20.3} & 34.4 & {\bf48.4} & {\bf68.6} & 87.4 \\ \cline{2-9}
                  & Proxy+\ah & {\bf7.8} & 14.1 & 21.8 & {\bf32.7} & {\bf48.4} & {\bf68.6} & {\bf84.3} \\ \hline
\multirow{2}{*}{FL} & \ah & {\bf15.6} & 23.4 & 34.3 & {\bf48.4} &{\bf65.5} & 90.5 & 110.8 \\ \cline{2-9}
                  & Proxy+\ah & {\bf15.6} & {\bf21.8} & {\bf32.8} & 53 & 71.7 & {\bf87.4} & {\bf107.6} \\ \hline
\multirow{2}{*}{CA} & \ah & {\bf23.4} & 39 & 59.3 & 81.1 & 104.5 & 145 & 181 \\ \cline{2-9}
                  & Proxy+\ah & {\bf23.4} & {\bf37.4} & {\bf57.7} & {\bf78} & {\bf99.8} & {\bf140.4} & {\bf176.3} \\ \hline
\multirow{2}{*}{E-US} & \ah & {\bf28.1} & 48.4 & 82.7 & 142 & 229.3 & 357.2 & {\bf443.1} \\ \cline{2-9}
                    & Proxy+\ah & {\bf28.1} & {\bf46.8} & {\bf79.6} & {\bf134.2} & {\bf221.5} & {\bf347.8} & 433.6 \\ \hline
\multirow{2}{*}{W-US} & \ah & {\bf35.8} & 56.3 & 82.7 & 124.8 & 187.2 & 276.1 & 394.7 \\ \cline{2-9}
                    & Proxy+\ah & 35.9 & {\bf54.6} & {\bf81.1} & {\bf121.7} & {\bf182.5} & {\bf269.9} & {\bf386.9} \\ \hline
\multirow{2}{*}{C-US} & \ah & 56.1 & 99.8 & 188.8 & 347.9 & 591.2 & 926.7 & 1,324.4 \\ \cline{2-9}
                    & Proxy+\ah & {\bf53} & {\bf95.2} & {\bf179.4} & {\bf333.9} & {\bf567.9} & {\bf892.3} & {\bf1,310.4} \\ \hline
\end{tabular}
%\end{scriptsize}
\end{center}
\end{table*}
