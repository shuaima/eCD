...
\title{Supplementary Material: Experimental Results}
%
%
...
Below we show the omitted results in our paper. We first report results on dataset CO, FL, W-US, and US. By following the settings in our paper, we fixed the constant $c=2$ for computing proxies on all graphs.

\stitle{Effectiveness  \wrt graph queries}.
The results of distance queries and path queries are reported in Figures~\ref{fig:performance_dist_queries_dj}, ~\ref{fig:performance_path_queries_dj} (comparison between Dijkstra and Proxy+Dijkstra), Figures~\ref{fig:performance_dist_queries_af}, ~\ref{fig:performance_path_queries_af} (comparison between \arcflag and Proxy+\arcflag), Figures~\ref{fig:performance_dist_queries_tnr}, ~\ref{fig:performance_path_queries_tnr} (comparison between \tnr and Proxy+\tnr), Figures~\ref{fig:performance_dist_queries_ah}, ~\ref{fig:performance_path_queries_ah} (comparison between \ah and Proxy+\ah), respectively.
...
\includegraphics[scale=0.45]{./exp/query_col_dist_dj.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize FL}]{\label{fig-dist-dj-varyQ-FL}
\includegraphics[scale=0.45]{./exp/query_fla_dist_dj.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize W-US}]{\label{fig-dist-dj-varyQ-W-US}
\includegraphics[scale=0.45]{./exp/query_wus_dist_dj.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize US}]{\label{fig-dist-dj-varyQ-US}
\includegraphics[scale=0.45]{./exp/query_usa_dist_dj.eps}}
\end{center}
\vspace{1ex}
...
\includegraphics[scale=0.45]{./exp/query_col_dist_af.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize FL}]{\label{fig-dist-af-varyQ-FL}
\includegraphics[scale=0.45]{./exp/query_fla_dist_af.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize W-US}]{\label{fig-dist-af-varyQ-W-US}
\includegraphics[scale=0.45]{./exp/query_wus_dist_af.eps}}
\end{center}
\vspace{1ex}
...
\includegraphics[scale=0.45]{./exp/query_col_dist_tnr.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize FL}]{\label{fig-dist-tnr-varyQ-FL}
\includegraphics[scale=0.45]{./exp/query_fla_dist_tnr.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize W-US}]{\label{fig-dist-tnr-varyQ-W-US}
\includegraphics[scale=0.45]{./exp/query_wus_dist_tnr.eps}}
\end{center}
\vspace{1ex}
...
\begin{center}
\hspace{-4ex}
\subfigure[{\scriptsize CO}]{\label{fig-dist-ah-varyQ-CO}
\includegraphics[scale=0.45]{./exp/query_col_dist_ah.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize FL}]{\label{fig-dist-ah-varyQ-FL}
\includegraphics[scale=0.45]{./exp/query_fla_dist_ah.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize W-US}]{\label{fig-dist-ah-varyQ-W-US}
\includegraphics[scale=0.45]{./exp/query_wus_dist_ah.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize US}]{\label{fig-dist-ah-varyQ-US}
\includegraphics[scale=0.45]{./exp/query_usa_dist_ah.eps}}
\end{center}
\vspace{1ex}
...
Similarly to the observations that we made on datasets CA, E-US, and C-US, we can see that (1) proxies have a better speed-up effect on bidirectional Dijkstra than \arcflag, (2) for \arcflag, proxies have a better speed-up effect when the two query nodes are close to each other, (3) different from \arcflag, proxy+Dijkstra has a better performance when the query nodes are far from each other, (4) Proxy+\tnr achieves a comparable performance to its counterparts without proxies, and (5) though \ah is one of the state-of-art method for shortest path and distance queries, proxies still improves the its efficiency about 1\%.
...
\includegraphics[scale=0.45]{./exp/query_col_path_dj.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize FL}]{\label{fig-path-dj-varyQ-FL}
\includegraphics[scale=0.45]{./exp/query_fla_path_dj.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize W-US}]{\label{fig-path-dj-varyQ-W-US}
\includegraphics[scale=0.45]{./exp/query_wus_path_dj.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize US}]{\label{fig-path-dj-varyQ-US}
\includegraphics[scale=0.45]{./exp/query_usa_path_dj.eps}}
%\hfill
%\vspace{-1ex}
\end{center}
\vspace{1ex}
...
\includegraphics[scale=0.45]{./exp/query_col_path_af.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize FL}]{\label{fig-path-af-varyQ-FLA}
\includegraphics[scale=0.45]{./exp/query_fla_path_af.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize W-US}]{\label{fig-path-af-varyQ-W-US}
\includegraphics[scale=0.45]{./exp/query_wus_path_af.eps}}
\end{center}
\vspace{1ex}
...
\includegraphics[scale=0.45]{./exp/query_col_path_tnr.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize FL}]{\label{fig-path-tnr-varyQ-FL}
\includegraphics[scale=0.45]{./exp/query_fla_path_tnr.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize W-US}]{\label{fig-path-tnr-varyQ-W-US}
\includegraphics[scale=0.45]{./exp/query_wus_path_tnr.eps}}
\end{center}
\vspace{1ex}
...
\begin{center}
\hspace{-4ex}
\subfigure[{\scriptsize CO}]{\label{fig-path-ah-varyQ-CO}
\includegraphics[scale=0.45]{./exp/query_col_path_ah.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize FL}]{\label{fig-path-ah-varyQ-FL}
\includegraphics[scale=0.45]{./exp/query_fla_path_ah.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize W-US}]{\label{fig-path-ah-varyQ-W-US}
\includegraphics[scale=0.45]{./exp/query_wus_path_ah.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize US}]{\label{fig-path-ah-varyQ-US}
\includegraphics[scale=0.45]{./exp/query_usa_path_ah.eps}}
\end{center}
\vspace{1ex}
...
In this set of experiments, we compare the efficiency of a group of shortest path and distance queries $\{Q_2, Q_4, Q_6\}$  on road graphs using the same settings.
...
\includegraphics[scale=0.45]{./exp/query_q2_dist_dj.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize $Q_4$}]{\label{fig-dist-dj-varySize-Q4}
\includegraphics[scale=0.45]{./exp/query_q4_dist_dj.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize $Q_6$}]{\label{fig-dist-dj-varySize-Q6}
\includegraphics[scale=0.45]{./exp/query_q6_dist_dj.eps}}
...
\includegraphics[scale=0.45]{./exp/query_q2_dist_af.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize $Q_4$}]{\label{fig-dist-af-varySize-Q4}
\includegraphics[scale=0.45]{./exp/query_q4_dist_af.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize $Q_6$}]{\label{fig-dist-af-varySize-Q6}
\includegraphics[scale=0.45]{./exp/query_q6_dist_af.eps}}
\end{center}
\vspace{1ex}
...
\includegraphics[scale=0.45]{./exp/query_q2_dist_tnr.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize $Q_4$}]{\label{fig-dist-tnr-varySize-Q4}
\includegraphics[scale=0.45]{./exp/query_q4_dist_tnr.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize $Q_6$}]{\label{fig-dist-tnr-varySize-Q6}
\includegraphics[scale=0.45]{./exp/query_q6_dist_tnr.eps}}
\end{center}
\vspace{1ex}
...
\begin{center}
\hspace{-4ex}
\subfigure[{\scriptsize $Q_2$}]{\label{fig-dist-ah-varySize-Q2}
\includegraphics[scale=0.45]{./exp/query_q2_dist_ah.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize $Q_4$}]{\label{fig-dist-ah-varySize-Q4}
\includegraphics[scale=0.45]{./exp/query_q3_dist_ah.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize $Q_6$}]{\label{fig-dist-ah-varySize-Q6}
\includegraphics[scale=0.45]{./exp/query_q6_dist_ah.eps}}
\end{center}
\vspace{1ex}
...
\begin{center}
\hspace{-4ex}
\subfigure[{\scriptsize $Q_2$}]{\label{fig-path-ah-varySize-Q2}
\includegraphics[scale=0.422]{./exp/query_q2_path_ah.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize $Q_4$}]{\label{fig-path-ah-varySize-Q4}
\includegraphics[scale=0.422]{./exp/query_q4_path_ah.eps}}
\hspace{-4ex}\vspace{-1.5ex}
\subfigure[{\scriptsize $Q_6$}]{\label{fig-path-ah-varySize-Q6}
\includegraphics[scale=0.422]{./exp/query_q6_path_ah.eps}}
\end{center}
\vspace{1ex}
...
This work is supported in part by  973 Program ({\small No. 2014CB340300}), NSFC ({\small No. 61322207}), Special Funds of Beijing Municipal Science \& Technology Commission, and the Fundamental Research Funds for the Central Universities.
