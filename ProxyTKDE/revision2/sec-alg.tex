...
Note that \bcsketch graphs are a type of block graphs~\cite{Diestel05}, which further provide the weight function $\omega$ for the \bccs nodes.
%
...
\>\>  /* {\small note that all \bccs are separately maintained in $X'$}*/\\
