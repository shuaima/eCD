...
{\color{red}(3) In Table 12, the space overhead of \af, \tnr and \ah with proxies consists of (1) the extra space for proxies in pre-processing and (2) the space of the index generated by each of those methods on the reduced graph.}
