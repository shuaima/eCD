...
\noindent{\em{\bf[R1e]} e. In Example 4, the merging step is missing. (It is not necessary, but it would be better to have for sake of completeness).}
\svs
...
\noindent{\em{\bf[R1g]} Page 7, last paragraph: "AH is one of the state-of-art method" ---> "AH is one of the state-of-art methods".}
\svs
