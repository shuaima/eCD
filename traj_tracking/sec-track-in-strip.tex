...
Similar as spatio-temporal cones used in trajectory tracking using \sed, the sectors is applicable to track moving objects using \ped. 
%
...
We next present a {\em trajectory tracking} algorithm based on full-$\epsilon$ sectors (\sitt) that runs in a similar routine as \citt. \todo{vs cised}
