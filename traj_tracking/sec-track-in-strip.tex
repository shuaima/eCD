...
Similar as spatio-temporal cones used to track trajectory in circulars, the half-$\epsilon$ sectors used in trajectory simplification is applicable to track moving objects in strips. 
%
...
\begin{proof}
	\todo.
	1. traj simplification...ok.
	
	2. position tracking: \ie given a sub-traj, if it can be represented by sectors, then there is sure a $\vv{v}$ living in the common intersection of sectors such that it is trackable.
\end{proof}
