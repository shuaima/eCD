...
\stitle{Binary Euclidean distances of \sed and \ped}, shortly \bed (\sed, \ped), is the combination of two primary distance metrics of \sed and \ped whose error bounds are separately set to $\epsilon_{sed}$ and $\epsilon_{ped}$, satisfying $\epsilon_{sed} \ge \epsilon_{ped}$. 
