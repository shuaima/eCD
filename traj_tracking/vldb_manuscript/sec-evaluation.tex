...
\begin{figure*}[tb!]
	\centering
	\includegraphics[scale = 0.575]{figures/Fig-BITT-mopsi-compression-ratio.png}\hspace{0ex}
	\includegraphics[scale = 0.575]{figures/Fig-BITT-sercar-compression-ratio.png}\hspace{0ex}
	\includegraphics[scale = 0.575]{figures/Fig-BITT-geolife-compression-ratio.png}\hspace{0ex}
	\vspace{-2ex}
...
\begin{figure*}[tb!]
	\centering
	\includegraphics[scale = 0.575]{figures/Fig-BITT-mopsi-total-messages.png}\hspace{0ex}
	\includegraphics[scale = 0.575]{figures/Fig-BITT-sercar-total-messages.png}\hspace{0ex}
	\includegraphics[scale = 0.575]{figures/Fig-BITT-geolife-total-messages.png}\hspace{0ex}
	\vspace{-2ex}
...
\begin{figure*}[tb!]
	\centering
	\includegraphics[scale = 0.585]{figures/Fig-BITT-mopsi-sed-error.png}\hspace{-1ex}
	\includegraphics[scale = 0.585]{figures/Fig-BITT-sercar-sed-error.png}\hspace{-1ex}
	\includegraphics[scale = 0.585]{figures/Fig-BITT-geolife-sed-error.png}\hspace{0ex}
	\vspace{-2ex}
...
\begin{figure*}[tb!]
	\centering
	\includegraphics[scale = 0.585]{figures/Fig-BITT-mopsi-ped-error.png}\hspace{-1ex}
	\includegraphics[scale = 0.585]{figures/Fig-BITT-sercar-ped-error.png}\hspace{-1ex}
	\includegraphics[scale = 0.585]{figures/Fig-BITT-geolife-ped-error.png}\hspace{0ex}
	\vspace{-2ex}
