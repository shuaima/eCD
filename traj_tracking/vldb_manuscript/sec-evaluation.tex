...
\begin{figure*}[tb!]
	\centering
	\includegraphics[scale = 0.595]{figures/Fig-BITT-mopsi-compression-ratio.png}\hspace{1ex}
	\includegraphics[scale = 0.595]{figures/Fig-BITT-sercar-compression-ratio.png}\hspace{1ex}
	\includegraphics[scale = 0.595]{figures/Fig-BITT-geolife-compression-ratio.png}\hspace{1ex}
	\vspace{-4ex}
...
\begin{figure*}[tb!]
	\centering
	\includegraphics[scale = 0.595]{figures/Fig-BITT-mopsi-total-messages.png}\hspace{1ex}
	\includegraphics[scale = 0.595]{figures/Fig-BITT-sercar-total-messages.png}\hspace{1ex}
	\includegraphics[scale = 0.595]{figures/Fig-BITT-geolife-total-messages.png}\hspace{1ex}
	\vspace{-4ex}
...
\begin{figure*}[tb!]
	\centering
	\includegraphics[scale = 0.595]{figures/Fig-BITT-mopsi-sed-error.png}\hspace{1ex}
	\includegraphics[scale = 0.595]{figures/Fig-BITT-sercar-sed-error.png}\hspace{1ex}
	\includegraphics[scale = 0.595]{figures/Fig-BITT-geolife-sed-error.png}\hspace{1ex}
	\vspace{-4ex}
...
\begin{figure*}[tb!]
	\centering
	\includegraphics[scale = 0.595]{figures/Fig-BITT-mopsi-ped-error.png}\hspace{1ex}
	\includegraphics[scale = 0.595]{figures/Fig-BITT-sercar-ped-error.png}\hspace{1ex}
	\includegraphics[scale = 0.595]{figures/Fig-BITT-geolife-ped-error.png}\hspace{1ex}
	\vspace{-4ex}
