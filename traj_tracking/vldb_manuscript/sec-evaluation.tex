...
\sstab\emph{(1) Compression ratios}. Algorithm \sitt using \ped has the best compression ratios among all the algorithms at the price of unbound \sed errors. Algorithms \bitt and \citt are comparable with \grts.
They are all obviously better than \ldrh.
