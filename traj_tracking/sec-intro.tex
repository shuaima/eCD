...
To the end, we explore ways to track moving objects in areas such as circular, strip and rectangle-like areas, and design three novel one-pass trajectory tracking algorithms that run effectively and efficiently in those areas, respectively. 
