...
\ldrh is a one-pass trajectory tracking algorithm, having linear time and constant space complexities, while suffers in effectiveness (compression ratios).
