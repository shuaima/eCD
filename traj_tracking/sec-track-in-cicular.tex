...
\ldrh is an efficient trajectory tracking algorithm while suffers in effectiveness (compression ratios).
Observing one-pass algorithm, \cised using \sed, has low time complexity as well as good compression ratios, this inspires us to develop an efficient and effective trajectory tracking algorithm using \sed.
