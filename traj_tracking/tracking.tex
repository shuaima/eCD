...
\begin{abstract}
Trajectory tracking is a method that tracks the current position of a moving object and meanwhile simplifies its trajectory. It is a combination of two fundamental services of trajectory management, position tracking and trajectory simplification, in one routine such that only one copy of position information is sent to the data server, and thus the network and computing resources are saved.
%
...
%
To solve these problems, this paper presents three one-pass trajectory tracking algorithms that effectively and efficiently track a moving object in a circular, strip and rectangle-like area, respectively, based on the techniques of sector intersection and spatio-temporal cone intersection.
%
