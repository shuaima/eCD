...
%
Using three real-life trajectory datasets, we experimentally show that our approaches provide extra options of track a moving object, and are both efficient and effective that outperform \ldrh and \grts.
\end{abstract}
