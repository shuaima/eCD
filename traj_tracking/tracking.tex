...
%\subtitlenote{The full version of the author's guide is available as  \texttt{acmart.pdf} document}
 ...
 \email{{linxl, fuyh, houyc, mashuai, woty}@buaa.edu.cn}
...
\begin{abstract}
Trajectory tracking is a method that tracks the current position of a moving object and simplifies its trajectory in one routine. It is a combination of two fundamental services of trajectory management, position tracking and trajectory simplification, such that the computing and network resources are saved.
%
There are some distinct trajectory tracking algorithms, such as \ldrh and \grts. However, they still suffer in effectiveness or efficiency, and more important, they only track a moving object in a circular area, unable to satisfy the varied requirements of trajectory tracking in areas beyond a circle. 
%
To solve these problems, this work present three one-pass trajectory tracking algorithms that effectively and efficiently track a moving object in a circular, strip and rectangle-like area, respectively, based on the techniques of sector intersection and spatio-temporal cone intersection.
%
Using three real-life trajectory datasets, we experimentally show that our approaches are both efficient and effective that outperform \ldrh and \grts, and are excellent options of tracking a moving object. %in varied areas.
\end{abstract}
...
\input{sec-track-in-strip}
\input{sec-track-in-comb}
