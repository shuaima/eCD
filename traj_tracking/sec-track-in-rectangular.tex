...
This section develops an effective and efficient way to track a moving object in a rectangle-like area. 
Though it is possible to do a tracking in a rectangular area, it is really hard to design such a shape without introducing a new distance metric, and at the same time develop such an efficient algorithm. Hence, we alternatively define a rectangle-like area that subtly makes use of \ped and \sed.
