...
\myblue{However, as mentioned in Section~\ref{sec-intro}, there is a need of tracking a moving object in strip areas.}
...
\myblue{This section introduces a \ped-based method that tracks a moving object in strip areas.}
