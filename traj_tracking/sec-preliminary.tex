...
\begin{figure}[tb!]
	...
	\vspace{-1ex}
	\caption{\small A running example of trajectory tracking by \ldrh taking the same trajectory of Figure \ref{fig:ldr} as input. }
	\vspace{-2ex}
	\label{fig:ldrh}
\end{figure}
