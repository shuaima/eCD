...
\begin{example}
	...
	%
	(2) the set of two continuous line segments $\{\vv{P_0P_4}$, $\vv{P_4P_{10}}$\} and the set of four continuous line segments $\{\vv{P_0P_2}$, $\vv{P_2P_4}$, $\vv{P_4P_7}$, $\vv{P_7P_{10}}$\} are two piece-wise line representations of trajectory $\dddot{\mathcal{T}}$,
	%
