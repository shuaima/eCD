...
\sstab\emph{(2) Total messages}. The message numbers from the largest to the smallest are \ldrh, \grts, \citt, \bitt and \sitt.
...
\sstab\emph{(4) Running time}. Algorithms \ldrh and \sitt are the fastest.
