...
\stitle{Compression ratios.} We first report and discuss compression ratios as shown in Figure~\ref{fig:compression-ratio}.
...
\stitle{Message ratios.} We then report and discuss message ratios as shown in Figure~\ref{fig:total-message}.
