...
\begin{figure*}[tb!]
	\centering
	\includegraphics[scale = 0.560]{figures/Fig-mopsi-total-messages.png}\hspace{1ex}
	\includegraphics[scale = 0.560]{figures/Fig-sercar-total-messages.png}\hspace{1ex}
...
\begin{figure*}[tb!]
	\centering
	\includegraphics[scale = 0.560]{figures/Fig-mopsi-speed-messages.png}\hspace{1ex}
	\includegraphics[scale = 0.560]{figures/Fig-sercar-speed-messages.png}\hspace{1ex}
	\includegraphics[scale = 0.560]{figures/Fig-geolife-speed-messages.png}\hspace{1ex}
	\vspace{-1ex}
...
\begin{figure*}[tb!]
	\centering
	\includegraphics[scale = 0.560]{figures/Fig-mopsi-running-time.png}\hspace{1ex}
	\includegraphics[scale = 0.560]{figures/Fig-sercar-running-time.png}\hspace{1ex}
	\includegraphics[scale = 0.560]{figures/Fig-geolife-running-time.png}\hspace{1ex}
	\vspace{-1ex}
...
\ni (4) \grts has more messages than \citt. Recall that \grts has \emph{position-messages} and \emph{position-velocity-messages}, while \citt has \emph{velocity-messages} and \emph{position-velocity-messages}. From Figure \ref{fig:compression-ratio} we know that \grts has a similar compression ratio as \citt, meaning \grts has the similar number of \emph{position-messages} as the \emph{position-velocity-messages} of \citt. Besides, the  number of \emph{position-velocity-messages} of \grts (\todo{on average $(?\%, ?\%, ?\%)$} of the total messages \wrt datasets (\mopsi, \sercar, \geolife), respectively) is usually a bit larger than the \emph{velocity-messages} of \citt (on average $(60.41\%, 57.31\%, 52.80\%)$ of the total messages \wrt datasets (\mopsi, \sercar, \geolife), respectively). As a result, \grts has more total messages than \citt.
...
\stitle{Average errors.} We next report and analyze the average errors from Figures~\ref{fig:sed-error} and \ref{fig:ped-error}.
...
\ni (1) The running time of these algorithms from the largest to the smallest are \grts, \bitt, \citt, \sitt and \ldrh on all datasets.
