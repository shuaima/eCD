...
set xr [-1.6:-0.4]
set yr [0.6:0.85]  
set ytics ("0.60" 0.6, "0.65" 0.65, "0.70" 0.70, "0.75" 0.75, "0.80" 0.8, "0.85" 0.85)
...
set key vertical samplen 3.3 spacing 1.2 at graph 0.97, 0.5
...
"AAN_sigma.tab" using ($1):($5) title 'Best Baseline(FCita)' with linespoints linetype 1 pointtype 2 lc rgb "green" lw 3,\
"AAN_sigma.tab" using ($1):($2) title 'ERank(Recom)' with linespoints linetype 0 pointtype 4 lc rgb "blue" lw 5,\
"AAN_sigma.tab" using ($1):($3) title 'Best Baseline(Recom)' with linespoints linetype 0 pointtype 1 lc 1 lw 5