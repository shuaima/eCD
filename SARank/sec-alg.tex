...
\end{proof}
 ...
 Recall that (a)  $t$ is very likely to be in the tens to hundreds~\cite{Brin98:PageRank}, and (b) $O(|V|+|E_a|+t|E_i|)$ is essentially $O(|V|+|E|+(t-1)|E_i|)$ as $|E_i|$ + $|E_a|$  = $|E|$. Hence, the efficiency of block-wise algorithm \twprscc is mainly affected by $|E_i|$.
