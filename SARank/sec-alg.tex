...
\end{small}
\end{center}
\caption{\small Statistics of citation graphs and Web graphs that were extracted from berkely.edu and stanford.edu domains in 2002 and from the Google programming contest in 2002, respectively~\cite{LeskovecLDM09}.}
\label{tab-batch}
\vspace{-8ex}
\end{table}
%%%%%%%%%%%%%%%%%%%
