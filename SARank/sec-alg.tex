...
\hline
                  &       \multicolumn{2}{c|}{\bf Nodes / Edges}                         & \multicolumn{2}{c|}{\bf Largest }   & \multicolumn{2}{c|}{\bf \scc }    \\ \cline{2-3}
\raisebox{1.5ex}[0pt]{\bf Graphs}      & \multicolumn{1}{c|}{\bf citation} & \multicolumn{1}{c|}{\bf venue} & 
%\multicolumn{1}{c|}{\raisebox{1.5ex}[0pt]{\bf Edges}} &
\multicolumn{2}{c|}{\bf \scc nodes} &  \multicolumn{2}{c|}{\bf edge ratio}    \\
...
\aan  & 18,041/82,860 & 565/22,527 &  20 & 18  & 0.92\% & 2.78\%      \\  %\hline
\aminer  & 3.14 M/6.27M & 56 K/2.77 M   & 23 & 530 &  0.14\% & 1.78\%     \\ %\hline
\magdata  & 127 M/526 M & 584 K/162 M & 351 & 10 K & 0.06\% & 1.84\%    \\ \hline
...
web-BS  & \multicolumn{2}{c|}{685,230/7,600,595} & \multicolumn{2}{c|}{334,857} & \multicolumn{2}{c|}{59.51\%}\\  %\hline
web-G  & \multicolumn{2}{c|}{875,713/5,105,039} & \multicolumn{2}{c|}{434,818} & \multicolumn{2}{c|}{66.98\%} \\  %\hline
%Web graph  & 3,563 M  & 1,828 M & $>$25\%     \\
\hline
\end{tabular}
\end{small}
\end{center}
\caption{\small Statistics of citation graphs, venue graphs and Web graphs extracted from berkely.edu and stanford.edu domains in 2002 and from the Google programming contest in 2002, respectively~\cite{LeskovecLDM09}.}
\label{tab-batch}
\vspace{-6ex}
\end{table}
%%%%%%%%%%%%%%%%%%%
...
%
Taking $t=100$ for example, algorithm \twprscc needs to scan about $2|E|$ edges on citation graphs, and $4|E|$ edges on venue graphs, while over $50|E|$ edges are needed on Web graphs.
