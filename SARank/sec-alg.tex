...
\hline
{\bf Datasets}   &  \multicolumn{1}{c|}{\bf nodes}    & \multicolumn{1}{c|}{\bf \scc nodes}  & \multicolumn{1}{c|}{\bf Ratio (nodes)}   & \multicolumn{1}{c|}{\bf Ratio (edges)}    \\
\hline \hline
...
\end{small}
\end{center}
\caption{\small Statistics of citation graphs and Web graph~\cite{MeuselVLB14}.}
\vspace{-8ex}
\end{table}
%%%%%%%%%%%%%%%%%%%
