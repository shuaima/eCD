...
In this section, we first present Time-Weighted PageRank for evaluating  the importance of scholarly articles, and then introduce our ranking
...
are two TWPageRank vectors after $t$ and $t-1$ iterations, respectively, $M$ is the transition matrix such that $M_{u,v}=w(u,v)/W(u)$ and $e$ is a $n$-dimensional vector $[1]_{n\times1}$.
