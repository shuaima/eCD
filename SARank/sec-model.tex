...
Our ranking model \ensemblerank assembles the importance of articles, venues and authors for scholarly article ranking, computed by the citation, venue and author components, respectively, as shown in Fig.~\ref{fig-rankmodel}.
%
...
\stitle{Ranking with Importance assembling}.
