...
\marked{We then show a block-wise PageRank computation method is a good choice for computing Time-Weighted PageRank on scholarly data and further propose both batch and incremental algorithms for efficient ranking computation.}
