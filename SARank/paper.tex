...
%an ensemble enabled
a ranking model by assembling the importance of heterogeneous entities involved in scholarly articles, and  Time-Weighted PageRank, which extends traditional PageRank with a time decaying factor.
