...
Indeed, with \recom and \fcita, the \PairAcc of combining prestige and popularity was (9.8\%, 10.6\%, 7.0\%) and (3.6\%, 9.6\%, 4.1\%) higher than using prestige alone, and was (0.84\%, -2.3\%, -0.61\%) and (0.13\%, 0.45\%, -0.36\%) higher than using popularity alone on (\aan, \aminer, \magdata), respectively.
