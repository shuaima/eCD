...
%
Finally, the TWPageRank has little impacts on efficiency, and the running time of \ensemblerank and its counterparts only changes (5.44\%, 3.78\%) on (\aminer, \magdata) on average, respectively.
}
