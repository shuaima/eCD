...
Indeed, with \recom and \fcita, the \PairAcc of combining prestige and popularity was (10.2\%, 12.1\%, 5.5\%) and (3.7\%, 9.6\%, 7.6\%) higher than using prestige alone, and was (1.2\%, -0.73\%, 1.0\%) and (0.19\%, 0.45\%, 0.06\%) higher than using popularity alone on (\aan, \aminer, \magdata), respectively.
...
Moreover,this also enables to verify the effectiveness of importance assembling from different components, whose results are reported in Table~IV.
