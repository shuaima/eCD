...
The difference of \PairAcc by the two algorithms is higher with \recom than with \fcita, possibly because both algorithms are using citation information to predict future citations.
...
The improvement decreases with the decrease of $\lambda$ as the popularity dominates the ranking with small $\lambda$, and in some cases, \drank outperforms \ensemblerank as the prestige and popularity orders of articles of \drank are more diverse. 
