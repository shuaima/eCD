...
(b) \marked{the default splitting years were selected such that the data in evaluation part accounted for 4 years, which were 2008 on \aan and 2012 on both \aminer and \magdata since the data missing of 2016,} and,
...
%
For scholarly article ranking, algorithm \incensemble is on average (1.7, 3.0, 2.9, 128) and (2.0, 3.0, 4.4, 245) times faster than (\batensemble, \powensemble, \futurerank, \hhgrank) on \aminer and \magdata, respectively.
...
%
Our incremental algorithm \incensemble is on average (1.7, 3.0, 2.9, 128) and (2.0, 3.0, 4.4, 245) times faster than (\batensemble, \powensemble, \futurerank, \hhgrank)  on the large \aminer and \magdata, respectively.
