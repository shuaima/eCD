...
%
\marked{Moreover, recent work has also leveraged external data to improve the ranking quality, \eg using Knowledge Graph Embedding to better understand the meaning of research concepts~\cite{XiongPCWWW17}, or explored scientific journal ranking \cite{PackalenB17}. Different from these, our work ranks articles based on scholarly data only.}
