...
%
\marked{This specific structure in scholarly data has long been ignored in the literature, which has a large impact on the running time.} Taking $t=100$ for example, algorithm \twprscc needs to scan through $2|E|$ and $4|E|$ edges on citation and venue graphs, respectively, while over $59|E|$ edges on Web graphs.
