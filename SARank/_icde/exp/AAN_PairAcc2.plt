...
set xr [1:6]
set yr [0.3:0.75]  
set ytics ("0.3" 0.3, "0.39" 0.39, "0.48" 0.48, "0.57" 0.57, "0.66" 0.66, "0.75" 0.75)
...
#"AAN_PairAcc2.tab" using ($1):($6) title 'WPR' with linespoints linetype 1 pointtype 8 lc 4 lw 3
