...
set xr [-0.6:9.6]
set yr [0.72:0.96]  
set ytics ("0.72" 0.72, "0.78" 0.78, "0.84" 0.84, "0.90" 0.90, "0.96" 0.96)
...
set label 8 "-0.16%" at 5.65,0.865 font "Times-Roman,13" rotate by 40 textcolor rgb "#0000FF"
set label 9 "-0.02%" at 6.65,0.86 font "Times-Roman,13" rotate by 40 textcolor rgb "#0000FF"
