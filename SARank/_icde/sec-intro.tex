...
%
Besides, efforts have also been made from the industry, among which Google Scholar~\cite{g-scholar}, Microsoft Academic~\cite{ms-academic} and Semantic Scholar~\cite{sem-scholar} are the most prominent. More specifically, Google Scholar aims to rank articles in the way researchers do, weighing the full text, where they were published, who they were written by, as well as how often and how recently they have been cited.
...
%
(b) Our batch algorithm \batensemble and incremental algorithm \incensemble are also efficient. Indeed, \incensemble is on average (1.6, 3.1, 81) and (2.0, 4.1, 229) times faster than (\batensemble, \futurerank, \hhgrank)  on the large \aminer and \magdata, respectively.
%%%%%%%%%%%%%%%%%%%%%%%%%
