...
%
Besides, efforts have also been made from the industry, \eg Microsoft Academic~\cite{ms-academic}, Google Scholar~\cite{g-scholar}  and Semantic Scholar~\cite{sem-scholar}. More specifically, Google Scholar aims to rank articles in the way researchers do, weighing the full text, where they were published, who they were written by, as well as how often and how recently they have been cited.
