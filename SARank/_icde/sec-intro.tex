...
On the other hand, Semantic Scholar~\cite{sem-scholar} proposes to use the citation velocity feature, which is a weighted average number of the publication's citations for the last three years.
}
...
\marked{Finally, the bias caused by the dynamism of data has never been exploited in scholarly article ranking}.
...
%
\marked{To the best of our knowledge, the Time-Weighted PageRank in this work is among the first to incorporate both the diverse citation patterns of individual articles and the long-term bias caused by the dynamism of data to better model the evolving prestige.}
