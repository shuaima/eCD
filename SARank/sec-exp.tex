...
%\etitle{Exp-2.1}. 
\stitle{Exp-2.1}.%varying number of years as future period
...
%\etitle{Exp-2.2}.
\stitle{Exp-2.2}. %varying number of years as evaluate period.
...
%\etitle{Exp-2.3}.
\stitle{Exp-2.3}. %varying difference of future citation count in benchmark
