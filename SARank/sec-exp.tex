...
\begin{center}
%\hspace{10ex}
\subfigure[{\scriptsize TWPageRank (inc. vs. batch)}]{\label{fig-mag-time2}
\includegraphics[scale=0.4]{./exp/MAG_time_twpr.eps}}
\hspace{-3ex}
\subfigure[{\scriptsize Comparison of ranking algorithms}]{\label{fig-mag-time1}
\includegraphics[scale=0.4]{./exp/MAG_time.eps}}
\end{center}
\vspace{-4.5ex}
