...
To evaluate the ranking effectiveness in different scenarios, we varied three factors in our tests: the splitting year $Y_s$, the largest number $b$ of existing years of articles to be ranked, and the least difference $dif$ of future citation counts.


%varying number of years as future period
\etitle{Exp-2.1}. 
%\stitle{Exp-2.1}. 
To evaluate the impacts of the splitting year $Y_s$, 
we varied the splitting year $Y_s$ from 2005 to 2010 on \aan and from 2010 to 2015 on both \aminer and \magdata.
