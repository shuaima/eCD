...
These datasets were further cleaned by deleting self citations and citations with error time information, which accounted for (0.1\%, 1.8\%, 0.4\%) of the total citations on (\aan, \aminer, \magdata).
