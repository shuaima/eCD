...
When varying $\sigma$, the \PairAcc of \ensemblerank is almost stable on all datasets using both \fcita and \recom. Indeed, with \recom and \fcita, the \PairAcc only varies (0.19\%, 0.83\%, 0.41\%) and (0.66\%, 0.33\%, 0.60\%) on (\aan, \aminer, \magdata), respectively.
