...
\noindent
(1) \recom~\cite{Liang16AAAI} assumes scholarly articles with more recommendations are of higher importance.
...
\etitle{Exp-2.3}.
%\stitle{Exp-2.3}.
To evaluate the effectiveness of ranking \wrt\ {\em the different of future citations},
