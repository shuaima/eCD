\stitle{Related work}. %We summarize related work from the following aspects.
%
...
Further, although there exist several studies on incremental PageRank computation~\cite{DesikanPSK05,AbiteboulPC03,WuR09} \marked{and incremental PageRank approximation\cite{BahmaniCG10,BahmaniKMU12}}, none of them has been applied for scholarly article ranking.
...
\marked{In this work, following the idea of ensembles, we assemble importance of different entities  to produce better and robust results for scholarly article ranking~\cite{zhihua-book,wsdmcup,DuanAMHH16}.}
