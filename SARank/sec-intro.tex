...
%
(b) Our batch algorithm \batensemble and incremental algorithm \incensemble are efficient, and  \incensemble is on average (1.8, 2.8, 3.9, 203) times faster than (\batensemble, \powensemble, \futurerank, \hhgrank)  on the large dataset \magdata.
