...
plot "AMiner_sigma.tab" using ($1):($4) title 'SARank(FCita)' with linespoints linetype 1 pointtype 2 lc 7 lw 3,\
"AMiner_sigma.tab" using ($1):($2) title 'SARank(Recom)' with linespoints linetype 0 pointtype 6 lc 7 lw 3 