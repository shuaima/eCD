...
set key vertical samplen 3.3 spacing 1 at graph 0.97, 0.3
...
"AMiner_sigma.tab" using ($1):($2) title 'ERank(Recom)' with linespoints linetype 0 pointtype 6 lc rgb "#D2691E" lw 3