...
set xr [1:6]
set yr [0.3:0.9]  
set ytics ("0.30" 0.3, "0.42" 0.42, "0.54" 0.54, "0.66" 0.66, "0.78" 0.78, "0.90" 0.9)
...
plot "MAG_PairAcc2.tab" using ($1):($2) title 'ERank' with linespoints linetype 1 pointtype 6 lc 7 lw 3,\
"MAG_PairAcc2.tab" using ($1):($5) title 'HRank' with linespoints linetype 1 pointtype 4 lc rgb "blue" lw 3,\
"MAG_PairAcc2.tab" using ($1):($3) title 'FRank' with linespoints linetype 1 pointtype 2 lc rgb "green" lw 3,\
