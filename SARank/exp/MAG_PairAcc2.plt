...
set key horizontal samplen 2.0 spacing 1.2 at graph 0.99, 0.3
#set key horizontal font ",13" 
plot "MAG_PairAcc2.tab" using ($1):($5) title 'HRank' with linespoints linetype 1 pointtype 4 lc rgb "blue" lw 3,\
