set terminal postscript portrait enhanced color "Times-Roman" 15
...
set xr [0:1]
set yr [0.60:0.90]  
set ytics ("0.60" 0.60, "0.66" 0.66, "0.72" 0.72, "0.78" 0.78, "0.84" 0.84, "0.90" 0.90)
...
set xlabel "importance weighting factor {/Symbol l}" offset 0,0.5
