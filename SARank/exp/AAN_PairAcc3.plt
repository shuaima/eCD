...
plot "AAN_PairAcc3.tab" using ($1):($5) title 'ERank' with linespoints linetype 1 pointtype 6 lc 7 lw 3,\
"AAN_PairAcc3.tab" using ($1):($4) title 'HRank' with linespoints linetype 1 pointtype 4 lc rgb "blue" lw 3,\
"AAN_PairAcc3.tab" using ($1):($3) title 'FRank' with linespoints linetype 1 pointtype 2 lc rgb "green" lw 3,\
