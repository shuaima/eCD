...
Given an update $\Delta$ = $\Delta V\cup\Delta E$ of graph $G(V,E)$, and the TWPageRank vector and topological order of $G$, algorithm \inctwprscc takes $O(|V\cup \Delta V|+|E\cup\Delta E\setminus E_A|+t^+|E_{B,i}\cup E_{C,i}|)$ time.
\end{theorem}
