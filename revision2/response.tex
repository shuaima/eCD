...
We have incorporated order dependencies into the discussion (the last paragraph in the left column of page 3), and we have also added a discussion in the end of the related work part (page 3). Thanks for the suggestion!  Note that, to save space, we also removed some references, mostly our own previous work
