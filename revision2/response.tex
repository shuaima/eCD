...
Attached please find a revised version of our submission to TIEEE Transactions on Knowledge and Data Engineering,
...
%
(1) we have added and discussed five new references in the related work, including the four papers mentioned by Referee 1, and
%
(2) we have further tested a new algorithm (Transit Node Routing, TNR) and a new dataset (the co-authorship network, DBLP) in the experimental study, and
%
...
These papers have been cited and incorporated into the related work, and we have also added more details on how these techniques are complementary to our work (page 2, item (2) in the related work). Thanks!
