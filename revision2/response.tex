...
We have changed all $t$ to $t_1$ in bullet (1) (page 9).  Thanks for spotting this out!
...
This is caused by the different ratios of $CFD^ps$ and $CIND^ps$  and their approximate $CFDs$ and $CINDs$ in DBLP and HOSP, and the more $CFD^ps$  and $CIND^ps$ that can bee expressed by their corresponding approximate $CFDs$ and $CINDs$, the smaller the gap is for the accuracy tests.
%
...
Hence, we added a discussion on the axiomatization in the end of Section 4.2, as reviewer 1 suggested. Thanks for the suggestion!
...
We have incorporated order dependencies into the discussion (the last paragraph in the left column of page 3), and we have also added a discussion on these references in the end of the related work part (page 3). Thanks for the suggestion!  Note that, to save space, we also removed some references, mostly our own previous work
