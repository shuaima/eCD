...
Hence, we added a dissuasion on the axiomatization in the end of Section 4.2, as reviewer 1 suggested.
...
We have added the following three new references, \eg order dependencies, metric functional dependencies and differential Dependencies, and we have also added a discussion in the end of related work. Thanks for the suggestion!  Note that, to save space, we also removed some references, mostly our own previous work.

[27] S. Ginsburg and R. Hull. Order dependency in the relational model. Theor. Comput. Sci., 26:149¨C195, 1983.
