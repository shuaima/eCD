...
\begin{figure}
\begin{center}
 \includegraphics[scale=0.8]{./extended-proxies.eps}
\end{center}
 \vspace{-1.5ex}
...
%\subsection{Good Properties of Proxies and DRAs}
%\label{subsec-proxy-properties}

We then show that  proxies and \dras indeed hold good properties for answering shortest path and distance queries.
