%\documentclass[10pt,conference,compsoc,twoside]{IEEEtran}
\documentclass[10pt,conference,balance,letterpaper]{IEEEtran}
...
\newenvironment{theorem}{\begin{em}
        ...
        \end{em}\eop\vspace{0.0ex}} %\hspace*{\fill}\vspace*{1ex}}
...
\newenvironment{lemma}{\begin{em}
        ...
        \end{em}\eop\vspace{0ex}} %\hspace*{\fill}\vspace*{1ex}}
...
\newenvironment{definition}{
        ...
        {\noindent\bf Definition {\bf \thedefinition}:}}{\eop\vspace{0.5exex}
}
...
\newcommand{\ltitle}[1]{\noindent{\large\bf #1}}
\newcommand{\stitle}[1]{\vspace{0.0ex} \noindent{\bf #1}}
...
\title{Proxies for Shortest Path and Distance Queries\\ {\large\textnormal{(Extended Abstract)}}}

\author{\IEEEauthorblockN{Shuai Ma\IEEEauthorrefmark{1}\IEEEauthorrefmark{2},
 Kaiyu~Feng\IEEEauthorrefmark{3},
Jianxin~Li\IEEEauthorrefmark{1}\IEEEauthorrefmark{2},
Haixun~Wang\IEEEauthorrefmark{4},
Gao~Cong\IEEEauthorrefmark{3},
Jinpeng Huai\IEEEauthorrefmark{1}\IEEEauthorrefmark{2}
\IEEEauthorblockA{\IEEEauthorrefmark{1}SKLSDE Lab, Beihang University, Beijing, China}
\IEEEauthorblockA{\IEEEauthorrefmark{2}Beijing Advanced Innovation Center for Big Data and Brain Computing, Beijing, China}
\IEEEauthorblockA{\IEEEauthorrefmark{3}School of Computer Science and Engineering, Nanyang Technological University, Singapore}
\IEEEauthorblockA{\IEEEauthorrefmark{4}Facebook Inc., USA}
%\{mashuai, lijx, huaijp\}@buaa.edu.cn \hspace{1ex} \{kfeng002@e., gaocong@\}ntu.edu.sg \hspace{1ex} haixun@gmail.com}}
...
This study investigates a light-weight data reduction technique for speeding-up shortest  path and distance queries on large graphs.
%
We propose a notion of {\em routing  proxies} (or simply proxies), each of which represents a small subgraph, referred to as deterministic routing areas (\dras). We show that routing proxies hold good properties for speeding-up shortest path and distance queries, and there exists a {\em linear-time} algorithm to compute routing proxies and their corresponding \dras.
%
Finally, we discuss the experimental results, and verify that our solution is a general technique for reducing graph sizes and
...
This work is supported in part by  973 Program ({\small No. 2014CB340300}), NSFC ({\small No. U1636210\&61421003\&61322207}), Special Funds of Beijing Municipal Science \& Technology Commission, and MSRA Collaborative Research Program.
