...
constraints~\cite{FlescaFP05}. Finally, distributed violation detection methods for \pCFDs and \pCINDs are to be studied to deal with larger datasets, along the same lines as \cite{dis-FanGMM10}.
