...
to develop effective algorithms for discovering \pCFDs and \pCINDs,
along the same lines as \cite{divesh08,BauckmannALMN12,ZanziT14}. Third, we plan
...
constraints~\cite{BertossiBFL08}, and aggregate
constraints~\cite{FlescaFP05}.
%Finally, distributed violation detection methods for \pCFDs and \pCINDs are to be studied to deal with larger datasets, along the same lines as %\cite{dis-FanGMM10}.
