...
\emph{online algorithms enforces the constrained global checking policy}.
...
Several line simplification algorithms have been developed \eg by combining \dpa or \pavlidis with sliding or opening windows for online processing\cite{Meratnia:Spatiotemporal, Keogh:online}.
...
\bqsa \cite{Liu:BQS} uses a new distance checking method by picking out at most eight special points from an open window based on a convex hull. The time complexity of \bqsa is $O(n^2)$ in the worst case.
