...
%
\textcolor{blue}{Besides, online algorithms need to addresses the problem of balancing the trade-off between the energy cost due to communication and the accuracy of the trajectories’ representation \cite{Ghica:DTracking}.}
%
