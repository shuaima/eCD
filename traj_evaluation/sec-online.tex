...
The \bqsa algorithm \cite{Liu:BQS} is essentially an opening window and top-down algorithm\cite{Meratnia:Spatiotemporal}. It reduces the compression time by introducing \textit{convex hulls} that bound a certain number of points. This strategy makes \bqsa be \ped specific.
