...
%
\textcolor{blue}{Besides, in environments like Wireless Sensor Networks, online algorithms also need to address the problem of balancing the trade-off between the energy cost due to communication and the accuracy of the trajectories’ detection and representation \cite{Ghica:DTracking}.}
%
