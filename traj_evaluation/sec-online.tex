...
It is worth pointing out that its simply version, \fbqsa, essentially avoids case (3) to fast the process. The performance of \fbqsa has already been evaluated in work \cite{Lin:Operb}. %our preview work
