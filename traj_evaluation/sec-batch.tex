...
Algorithm \dpa also supports \sed \cite{Meratnia:Spatiotemporal}, and it runs in the same routine as using \ped. %, except that $ped$ in Figure~\ref{alg:dp} is replace by $sed$.
