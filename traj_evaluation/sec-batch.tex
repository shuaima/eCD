...
\textcolor{blue}{Originally, it uses \ped, however, it is easy to be extended to support \sed and \dad.}
...
\textcolor{blue}{The \tpa algorithm like \dpa algorithm originally supports \ped, and it is also easy to be extended to support \sed and \dad.}
