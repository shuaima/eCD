...
Algorithms Ramer \cite{Ramer:Split} and Douglas-Peucker (\dpa)  \cite{Douglas:Peucker} are similar, and support all the three distances \ped, \sed and \dad. {Note that the \dpa using \sed is also called TD-TR \cite{Meratnia:Spatiotemporal}}.
