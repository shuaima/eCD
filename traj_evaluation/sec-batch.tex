...
%Variations on the Top-Down algorithm were independently introduced in several fields in the early 1970's [14]. Douglas-Peucker algorithm [9] in cartography and Ramer  algorithm [29] in image processing share the similar routine, and they support all the three ...
...
\begin{figure}[tb!]
	\centering
	\includegraphics[scale=0.425]{Figures/Fig-pavlidis.png}\vspace{-1ex}
	\caption{\small Example of algorithm Theo-Pavlidis.}	\vspace{-2ex}
	\label{fig:pavlidis}
\end{figure}
