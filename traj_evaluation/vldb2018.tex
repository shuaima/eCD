...
%\title{Trajectory Compression and Line Simplification: A Comprehensive Evaluation and New Approach}
%\title{Trajectory Compression and Line Simplification: An Experimental Evaluation and New Approach}
...
%\title{Piece-wise Line Simplification of Trajectory: An Experimental Evaluation and New Approach}
...
\author{
\alignauthor
    Xuelian Lin\hspace{1.5ex} Jiahao Jiang\hspace{1.5ex} Shuai Ma$^{*}$\hspace{1.5ex} Yimeng Zuo\hspace{1.5ex} Chunming Hu\hspace{1.5ex} \\   %Tianyu Wo\hspace{1.5ex}\\
   ...
   % \affaddr{BAI Center for Big Data and Brain Computing, Beijing, China}\\
    \email{\{linxl, jiangjh, mashuai, zuoym, hucm\}@buaa.edu.cn}  %, hucm, woty
}
