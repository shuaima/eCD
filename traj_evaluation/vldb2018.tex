...
This paper presents an experimental comparison of the state-of-the-art line simplification algorithms for trajectory compression, including {both optimal and sub-optimal methods that use distance metrics either the \emph{perpendicular Euclidean distances} or the \emph{synchronous Euclidean distances}}. 
