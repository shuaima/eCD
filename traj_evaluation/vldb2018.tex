...
\vldbTitle{Line Simplification Algorithms for Trajectory Compression: An Experimental Evaluation}
\vldbAuthors{Authors} %Xuelian Lin, Jiahao Jiang, Shuai Ma, Tianyu Wo, and Chunming Hu
