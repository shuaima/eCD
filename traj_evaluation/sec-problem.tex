...
%%%{It is worth pointing out that in some algorithms, they do not directly define threshold on a distance, instead, they accumulate the distances of points to a line segment and define a threshold on the accumulated value. For example, algorithms MRPA and DOTS use ISSD which is an accumulated value of \ped. }
