...
\begin{table*}
	...
	\begin{tabular}{|l|c|c|c|c|c|c|c|}
		...
		\sia~\cite{Williams:Longest,Sklansky:Cone,Dunham:Cone, Zhao:Sleeve}	&one-pass	& Sector intersection        &Y & N  & $O(n)$ & O(1) \\		\hline
		\cia~\cite{Lin:Cised}	&one-pass	& Spatio-temporal Cone intersection        &N & Y & $O(n)$ & O(1) \\		\hline
