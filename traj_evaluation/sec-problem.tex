...
Notations used are summarized in Table \ref{tab:notations}.
	\begin{table}
		...
		\begin{tabular}{|c|l|}
			...
			$ped\left(P, \mathcal{L}\right)$ &  {the perpendicular Euclidean distance of $P$ to $\mathcal{L}$}	\\	\hline
			$sed\left(P, \mathcal{L}\right)$ & {the synchronous Euclidean distance of $P$ to $\mathcal{L}$} 	\\		\hline
			$dad\left(\mathcal{L}_1, \mathcal{L}_2\right)$ & {the direction-aware distance of $\mathcal{L}_1$ to $\mathcal{L}_2$} 	\\		\hline
