...
\textcolor{blue}{\dad differs from \ped and \sed in that it is a measure of angle, rather than Euclidean distances.}
...
\begin{figure}[tb!]
	\centering
	\includegraphics[scale=0.45]{Figures/Fig-DP.png}\vspace{-2ex}
	\caption{\small A trajectory is simplified by algorithm \dpa using distance metrics \ped, \sed and \dad, respectively.}	\vspace{-2ex}
	\label{fig:dp}
\end{figure}
