...
\stitle{(2) Choice of distance metrics}. Users essentially choose a distance metric of \ped, \sed and \dad based on the needs of applications, \eg~\sed is the only distance metric that is query friendly \myblue{\wrt~the \emph{where\_at}, \emph{range} and \emph{nearest\_neighbor} queries, hence, it is the best choice for such applications; and all of them are not friendly \wrt the \emph{where\_at} query.}
%
