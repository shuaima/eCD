...
In addition, the \interval\cite{Ke:Interval} approach is somehow very like the \emph{sector intersection} method except that it is specifically designed for the direction-aware distance \dad.
%
