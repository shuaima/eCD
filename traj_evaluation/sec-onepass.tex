...
%
In Reumann-Witkam routine (\rwa)\cite{Reumann:Strip}, it builds a strip paralleling to the line connecting the first two points, then the points within this strip compose one section of the line.
\rwa also runs fast but it is limited in compression ratio.
%
