...
Direction range intersection \cite{Long:Direction} approach (\eg\ \intersec \cite{Long:Direction} and \interval \cite{Ke:Interval}) is somehow like the \emph{sector intersection} methods except that they are designed for \dad,
