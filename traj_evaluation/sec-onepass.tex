...
\begin{example}
	...
	Figure~\ref{fig:sleeve} is a running example of narrow \emph{cone} taking a distance tolerance $\epsilon/2$. At the beginning, $P_0$ is the first start point, $P_1$, $P_2$, $P_3$ and so on, each has a narrow \emph{sector}.
...
\begin{figure}[tb!]
	\centering
	\includegraphics[scale=0.8]{figures/Fig-Conest.png}
	%\vspace{-2ex}
