...
\begin{example}
	...
	Figure~\ref{fig:exm-conest} shows a running example of \cised($\frac{\epsilon}{2}$) for compressing the trajectory \trajec{T} in Figure~\ref{fig:dp}.
...
\stitle{Algorithms \intersec \cite{Long:Direction} and \interval \cite{Ke:Interval} Using \dad.}
