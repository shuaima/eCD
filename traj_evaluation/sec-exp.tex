...
\stitle{Analysis of distance metrics.}
{The algorithm \dpa using \ped, \sed and \dad have the similar running time in all datasets, it is likely the distance metrics do not have much impacts on running time.}
\todo{run cases to test the cost of running a certain distance metric.}
