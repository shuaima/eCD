...
($124.74\%$, $131.01\%$, $138.01\%$, $131.01\%$), ($129.95\%$, $140.56\%$,
$139.00\%$, $140.56\%$)
and ($113.6\%$, $120.2\%$, $120.8\%$, $120.2\%$) of the optimal algorithm \optp
...
and ($143.37\%$, $147.80\%$, $152.37\%$, $147.80\%$) of
...
$57.57\%$, $61.34\%$), ($57.56\%$, $62.66\%$, $60.23\%$, $62.66\%$),($104.8\%$,
$108.9\%$, $106.9\%$, $108.9\%$) of the optimal algorithm \optp on datasets (\ucar, \geolife, \mopsi, \act), respectively.
Algorithms \siped and \operb are comparable, and they are on average
...
(\optp, \tpa, \dpa, \bqsa, \siped, \operb ) are ($16.08$, $9.19$, $9.68$, $17.4$, $12.96$, $12.77$) when $\epsilon$ = $40m$.
...
(\optp, \nopts, \siped, \cised) are  \textcolor{red}{($156.6$, $104.8$, $27.2$, $9.7$)} seconds when $\epsilon$ = $40m$.
%
Because the optimal algorithms run too slow and it is hard to show all these algorithms in a figure, we then only report the results of sub-optimal algorithms in Figure~\ref{fig:time-epsilon-ped} and Figure~\ref{fig:time-epsilon-sed}.
...
($19.90$, $28.30$, $30.35$, $28.30$), ($18.59$, $17.21$, $16.49$, $17.21$), ($15.07$, $37.73$, $62.23$, $37.73$)
...
$16.54$, $38.35$) times slower than the one-pass algorithms \siped and \operb, respectively. 
