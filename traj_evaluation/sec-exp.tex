...
For example, in \mopsi, the average errors of algorithms
(\tpa, \dpa, \interval) are ($65.6$, $75.4$, $68.1$) meters, respectively, when
$\epsilon$ = $45$ degrees.
It is worth pointing out that the max errors of algorithms
(\tpa, \dpa, \interval) using \dad may be very large in terms of the perpendicular Euclidean distances, \eg they are ($68247.9$, $66794.4$, $68247.9$) meters, respectively, when $\epsilon$ = $45$ degrees.}
