...
\sstab  \todo{(4) When using \dad,} the compression ratios from the best
to the worst are batch algorithms \tpa  one-pass algorithm \interval, and batch algorithm \dpa. 
For example, in \mopsi, the compression ratios of algorithms
(\tpa, \dpa, \interval)
