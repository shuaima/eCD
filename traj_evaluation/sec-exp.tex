...
In this set of tests, we compare the error and compression ratios of algorithms in data aging. We set $\epsilon_1=40m$ (or $\epsilon_1=30^o$) in the first run and $\epsilon_2=60m$ (or $\epsilon_2=50^o$) in the second run, the max errors and compression ratios are reported in Tables \ref{tab:aging-me}, \ref{tab:aging-cr} and \ref{tab:cr}, respectively.
...
\ni (3) \todo{cr:  (first $\epsilon_1$ then $\epsilon_2$) vs ($\epsilon_1 + \epsilon_2$)}
