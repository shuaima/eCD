...
\stitle{Exp-1.1: Impacts of the error bound $\zeta$}.
...
Second, algorithm \operba achieves the best compression ratios on all datasets and nearly all $\zeta$ values.
...
\stitle{Exp-3.1: Impacts of the error bound $\zeta$}.
