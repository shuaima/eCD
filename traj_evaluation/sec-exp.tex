...
For algorithm \cised, we fixed parameter $m=16$ as shown in \cite{Lin:Cised}, \ie 16-edges inscribe regular polygon.
For algorithm \osed, we implement its near optimal version and fixed parameter $m=32$. The performance of the near optimal algorithm compared with the optimal algorithm refers to Appendix B.
