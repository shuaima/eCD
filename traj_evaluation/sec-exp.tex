...
%\vspace{0.5ex}
\ni \textcolor{blue}{(1) \ucar is the GPS trajectories collected by a Chinese car rental company during Apr. 2015 to Nov. 2015. Most routes are in big cities. The sampling rate was one point per $3$--$5$ seconds, and each trajectory has around $114.1K$ points.}
%.We randomly chose $1,000$ cars from them

%\vspace{0.5ex}
\ni \textcolor{blue}{(2) \geolife is the GPS trajectories collected in GeoLife project~\cite{Web:Geolife} by 182 users in a period from Apr. 2007 to Oct. 2011. These trajectories have a variety of sampling rates, among which 91\% are logged in each 1-5 seconds per point. The longest trajectory has 2,156,994 points.}

%\vspace{0.5ex}
\ni \textcolor{blue}{(3) \mopsi is the GPS trajectories collected in Mopsi project~\cite{Web:Mopsi} by 51 users in a period from 2008 to 2014. Most routes are in Joensuu region, Finland. The sampling rate was one point per $2$ seconds, and each trajectory has around $153.9K$ points.}
...
\textcolor{blue}{For algorithm \operb, the fifth optimization technique ``absorbing data points after $P_{s+k}$" is removed.}
...
\textcolor{blue}{Compression ratios and errors are the most popular metrics to evaluate the effectiveness of \lsa algorithms, and they are also metrics to evaluate the aging friendliness and query friendliness of \lsa algorithms.
Besides, running time reflects the efficiency of \lsa algorithms.}
...
%%%%%%%%%%%%%%%%%
\sstab(1) \textcolor{blue}{Datasets have some impacts on the compression ratios of \lsa algorithms. Datasets having higher sampling rates have better compression ratios when use \ped and \sed, while it is on the contrary when use \dad. Datasets collected by cars (\eg~\ucar) also have better compression ratios than datasets partially collected by individuals (\eg~\geolife and \mopsi). }
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.320]{Figures/Exp-PED-CR-epsilon-taxi.png}\hspace{3ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.320]{Figures/Exp-SED-CR-epsilon-taxi.png}\hspace{3ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.320]{Figures/Exp-DAD-CR-epsilon-taxi.png}\hspace{3ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.320]{Figures/Exp-PED-CR-size-taxi.png}\hspace{3ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.320]{Figures/Exp-SED-CR-size-taxi.png}\hspace{3ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.320]{Figures/Exp-DAD-CR-size-taxi.png}\hspace{3ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.320]{Figures/Exp-PED-error-epsilon-taxi.png} \hspace{3ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.320]{Figures/Exp-SED-error-epsilon-taxi.png} \hspace{3ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.320]{Figures/Exp-DAD-error-epsilon-taxi.png} \hspace{3ex}
...
\sstab (1) \textcolor{blue}{Datasets have few impacts on the errors of \lsa algorithms.}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.320]{Figures/Exp-PED-error-size-taxi.png}\hspace{3ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.320]{Figures/Exp-SED-error-size-taxi.png}\hspace{3ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.320]{Figures/Exp-DAD-error-size-taxi.png} \hspace{3ex}
...
\sstab (1) \textcolor{blue}{Datasets do not have obviously impacts on the running time of \lsa algorithms.}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.320]{Figures/Exp-PED-time-epsilon-taxi.png}	\hspace{3ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.320]{Figures/Exp-SED-time-epsilon-taxi.png}	\hspace{3ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.320]{Figures/Exp-DAD-time-epsilon-taxi.png}\hspace{3ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.320]{Figures/Exp-PED-time-size-taxi.png}\hspace{3ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.320]{Figures/Exp-SED-time-size-taxi.png}\hspace{3ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.320]{Figures/Exp-DAD-time-size-taxi.png}\hspace{3ex}
...
\ni (3) \mytable{tab:aging-cr} and \mytable{tab:cr} tell that, if algorithms compress data using $\epsilon_1$ and $\epsilon_2$ in turn, then they have a bit poorer compression ratios than simplification directly using $\epsilon_3=\epsilon_1 + \epsilon_2$.
Note that the causes of this phenomenon are varied. For algorithm \dpa using \ped or \sed, it is caused by the shorten of the final error bound, which is $max\{\epsilon_1, \epsilon_2\}$, less than $\epsilon_3=\epsilon_1 + \epsilon_2$; while for the other algorithms, they loss some compression ratios because of data aging. 
...
\stitle{Analyses of \lsa algorithms.} \dpa is the only algorithm that is aging friendly \wrt ~\ped and \sed. Indeed, {aging friendly} is a result of the {specific nature} of algorithm \dpa, \ie batch and top-down, that always splits a trajectory into two sub trajectories by the same splitting point when it uses any \ped or \sed lager than the error bound.
...
\begin{table}
	...
	\begin{tabular}{|l|c|c|c|l|c|c|c|l|c|c|c|}
		...
		\hline
		{\operb} &	$\textcolor{red}{98.26} $ & $\textcolor{red}{96.53} $ & $\textcolor{red}{98.08} $	& / &- &- &- & / &- &- &- \\
		\hline
	\end{tabular}
	\label{tab:aging-me}
...
%\includegraphics[scale = 0.320]{Figures/Exp-query-ae-epsilon-private.png}
%\vspace{-1ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.320]{Figures/Exp-query-PED-error-size-taxi.png}\hspace{3ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.320]{Figures/Exp-query-SED-error-size-taxi.png}\hspace{3ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.320]{Figures/Exp-query-DAD-error-size-taxi.png} \hspace{3ex}
...
%
(5) \textcolor{blue}{Algorithms \dpa using \ped and \sed are aging friendly, while others are not. All the algorithms have bounded errors in data aging, where the error bounds of \dpa using \ped and \sed are $max\{\epsilon_1, \epsilon_2\}$ and others are $\epsilon_1 + \epsilon_2$.}
