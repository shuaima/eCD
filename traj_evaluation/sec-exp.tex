...
%
{The max and average errors of the queries are reported in Table~\ref{tab:query-me} and Figures~\ref{fig:query-ped}, \ref{fig:query-sed} and \ref{fig:query-dad}, respectively.}
