...
(\tpa, \dpa, \bqsa, \siped(${\epsilon}$), \siped($\frac{\epsilon}{2}$), \operb, \myblue{\operb-A} ) is ($232.9$, $124.2$, $469.4$, $6.89$, $7.6$, $8.6$, \myred{$9.4\%$}) seconds when $\epsilon$ = $40m$.
...
\begin{table}
	%\renewcommand{\arraystretch}{1.2}
	\caption{\small \textcolor{blue}{The max errors {($\times 10^7$ s)} of \emph{when\_at} queries on compressed trajectories: fixed $\epsilon=40m$.}}
	\centering
	\scriptsize
	\vspace{-1ex}
	\begin{tabular}{|l|c|c|c|l|c|c|c|l|c|c|c|}
		...
		\bf{Alg. (PED)}  &\ucar &\geolife &\mopsi & \bf{Alg. (SED)}  &\ucar &\geolife &\mopsi &\bf{Alg. (DAD)}  &\ucar &\geolife &\mopsi \\
		\hline
		{\dpa} &	$3.81$ & $12.6$ &	$9.26  $	&\dpa &$3.81  $ &$14.9  $ & $9.26 $ & \dpa	& $3.81 $	& $12.6 $	& $9.26 $ \\
		\hline
		{\tpa} &	$6.28$ & $14.7  $ &	$9.26  $	&\tpa 	& $3.81  $& $14.9  $ &$9.26 $ & \tpa	& $ 3.81 $	& $ 12.6 $	& $ 9.26  $ \\
		\hline
		{\bqsa} &	$5.53$ & $13.9 $ &	$ 21.3 $	&\squishe &$3.81  $ & $ 12.6  $ & $9.26 $ & \opwa	& $3.81 $	& $ 12.6$	& $9.26 $ \\
		\hline
		{\siped($\epsilon$)} &	$3.81$ & $12.6  $ &	$9.26  $	&\cised($\epsilon$) & $3.81  $ &$ 24.2	  $ &$9.26 $ & \interval	& $3.81 $	& $12.6 $	& $ 9.26 $ \\
		\hline
		{\siped($\frac{\epsilon}{2}$)} &	$3.81$ & $12.6 $ &	$ 9.26 $ &\cised($\frac{\epsilon}{2}$) &$ 3.81 $ & \myred{$463$} & $9.26 $& \intersec	& $ 3.81 $	& $ 12.6$	& $ 9.26 $ \\
		\hline
		{\operb} &	$3.81 $ & $12.6  $ & $9.26  $	& {\dagots} &$3.81$ &$62.7$ & $9.26$ & /&- &- &- \\
		\hline
		 {\operb-A} &	${3.81} $ & ${24.5} $ & ${12.4} $	&  {\cised-W} &$2.82$ &$12.6$ &$4.68$ & / &- &- &- \\
		\hline
	\end{tabular}
...
\myblue{Besides, all these algorithms and distance metrics may result in unbound \emph{when\_at} queries, as proved in \cite{Cao:Spatio}.}
