...
(\tpa, \dpa, \bqsa, \siped, \operb ) are ($64.7$, $34.5$,\textcolor{red}{0.0}, $2.1$, $2.4$) hours \textcolor{red}{when $\epsilon$ = $40m$}.
...
For example, in \mopsi, the running time of algorithms
(\tpa, \dpa, \squishe, \cised) are  ($43.5$, $29.1$, $7.7$, $2.7$) hours \textcolor{red}{when $\epsilon$ = $40m$}.
