...
To compare the compression ratios of these algorithms and evaluate the impacts of $\epsilon$ on compression ratios of them, we varied $\epsilon$ from $10m$ to $100m$ on the entire four datasets, respectively.
%
The results are reported in Figure~\ref{fig:cr-ped} and Figure~\ref{fig:cr-sed}.
%
Note given a set of trajectories $\{\dddot{\mathcal{T}_1}, \ldots, \dddot{\mathcal{T}_M}\}$ and their piecewise line representations
...
To compare the errors of these algorithms and evaluate the impacts of $\epsilon$ on errors of them, we varied $\epsilon$ from $5m$ to $100m$ on the entire \taxi, \truck, \ucar and \geolife, respectively.
