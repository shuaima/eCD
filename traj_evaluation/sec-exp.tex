...
We use three real-life datasets shown in \mytable{tab:datasets}, namely, Service car trajectory data (\ucar) collected by a Chinese car rental company, Geolife trajectory data (\geolife) collected in GeoLife project~\cite{Web:Geolife} and \mopsi trajectory data (\mopsi) collected in Mopsi project \cite{Web:Mopsi}, to evaluate those \lsa algorithms.
...
For algorithm \cised($\epsilon$) and \cised($\frac{\epsilon}{2}$), we fixe parameter $m=16$ as evaluated in \cite{Lin:Cised}, \ie 16-edges inscribe regular polygon.
...
($113.32\%$, $120.22\%$, $120.83\%$) and ($116.04\%$, $124.46\%$, $124.24\%$) of the optimal algorithm \opt
...
($136.73\%$, $150.23\%$, $152.29\%$)
and ($143.14\%$, $147.80\%$, $152.37\%$) of \opt on \dSets, respectively.
%
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.30]{Figures/Exp-PED-CR-epsilon-taxi.png}\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-PED-CR-epsilon-service.png} 	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-PED-CR-epsilon-geolife.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-PED-CR-epsilon-mopsi.png}		
	\vspace{-2ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.30]{Figures/Exp-SED-CR-epsilon-taxi.png}\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-SED-CR-epsilon-service.png} 	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-SED-CR-epsilon-geolife.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-SED-CR-epsilon-mopsi.png}		
	\vspace{-2ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.30]{Figures/Exp-DAD-CR-epsilon-taxi.png}\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-DAD-CR-epsilon-service.png} 	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-DAD-CR-epsilon-geolife.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-DAD-CR-epsilon-mopsi.png}		
	\vspace{-2ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.30]{Figures/Exp-PED-CR-size-taxi.png}\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-PED-CR-size-service.png} 	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-PED-CR-size-geolife.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-PED-CR-size-mopsi.png}		
	\vspace{-2ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.30]{Figures/Exp-SED-CR-size-taxi.png}\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-SED-CR-size-service.png} 	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-SED-CR-size-geolife.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-SED-CR-size-mopsi.png}		
	\vspace{-2ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.30]{Figures/Exp-DAD-CR-size-taxi.png}\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-DAD-CR-size-service.png} 	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-DAD-CR-size-geolife.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-DAD-CR-size-mopsi.png}		
	\vspace{-2ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.30]{Figures/Exp-PED-error-epsilon-taxi.png} \hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-PED-error-epsilon-service.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-PED-error-epsilon-geolife.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-PED-error-epsilon-mopsi.png}	
	\vspace{-2ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.30]{Figures/Exp-SED-error-epsilon-taxi.png} \hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-SED-error-epsilon-service.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-SED-error-epsilon-geolife.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-SED-error-epsilon-mopsi.png}		
	\vspace{-2ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.30]{Figures/Exp-DAD-error-epsilon-taxi.png} \hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-DAD-error-epsilon-service.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-DAD-error-epsilon-geolife.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-DAD-error-epsilon-mopsi.png}	
	\vspace{-2ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.30]{Figures/Exp-PED-error-size-taxi.png}\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-PED-error-size-service.png} 	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-PED-error-size-geolife.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-PED-error-size-mopsi.png}		
	\vspace{-2ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.30]{Figures/Exp-SED-error-size-taxi.png}\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-SED-error-size-service.png} 	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-SED-error-size-geolife.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-SED-error-size-mopsi.png}		
	\vspace{-2ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.30]{Figures/Exp-DAD-error-size-taxi.png} \hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-DAD-error-size-service.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-DAD-error-size-geolife.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-DAD-error-size-mopsi.png}	
	\vspace{-2ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.30]{Figures/Exp-PED-time-epsilon-taxi.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-PED-time-epsilon-service.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-PED-time-epsilon-geolife.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-PED-time-epsilon-mopsi.png}	\hspace{1ex}
	\vspace{-2ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.30]{Figures/Exp-SED-time-epsilon-taxi.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-SED-time-epsilon-service.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-SED-time-epsilon-geolife.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-SED-time-epsilon-mopsi.png}	\hspace{1ex}
	\vspace{-2ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.30]{Figures/Exp-DAD-time-epsilon-taxi.png}\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-DAD-time-epsilon-service.png} 	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-DAD-time-epsilon-geolife.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-DAD-time-epsilon-mopsi.png}		
	\vspace{-2ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.30]{Figures/Exp-PED-time-size-taxi.png}\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-PED-time-size-service.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-PED-time-size-geolife.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-PED-time-size-mopsi.png}	\hspace{1ex}
	\vspace{-2ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.30]{Figures/Exp-SED-time-size-taxi.png}\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-SED-time-size-service.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-SED-time-size-geolife.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-SED-time-size-mopsi.png}	\hspace{1ex}
	\vspace{-2ex}
...
\begin{figure*}[tb!]
	\centering
	%\includegraphics[scale=0.30]{Figures/Exp-DAD-time-size-taxi.png}\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-DAD-time-size-service.png} 	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-DAD-time-size-geolife.png}	\hspace{1ex}
	\includegraphics[scale=0.30]{Figures/Exp-DAD-time-size-mopsi.png}		
	\vspace{-2ex}
...
{We first compress these trajectories using \ped and \sed, respectively. When compressing, we also fixed {$m$=$16$} for algorithm \cised and varied $\epsilon$ from $10$ to $200$ meters for all algorithms on the entire four datasets, respectively.}
...
\ni {(1) When using \sed, the max errors of spatio-temporal queries on compressed trajectories are always not larger than error bounds. However, when using \ped, they are more than $10^6$ metres in datasets \taxi, \ucar, \geolife and \mopsi, significantly larger than error bounds. This large-error phenomenon is actually possible. For example, if someone travels from Beijing of China to Sydney of Australia. During the trip, he first closes his mobile when the air plane is ready to take off, then he turns on his mobile after he arrives at Sydney. Because the sub-trajectory includes data points located in two small regions, \ie the Beijing and Sydney airports, it is possible that the sub-trajectory is compressed by some \lsa algorithm using \ped into a single line segment, even the error bound $\epsilon$ is set to just $60$ metres. When a {\emph where\_at} is performed on the long line segment, it may return an approximate point having a large error to the actual position.}
%
...
\begin{table}[bt!]
	...
	\begin{tabular}{|l|c|c|c|c|}
		\hline
		\bf{Alg.}  &\ucar &\geolife &\mopsi \\
		\hline
		\kw{SIPED}	 &$4.81 \times 10^6$	    	&$1.91 \times 10^6$	    &$1.40 \times 10^6$    \\
		\hline
        \kw{DPPED}	&$4.27 \times 10^6$	    &$1.03 \times 10^6$	    &$4.21 \times 10^6$  \\
		\hline
		\dps  &59.99	    &59.99	    &59.99   \\
		\hline
		\cised	 &59.99	    &59.99	        &59.99       \\
		\hline
		\squishe &59.99	    &59.98	        &59.99      \\
		\hline
	\end{tabular}
	\label{tab:query-me}
	\vspace{-2ex}
...
\ni {(2) Given the same error bound, the average errors of these queries on compressed trajectories using \ped are obvious larger than those using \sed, and they are typically larger than error bounds. Moreover, algorithm \siped using \ped has larger spatio-temporal query errors than \dpa using \ped because \siped applies a greedy policy that tries to include as many points into a line segment, and some of these ``extra-points'' lead to large errors.}
