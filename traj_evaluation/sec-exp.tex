...
\begin{table}
	...
	\begin{tabular}{|l|c|c|c|r|}
		...
		\taxi	&\textcolor{red}{500}	    &60	        &\textcolor{red}{$\sim39.1$}      &\textcolor{red}{39.1M} \\	\hline
...
\begin{figure*}[tb!]
	\centering
	\includegraphics[scale=0.315]{Figures/Exp-small-CR-epsilon-taxi.png}\hspace{1ex}
	\includegraphics[scale=0.315]{Figures/Exp-small-CR-epsilon-service.png} 	\hspace{1ex}
	\includegraphics[scale=0.315]{Figures/Exp-small-CR-epsilon-geolife.png}	\hspace{1ex}
	\includegraphics[scale=0.315]{Figures/Exp-small-CR-epsilon-mopsi.png}		
	\vspace{-2.5ex}
	\caption{\small Evaluation of compression ratios (\ped and \sed): varying the error bound $\epsilon$.}
	\label{fig:cr-all}
	\vspace{-2ex}
\end{figure*}
...
\begin{figure*}[tb!]
	\centering
	\includegraphics[scale=0.315]{Figures/Exp-small-error-epsilon-taxi.png} \hspace{1ex}
	\includegraphics[scale=0.315]{Figures/Exp-small-error-epsilon-service.png}	\hspace{1ex}
	\includegraphics[scale=0.315]{Figures/Exp-small-error-epsilon-geolife.png}	\hspace{1ex}
	\includegraphics[scale=0.315]{Figures/Exp-small-error-epsilon-mopsi.png}	
	\vspace{-2.5ex}
	\caption{\small Evaluation of average errors (\ped and \sed): varying the error bound $\epsilon$.}
	\label{fig:ae-all}
	\vspace{-2ex}
\end{figure*}
...
\begin{figure*}[tb!]
	\centering
	\includegraphics[scale=0.315]{Figures/Exp-small-time-epsilon-taxi.png}\hspace{1ex}
	\includegraphics[scale=0.315]{Figures/Exp-small-time-epsilon-service.png} 	\hspace{1ex}
	\includegraphics[scale=0.315]{Figures/Exp-small-time-epsilon-geolife.png}	\hspace{1ex}
	\includegraphics[scale=0.315]{Figures/Exp-small-time-epsilon-mopsi.png}		
	\vspace{-2.5ex}
	\caption{\small Evaluation of compression ratios (\ped and \sed): varying the error bound $\epsilon$.}
	\vspace{-2ex}
\end{figure*}
