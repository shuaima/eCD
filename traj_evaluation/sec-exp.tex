...
%
Because the optimal algorithms run too slow which makes it hard to show all these algorithms in a figure, we then only report the results of sub-optimal algorithms in Figure~\ref{fig:time-epsilon-ped} and Figure~\ref{fig:time-epsilon-sed}.
