...
\begin{figure*}[tb!]
\centering
\includegraphics[scale = 0.295]{Figures/Exp-query-ae-epsilon-service.png}\hspace{3ex}
\includegraphics[scale = 0.295]{Figures/Exp-query-ae-epsilon-geolife.png}\hspace{3ex}
\includegraphics[scale = 0.295]{Figures/Exp-query-ae-epsilon-mopsi.png}\hspace{3ex}
