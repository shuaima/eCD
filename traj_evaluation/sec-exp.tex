...
(\opt, \tpa, \dpa, \bqsa, \siped($\frac{\epsilon}{2}$), \operb ) are ($16.08$, $9.19$, $9.68$, $17.4$, $12.96$, $12.77$)  metres when $\epsilon$ = $40m$.
%
...
(\tpa, \dpa, \squishe, \cised($\frac{\epsilon}{2}$)) in \mopsi are ($12.17$, $12.20$, $6.76$, $14.71$) metres, respectively, when $\epsilon$ = $40m$.
%
