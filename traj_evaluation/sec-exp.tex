...
\begin{table}
	...
	\vspace{-1ex}
	\caption{\small The max errors of data aging that set $\epsilon=40m$ (or $\epsilon=30^o$) in the first compression and $\epsilon=60m$ (or $\epsilon=50^o$) in the second compression.}
	\centering
	\scriptsize
...
\begin{table}
	%\renewcommand{\arraystretch}{1.2}
	\vspace{-1ex}
	\caption{\small The compression ratios of data aging that set $\epsilon=40m$ (or $\epsilon=30^o$) in the first compression and $\epsilon=60m$ (or $\epsilon=50^o$) in the second compression.}
	\centering
	\scriptsize
	\begin{tabular}{|l|c|c|c|l|c|c|c|l|c|c|c|}
		\hline
