...
\textcolor{blue}{Comparing with the recent experimental study \cite{Zhang:Evaluation}, this work has the following new findings: 
	...
	(2) the efficiency of algorithms \wrt distance metrics, error bounds and data sizes are also revealed, as summarized in this section. Besides, our tests tell that the running time from the fastest to the slowest is normally \intersec, \interval, \operb, \squishe, \dpa, \opwa, \dagots and \bqsa in all datasets, which is partially different from \cite{Zhang:Evaluation} that is \intersec, \interval, \dpa, \operb, \dagots, \opwa, \squishe and \bqsa, 
