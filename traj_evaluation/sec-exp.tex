...
{Note the additional test of the effectiveness of the near optimal algorithm (\nopts), and the efficiencies of the (near) optimal algorithms are presented in Appendix B.}
...
The results, except the optimal algorithms (see Appendix B.2), are reported in Figure~\ref{fig:time-epsilon-ped} and Figure~\ref{fig:time-epsilon-sed}.
