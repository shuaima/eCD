...
(1) the compression ratios and average errors of these algorithms, and the impacts of distance metrics,\ie \sed and \ped, to them, and
...
3.40GHz  and 8GB of memory. {Java max heap size 4GB}
...
and varied the size \trajec{|T|} of a trajectory from $1,000$ points to $10,000$ points, while fixed error bound $\epsilon = 60$ meters.
...
\dpa, one-pass algorithm \cised, and online algorithm \squishe. 
%
\textcolor{red}{Algorithms \tpa and \dpa are comparable, and they are on average
($122.69\%$, $129.08\%$, $131.97\%$, $131.01\%$) and ($121.36\%$, $129.27\%$, $130.11\%$, $126.21\%$)
 of the optimal algorithm \opt on datasets (\ucar, \geolife, \mopsi,
 \act), respectively.}
%
\textcolor{red}{Algorithms \cised and \squishe are on average ($132.07\%$, $139.67\%$,
 $146.56\%$, $135.10\%$) and ($164.47\%$, $189.87\%$, $213.30\%$, $186.72\%$)
 of \opt on datasets (\ucar, \geolife, \mopsi, \act), respectively.}


\sstab (4) The compression ratios of algorithms using \ped are obviously better
than using \sed.
More specifically, the compression ratios of algorithms \optp, \tpa and \dpa
using \ped are on average \textcolor{red}{($42.17\%$, $46.77\%$, $60.37\%$, $40.76\%$),
($42.88\%$, $47.49\%$, $63.15\%$, $38.62\%$) and ($45.17\%$, $50.88\%$,
$64.50\%$, $40.63\%$)} of algorithms \opt, \tpa and \dpa using \sed on datasets (\ucar, \geolife, \mopsi, \act), respectively.
...
\textcolor{red}{($64.62\%$, $64.06\%$, $62.53\%$, $57.40\%$), ($65.03\%$, $63.72\%$, $62.54\%$, $57.95\%$)} of the naive optimal algorithm \opt on datasets (\ucar, \geolife,
\mopsi, \act), respectively.
Algorithms \cised and \squishe are on average \textcolor{red}{($74.06\%$, $75.77\%$, $75.35\%$, $75.81\%$), ($41.75\%$, $38.50\%$, $35.19\%$, $36.90\%$)} of \opt on datasets (\ucar, \geolife, \mopsi, \act), respectively.
