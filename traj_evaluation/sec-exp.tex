...
\begin{figure*}[tb!]
	\centering
	\includegraphics[scale=0.285]{Figures/Exp-CR-epsilon-service.png} 	\hspace{1ex}
	\includegraphics[scale=0.285]{Figures/Exp-CR-epsilon-mopsi.png}		\hspace{1ex}
	\includegraphics[scale=0.285]{Figures/Exp-CR-epsilon-geolife.png}	\hspace{1ex}
	\includegraphics[scale=0.285]{Figures/Exp-CR-epsilon-geolife.png}
	\vspace{-2.5ex}
	\caption{\small Effectiveness evaluation (\ped): varying the error bound $\epsilon$.}
	\label{fig:cr-ped}
	\vspace{-.5ex}
\end{figure*}
...
\begin{figure*}[tb!]
	...
	\includegraphics[scale=0.285]{Figures/Exp-CR-epsilon-geolife.png}
	\vspace{-2.5ex}
	\caption{\small Effectiveness evaluation (\sed): varying the error bound $\epsilon$.}
	\label{fig:cr-sed}
	\vspace{-.5ex}
\end{figure*}
...
\begin{figure*}[tb]
	\centering
  \includegraphics[scale=0.285]{Figures/Exp-error-epsilon-service.png}	\hspace{1ex}
  \includegraphics[scale=0.285]{Figures/Exp-error-epsilon-mopsi.png}	\hspace{1ex}
  \includegraphics[scale=0.285]{Figures/Exp-error-epsilon-geolife.png}	\hspace{1ex}
  \includegraphics[scale=0.285]{Figures/Exp-error-epsilon-geolife.png}
	\vspace{-2ex}
...
\begin{figure*}[tb!]
	\centering
	\includegraphics[scale=0.285]{Figures/Exp-time-epsilon-service.png}	\hspace{1ex}
	\includegraphics[scale=0.285]{Figures/Exp-time-epsilon-mopsi.png}	\hspace{1ex}
	\includegraphics[scale=0.285]{Figures/Exp-time-epsilon-geolife.png}	\hspace{1ex}
	\includegraphics[scale=0.285]{Figures/Exp-time-epsilon-geolife.png}	\hspace{1ex}
	\vspace{-2.5ex}
	\caption{\small Efficiency evaluation (\ped): varying the error bound $\epsilon$.}\label{fig:time-epsilon-ped}
	\vspace{-1ex}
\end{figure*}
...
\begin{figure*}[tb!]
	...
	\includegraphics[scale=0.285]{Figures/Exp-time-epsilon-geolife.png}	\hspace{1ex}
	\vspace{-2.5ex}
	\caption{\small Efficiency evaluation (\sed): varying the error bound $\epsilon$.}\label{fig:time-epsilon-sed}
	\vspace{-1ex}
\end{figure*}
...
\begin{figure*}[tb!]
	...
	\includegraphics[scale=0.285]{Figures/Exp-time-epsilon-geolife.png}	\hspace{1ex}
	\vspace{-2.5ex}
	\caption{\small Efficiency evaluation (\ped): varying the size of trajectories.}\label{fig:time-size-ped}
	\vspace{-1ex}
\end{figure*}
...
\begin{figure*}[tb!]
	...
	\includegraphics[scale=0.285]{Figures/Exp-time-epsilon-geolife.png}	\hspace{1ex}
	\vspace{-2.5ex}
	\caption{\small Efficiency evaluation (\sed): varying the size of trajectories.}\label{fig:time-size-sed}
	\vspace{-1ex}
\end{figure*}
