...
\includegraphics[scale=0.25]{Figures/Exp-CR-epsilon-mopsi.png}
...
\begin{figure*}[tb]
  ...
  \includegraphics[scale=0.25]{Figures/Exp-error-epsilon-mopsi.png}
...
\begin{figure*}[tb!]
  ...
  \includegraphics[scale=0.25]{Figures/Exp-time-epsilon-mopsi.png}
