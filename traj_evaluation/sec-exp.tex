...
Algorithms \tpa, \dpa and \bqsa are comparable, and they are on average \textcolor{red}{($5,5,5,5$)} times slower than the one-pass algorithms \siped and \operb on datasets (\ucar, \geolife, \mopsi, \act), respectively. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\stitle{\textcolor{green}{To do... Summary}}.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
