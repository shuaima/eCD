...
This paper presents experiments and analyses of representative error bounded line simplification algorithms, including both optimal and sub-optimal methods, in terms of commonly adopted perpendicular Euclidean, synchronous Euclidean and direction-aware distances.
Using real-life trajectory datasets, we systematically evaluate and analyze the performance (compression ratio, average error and running time) of error bounded \lsa algorithms with respect to trajectory sizes and error bounds.
Our study reveals the characteristics of error bounded \lsa algorithm, which lead to guidelines for  practitioners to decide which algorithms and distance metrics should be adopted for a specific application.
\end{abstract}
