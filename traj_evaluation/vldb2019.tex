...
Our study reveals the characteristics of error bounded \lsa algorithms, which lead to guidelines for practitioners to choose algorithms and distance metrics for specific applications.
\end{abstract}
