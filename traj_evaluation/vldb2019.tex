...
\vldbAuthors{Xuelian Lin, Jiahao Jiang, Shuai Ma, Yanchen Hou, Tianyu Wo, and Chunming Hu}
...
\author{
\alignauthor
    Xuelian Lin\hspace{1.5ex}  Jiahao Jiang\hspace{1.5ex} Shuai Ma$^{*}$\hspace{1.5ex}  Yanchen Hou\hspace{1.5ex} Tianyu Wo\hspace{1.5ex} Chunming Hu\hspace{1.5ex} \\   %Tianyu Wo\hspace{1.5ex}\\
    ...
    \affaddr{SKLSDE Lab, Beihang University, Beijing, China}\\
     \email{\{linxl, jiangjh, mashuai, houyc, woty, hucm\}@buaa.edu.cn}  %, hucm, woty
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
