...
\begin{theorem}
	\label{theo-aging-dp-dad}
	Given error bounds $\epsilon_1>0$ and $\epsilon_2>0$, the error bound between original trajectory $\dddot{\mathcal{T}}$ and simplified trajectory $\overline{\mathcal{T}}=DP(DP(\dddot{\mathcal{T}}, \epsilon_1, \dad), \epsilon_2, \dad)$ is $\epsilon_1 + \epsilon_2$.
\end{theorem}
