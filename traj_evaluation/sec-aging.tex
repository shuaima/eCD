...
Also note that \dpa is aging friendly on the premise that the second run of \dpa should take as input the whole simplified trajectory produced by the first run, including the same start and end points of trajectories. 
