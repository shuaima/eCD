...
\textcolor{blue}{By Propositions \ref{theo-aging-error-dp} and \ref{theo-aging-distance}, it is obious that all the above algorithms have bounded errors in data aging,  which make us freely re-compress trajectories by any of these algorithm as long as we use the same distance metric.}}
