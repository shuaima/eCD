...
\begin{table}
	...
	\vspace{-1ex}
	\caption{\small Aging friendliness and error bounds of line simplification algorithms}
	...
	\begin{tabular}{|c|c|c|c|}
		...
		{\multirow{2}*{\bf{\dpa}}} &\ped or \sed	&\checkmark  & $\max\{\epsilon_1, \epsilon_2\}$   \\
		\cline{2-4}
		
		&\dad	& $\times$  	& $\epsilon_1 + \epsilon_2$   \\
		\hline
		
		Algorithms other than \dpa	& \ped, \sed or \dad & $\times$  & $\epsilon_1 + \epsilon_2$   \\
		\hline
	\end{tabular}
	\vspace{-2ex}
\end{table}
