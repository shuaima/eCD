...
From the above we can find that only algorithm \dpa is aging friendly, others are not. Indeed, the pretty and rare feature of {aging friendly} is the result of the \textcolor{red}{specific nature} of algorithm \dpa.
