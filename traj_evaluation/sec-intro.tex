...
\textcolor{blue}{Roughly speaking, the quality criteria of \lsa algorithms are two levels, the first level comes from \lsa itself, including compression ratio, efficiency and simplification errors, where 
	(1) \emph{compression ratio} is the percentage of data sizes of the simplified trajectories compared with the original trajectories, 
