...
\lsa algorithms for trajectory compression commonly use two distance metrics of \lsa algorithms, \ie the \emph{perpendicular Euclidean distances} (\ped) and the \emph{synchronous Euclidean distances} (\sed).
...
Moreover, \lsa algorithms can be optimal or sub-optimal. %targeting the ``min-\#" problem\cite{Imai:Optimal,Chan:Optimal},
...
\stitle{Motivations}. The motivations of this work are 4 folds.
%\begin{enumerate}
