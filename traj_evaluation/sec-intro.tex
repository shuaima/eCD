...
%
\textcolor{blue}{They use errors, \ie~\emph{query errors}, to denote the qualities, where query errors are the temporal differs (\eg ``when\_at") or spatial distances (\eg ``where\_at") between the original trajectory and the answer to the queries on the simplified trajectories.}
...
Some new or different findings are summarized in Section \ref{sec-exp-summary}.}
