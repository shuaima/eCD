...
It is worth pointing out that algorithms without error bound, \eg the $n^{th}$ point routine and the routine of random-
selection of points\cite{Shi:Survey}, and algorithms using cumulative error, \eg MRPA that uses the  integral square synchronous
Euclidean distance \cite{Chen:Fast}, are out of the scope.
