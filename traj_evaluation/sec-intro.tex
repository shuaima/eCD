...
%
\mytable{tab:summary-lsa} summarizes the algorithms, which consist of optimal and sub-optimal algorithms, and the later is further classified into batch, online and one-pass algorithms.
