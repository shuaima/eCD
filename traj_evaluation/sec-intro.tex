...
selection of points\cite{Shi:Survey}, and algorithms using cumulative error, \eg MRPA that uses the cumulative distance \cite{Chen:Fast}, are out of the scope.
