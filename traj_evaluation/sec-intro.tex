...
The \lsa algorithms, solving the \emph{min-$\#$} problem \cite{Chan:Optimal, Imai:Optimal,Pavlidis:Segment}, fall into two categories, \ie the \textit{optimal} and \textit{sub-optimal} algorithms. 
