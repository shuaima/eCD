...
\stab (2) Using three real-life trajectory datasets, we systematically evaluate and analyze the performance (compression ratio, average error and efficiency) of error bounded \lsa algorithms in terms of trajectory sizes and error bounds.
%
