...
%
\textcolor{blue}{In this paper, we focus on \lsa algorithms solving the \emph{min-$\#$} problem. For algorithms solving the \emph{min-$\#$} problem \wrt trajectory data, please refer to \cite{Muckell:SQUISH,Muckell:Compression,Zhang:Evaluation}.}
%
