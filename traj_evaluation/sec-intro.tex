...
\myblue{In spite of that, \ped still has its usages, \eg trajectory simplification using \ped often serves as a pre-processing step of trajectory clustering that is the base of applications like traffic pattern recognition and urban planning \cite{Mazimpaka:Mining, Zhao:Clustering}, where rather the shapes of trajectories than the detailed positions of individuals are concerned.}
