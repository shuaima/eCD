...
Using real-life trajectory datasets, we systematically evaluate and analyze the performance (compression ratio, average error, running time, \textcolor{blue}{aging friendliness and query friendliness}) of error bounded line simplification algorithms with respect to \textcolor{blue}{distance metrics,} trajectory sizes and error bounds.
Our study reveals the characteristics of error bounded line simplification algorithms, which lead to guidelines for practitioners to choose algorithms and distance metrics for specific applications.
\end{abstract}
