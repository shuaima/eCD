...
Using real-life trajectory datasets, we systematically evaluate and analyze the performance (compression ratio, average error and running time) of error bounded line simplification algorithms with respect to trajectory sizes and error bounds.
