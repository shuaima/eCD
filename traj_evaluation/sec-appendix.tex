...
\begin{figure}[h]
	\vspace{-1ex}
	\centering
	\includegraphics[scale=0.20]{Figures/Exp-Append-NearOpt-CR-epsilon-service.png}	
	\includegraphics[scale=0.20]{Figures/Exp-Append-NearOpt-CR-epsilon-geolife.png}	
	\includegraphics[scale=0.20]{Figures/Exp-Append-NearOpt-CR-epsilon-mopsi.png}	
	\includegraphics[scale=0.20]{Figures/Exp-Append-NearOpt-CR-epsilon-geolife.png} 
	\vspace{-3ex}
