...
\stitle {Weak simplification of the min-$\#$ problem.}


\stitle {min-$\#$ problem using other error metric.}
...
\stitle {min-$\epsilon$ problem.}
Todo... The minimal $\epsilon$ problem and related work.
