...
The results are reported in Figure~\ref{fig:cr-nopts}. It shows that the compression ratios of algorithm \nopts are on average \textcolor{red}{($110\%$, $110\%$, $110\%$, $110\%$)} of \opt using \sed on datasets (\ucar, \geolife, \mopsi, \act), respectively.
