...
\begin{figure}[h]
	...
	\centering
	\hspace{-2ex}
	\includegraphics[scale=0.21]{Figures/Exp-Append-NearOpt-CR-epsilon-service.png}	
	\includegraphics[scale=0.21]{Figures/Exp-Append-NearOpt-CR-epsilon-geolife.png}		
	\includegraphics[scale=0.21]{Figures/Exp-Append-NearOpt-CR-epsilon-mopsi.png}		
	\includegraphics[scale=0.21]{Figures/Exp-Append-NearOpt-CR-epsilon-geolife.png}		\hspace{-2ex}
	\vspace{-2.5ex}
