...
The results are reported in \mytable{tab:cr-nearOpt}

\begin{table}[h]
	%\vspace{-2ex}
	\caption{\small The effectiveness of near optimal algorithm}
	\centering
	\small
...
\begin{table}[h]
	%\vspace{-2ex}
	\caption{\small The efficiency of the (near) optimal algorithms}
	\centering
	\small
	\begin{tabular}{|l|c|c|c|r|}
		\hline
