...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.25]{Figures/Exp-Append-NearOpt-CR-epsilon-service.png}	
	\includegraphics[scale=0.25]{Figures/Exp-Append-NearOpt-CR-epsilon-geolife.png}	
	\includegraphics[scale=0.25]{Figures/Exp-Append-NearOpt-CR-epsilon-mopsi.png}	
	\includegraphics[scale=0.25]{Figures/Exp-Append-NearOpt-CR-epsilon-geolife.png} 
	\vspace{-2.5ex}
