...
This section reviews two optimal \lsa methods evaluated in our experiments, namely \oped and \osed. We first introduce a naive optimal \lsa algorithm that runs in $O(n^3)$ time, which serves as the foundation of algorithms \oped and \osed. %We then describe those optimized algorithms separately.
