...
An optimal algorithm using \sed can construct the reachability graph $G$ in $O(n^2 \log n)$ time, by using the \textit{spatio-temporal cone intersection} mechanism (See Section~\ref{sec-siped}). 
