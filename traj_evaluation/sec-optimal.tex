...
The checking of intersection of cones is equal to check the intersection of circles on a plane \cite{Lin:Cised}, which can be achieved in $O(n \log n)$ time for $n$ circles~\cite{Shamos:Circle}. 
