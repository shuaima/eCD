...
Algorithms \nopt, \oped and \osed are evaluated in our experiments.
...
\begin{example}
	...
	Figure~\ref{fig:optimal} shows an example of the naive optimal \lsa algorithm using \ped taking as input the trajectory \trajec{T} shown in Figure~\ref{fig:notations}. The reachability graph of trajectory \trajec{T} is constructed and a shortest path with 2 edges is founded. 
