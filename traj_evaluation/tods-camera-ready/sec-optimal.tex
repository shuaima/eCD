...
\begin{figure}[tb!]
	...
	\caption{\small Example of reachability graph of trajectory \trajec{T}$[P_0, \ldots, P_n]$ whose shortest path is $(P_0, P_4, P_{10})$.}	\vspace{-2ex}
	\label{fig:optimal}
\end{figure}
