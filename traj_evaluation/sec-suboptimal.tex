...
(ii) \bqsa\cite{Liu:BQS} and \squishe~\cite{Muckell:SQUISH}, two online algorithms applying the \emph{constrained global checking} policy, %\textcolor[rgb]{1.00,0.00,0.00}{\opwa, \swab  and}
