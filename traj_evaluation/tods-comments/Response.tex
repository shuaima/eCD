...
{Yes, in Wireless Sensor Networks, online algorithms need to addresses the problem of balancing the trade-off between the energy cost due to communication and the accuracy of the trajectories’ detection and representation [r2].}
...
(2) Yes, we have replaced the sentence to ``light and applicable to run on end devices", in Section 1 (the second paragraph). 
