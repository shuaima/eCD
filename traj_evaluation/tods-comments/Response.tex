...
We have included the local integral square SED (LISSED), originally introduced in appendix, and evaluated algorithms OptLISSED, MRPA, DOTS and OLTS that use LISSED as error measure in this paper. 
We have also selected DOTS as the representative of these algorithms, described it in Section 4.2.4,  and tested it in Section 6.
