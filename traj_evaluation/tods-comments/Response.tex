...
Also note that, \emph{the LISSED is rather a special SED-based ``error" measure or a methodology that efficiently calculate SED errors than a kind of ``distance" measure}.
