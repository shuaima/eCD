...
Yes, we have added the \emph{``when\_at"} query in Section 6.3.5. Thanks for your advice!
...
Yes, we have moved the comparisons with [41] to the motivation part. Indeed, the very recent study [41] does evaluate a wide range of trajectory simplification algorithms.
