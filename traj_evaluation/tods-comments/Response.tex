...
(2) Compression ratios: it does report the relationship between compression ratios and average errors (note, they are average errors, not error bounds), however, both the compression ratios and the average errors are not independently tested \wrt error bounds.
...
To clarify this, we have revised the motivation part of the manuscript.
...
Comparing with [41], this work has the following new or different findings: 
...
Yes, we have moved some comparisons with [41] to the motivation part, as follows:

The very recent study [41] does evaluate a wide range of trajectory simplification algorithms.
...
%
{Besides, some important algorithms are not investigated: optimal algorithms using PED and SED and one-pass algorithms SIPED and CISED are not investigated in [41]. 
%
