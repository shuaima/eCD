...
Given a trajectory and an error bound, the ''min-\# problem" of trajectory simplification is to get the minimal number of data points of the trajectory that represents the original trajectory under the constrain of the error bound.

We have added this explanation to Section 1 (second paragraph). Thanks for pointing out this!
