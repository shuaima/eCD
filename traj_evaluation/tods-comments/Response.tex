...
The paper has been substantially revised according to the comments of you, Dr. Seeger and referees. In particular, we have added{
	...
	(c) experimental studies on query friendliness \wrt ``when\_at" query, 
...
Note that map-matching is not considered as a pre-processing step of trajectory simplification, the reasons please refer to {[R1C3]}.
