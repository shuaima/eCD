...
\begin{figure*}[tb!]
  ...
  \hspace{-3ex}
  \subfigure[YouTube]{\label{fig_exp_1_1_k_acc_youtube}\includegraphics[width= 1.8in]{eps-script/1-1-a.eps} }
  \hspace{-3ex}
  \subfigure[Flickr]{\label{fig_exp_1_1_k_acc_flickr}\includegraphics[width= 1.8in]{eps-script/1-1-b.eps}}
  \hspace{-3ex}
  \subfigure[Wikipedia]{\label{fig_exp_1_1_k_acc_wikipedia}\includegraphics[width= 1.8in]{eps-script/1-1-c.eps} }
  \subfigure[Digg]{\label{fig_exp_1_1_k_time_digg}\includegraphics[width= 1.8in]{eps-script/1-1-d.eps} }
  \hspace{-3ex}
  \subfigure[YouTube]{\label{fig_exp_1_1_k_time_youtube}\includegraphics[width= 1.8in]{eps-script/1-1-d.eps} }
  \hspace{-3ex}
  \subfigure[Flickr]{\label{fig_exp_1_1_k_time_flickr}\includegraphics[width=  1.8in]{eps-script/1-1-e.eps}}
  \hspace{-3ex}
  \subfigure[Wikipedia]{\label{fig_exp_1_1_k_time_wikipedia}\includegraphics[width= 1.8in]{eps-script/1-1-f.eps}}
  \vspace{-2ex}
...
\begin{figure*}[tb!]
  ...
  \hspace{-3ex}
  \subfigure[YouTube]{\label{fig_exp_1_2_size_acc_youtube}\includegraphics[width= 1.8in]{eps-script/1-2-a.eps}}
  \hspace{-3ex}
  \subfigure[Flickr]{\label{fig_exp_1_2_size_acc_flickr}\includegraphics[width= 1.8in]{eps-script/1-2-b.eps}}
  \hspace{-3ex}
  \subfigure[Wikipedia]{\label{fig_exp_1_2_size_acc_wikipedia}\includegraphics[width= 1.8in]{eps-script/1-2-c.eps}}
  \subfigure[Digg]{\label{fig_exp_1_2_size_time_digg}\includegraphics[width= 1.8in]{eps-script/1-2-d.eps}}
  \hspace{-3ex}
  \subfigure[YouTube]{\label{fig_exp_1_2_size_time_youtube}\includegraphics[width= 1.8in]{eps-script/1-2-d.eps}}
  \hspace{-3ex}
  \subfigure[Flickr]{\label{fig_exp_1_2_size_time_flickr}\includegraphics[width= 1.8in]{eps-script/1-2-e.eps}}
  \hspace{-3ex}
  \subfigure[Wikipedia]{\label{fig_exp_1_2_size_time_wikipedia}\includegraphics[width= 1.8in]{eps-script/1-2-f.eps}}
...
\begin{figure*}[tb!]
  ...
  \hspace{-3ex}
  \subfigure[YouTube]{\label{fig_exp_2_1_k_acc_youtube}\includegraphics[width= 1.8in]{eps-script/2-1-a.eps} }
  \hspace{-3ex}
  \subfigure[Flickr]{\label{fig_exp_2_1_k_acc_flickr}\includegraphics[width= 1.8in]{eps-script/2-1-b.eps}}
  \hspace{-3ex}
  \subfigure[Wikipedia]{\label{fig_exp_2_1_k_acc_wikipedia}\includegraphics[width= 1.8in]{eps-script/2-1-c.eps} }
  \subfigure[Digg]{\label{fig_exp_2_1_k_time_digg}\includegraphics[width= 1.8in]{eps-script/2-1-d.eps} }
  \hspace{-3ex}
  \subfigure[YouTube]{\label{fig_exp_2_1_k_time_youtube}\includegraphics[width= 1.8in]{eps-script/2-1-d.eps} }
  \hspace{-3ex}
  \subfigure[Flickr]{\label{fig_exp_2_1_k_time_flickr}\includegraphics[width=  1.8in]{eps-script/2-1-e.eps}}
  \hspace{-3ex}
  \subfigure[Wikipedia]{\label{fig_exp_2_1_k_time_wikipedia}\includegraphics[width= 1.8in]{eps-script/2-1-f.eps}}
  \vspace{-2ex}
...
\begin{figure*}[tb!]
  ...
  \hspace{-3ex}
  \subfigure[YouTube]{\label{fig_exp_2_2_size_acc_youtube}\includegraphics[width= 1.8in]{eps-script/2-2-a.eps}}
  \hspace{-3ex}
  \subfigure[Flickr]{\label{fig_exp_2_2_size_acc_flickr}\includegraphics[width= 1.8in]{eps-script/2-2-b.eps}}
  \hspace{-3ex}
  \subfigure[Wikipedia]{\label{fig_exp_2_2_size_acc_wikipedia}\includegraphics[width= 1.8in]{eps-script/2-2-c.eps}}
  \subfigure[Digg]{\label{fig_exp_2_2_size_time_digg}\includegraphics[width= 1.8in]{eps-script/2-2-d.eps}}
  \hspace{-3ex}
  \subfigure[YouTube]{\label{fig_exp_2_2_size_time_youtube}\includegraphics[width= 1.8in]{eps-script/2-2-d.eps}}
  \hspace{-3ex}
  \subfigure[Flickr]{\label{fig_exp_2_2_size_time_flickr}\includegraphics[width= 1.8in]{eps-script/2-2-e.eps}}
  \hspace{-3ex}
  \subfigure[Wikipedia]{\label{fig_exp_2_2_size_time_wikipedia}\includegraphics[width= 1.8in]{eps-script/2-2-f.eps}}
  \hspace{-3ex}
...
\begin{figure*}[tb!]
  ...
  \hspace{-3ex}
  \subfigure[YouTube]{\label{fig_exp_3_mu_acc_youtube}\includegraphics[width= 1.8in]{eps-script/3-1-a.eps}}
  \hspace{-3ex}
  \subfigure[Flickr]{\label{fig_exp_3_mu_acc_flickr}\includegraphics[width=1.8in]{eps-script/3-1-b.eps}}
  \hspace{-3ex}
  \subfigure[Wikipedia]{\label{fig_exp_3_mu_acc_wikipedia}\includegraphics[width=1.8in]{eps-script/3-1-c.eps}}
  \subfigure[Digg]{\label{fig_exp_3_mu_time_digg}\includegraphics[width=1.8in]{eps-script/3-1-d.eps}}
  \hspace{-3ex}
  \subfigure[YouTube]{\label{fig_exp_3_mu_time_youtube}\includegraphics[width=1.8in]{eps-script/3-1-d.eps}}
  \hspace{-3ex}
  \subfigure[Flickr]{\label{fig_exp_3_mu_time_flickr}\includegraphics[width=1.8in]{eps-script/3-1-e.eps}}
  \hspace{-3ex}
  \subfigure[Wikipedia]{\label{fig_exp_3_mu_time_wikipedia}\includegraphics[width=1.8in]{eps-script/3-1-f.eps}}
  \vspace{-2ex}
...
\begin{figure*}[tb!]
  ...
  \hspace{-3ex}
  \subfigure[YouTube]{\label{fig_exp_3_f_acc_youtube}\includegraphics[width= 1.8in]{eps-script/3-2-a.eps} }
  \hspace{-3ex}
  \subfigure[Flickr]{\label{fig_exp_3_f_acc_flickr}\includegraphics[width= 1.8in]{eps-script/3-2-b.eps} }
  \hspace{-3ex}
  \subfigure[Wikipedia]{\label{fig_exp_3_f_acc_wikipedia}\includegraphics[width= 1.8in]{eps-script/3-2-c.eps} }
  \subfigure[Digg]{\label{fig_exp_3_f_time_digg}\includegraphics[width= 1.8in]{eps-script/3-2-d.eps} }
  \hspace{-3ex}
  \subfigure[YouTube]{\label{fig_exp_3_f_time_youtube}\includegraphics[width= 1.8in]{eps-script/3-2-d.eps} }
  \hspace{-3ex}
  \subfigure[Flickr]{\label{fig_exp_3_f_time_flickr}\includegraphics[width= 1.8in]{eps-script/3-2-e.eps}}
  \hspace{-3ex}
  \subfigure[Wikipedia]{\label{fig_exp_3_f_time_wikipedia}\includegraphics[width= 1.8in]{eps-script/3-2-f.eps}}
  \vspace{-2ex}
...
\begin{figure*}[tb!]
  ...
  \hspace{-3ex}
  \subfigure[YouTube]{\label{fig_exp_3_s_acc_youtube}\includegraphics[width= 1.8in]{eps-script/3-3-a.eps} }
  \hspace{-3ex}
  \subfigure[Flickr]{\label{fig_exp_3_s_acc_flickr}\includegraphics[width= 1.8in]{eps-script/3-3-b.eps} }
  \hspace{-3ex}
  \subfigure[Wikipedia]{\label{fig_exp_3_s_acc_wikipedia}\includegraphics[width= 1.8in]{eps-script/3-3-c.eps} }
  \subfigure[Digg]{\label{fig_exp_3_s_time_digg}\includegraphics[width= 1.8in]{eps-script/3-3-d.eps} }
  \hspace{-3ex}
  \subfigure[YouTube]{\label{fig_exp_3_s_time_youtube}\includegraphics[width= 1.8in]{eps-script/3-3-d.eps} }
  \hspace{-3ex}
  \subfigure[Flickr]{\label{fig_exp_3_s_time_flickr}\includegraphics[width= 1.8in]{eps-script/3-3-e.eps}}
  \hspace{-3ex}
  \subfigure[Wikipedia]{\label{fig_exp_3_s_time_wikipedia}\includegraphics[width= 1.8in]{eps-script/3-3-f.eps}}
  \vspace{-2ex}
...
\begin{figure*}[tb!]
  ...
  \hspace{-3ex}
  \subfigure[YouTube]{\label{fig_exp_3_r_acc_youtube}\includegraphics[width= 1.8in]{eps-script/3-4-a.eps} }
  \hspace{-3ex}
  \subfigure[Flickr]{\label{fig_exp_3_r_acc_flickr}\includegraphics[width= 1.8in]{eps-script/3-4-b.eps} }
  \hspace{-3ex}
  \subfigure[Wikipedia]{\label{fig_exp_3_r_acc_wikipedia}\includegraphics[width= 1.8in]{eps-script/3-4-c.eps} }
  \subfigure[Digg]{\label{fig_exp_3_r_time_digg}\includegraphics[width= 1.8in]{eps-script/3-4-d.eps} }
  \hspace{-3ex}
  \subfigure[YouTube]{\label{fig_exp_3_r_time_youtube}\includegraphics[width= 1.8in]{eps-script/3-4-d.eps} }
  \hspace{-3ex}
  \subfigure[Flickr]{\label{fig_exp_3_r_time_flickr}\includegraphics[width= 1.8in]{eps-script/3-4-e.eps}}
  \hspace{-3ex}
  \subfigure[Wikipedia]{\label{fig_exp_3_r_time_wikipedia}\includegraphics[width= 1.8in]{eps-script/3-4-f.eps}}
  \vspace{-2ex}
...
\begin{figure*}[tb!]
  ...
  \hspace{-3ex}
  \subfigure[YouTube]{\label{fig_exp_3_e_acc_youtube}\includegraphics[width= 1.8in]{eps-script/3-5-a.eps} }
  \hspace{-3ex}
  \subfigure[Flickr]{\label{fig_exp_3_e_acc_flickr}\includegraphics[width= 1.8in]{eps-script/3-5-b.eps} }
  \hspace{-3ex}
  \subfigure[Wikipedia]{\label{fig_exp_3_e_acc_wikipedia}\includegraphics[width= 1.8in]{eps-script/3-5-c.eps} }
  \subfigure[Digg]{\label{fig_exp_3_e_time_digg}\includegraphics[width= 1.8in]{eps-script/3-5-d.eps} }
  \hspace{-3ex}
  \subfigure[YouTube]{\label{fig_exp_3_e_time_youtube}\includegraphics[width= 1.8in]{eps-script/3-5-d.eps} }
  \hspace{-3ex}
  \subfigure[Flickr]{\label{fig_exp_3_e_time_flickr}\includegraphics[width= 1.8in]{eps-script/3-5-e.eps}}
  \hspace{-3ex}
  \subfigure[Wikipedia]{\label{fig_exp_3_e_time_wikipedia}\includegraphics[width= 1.8in]{eps-script/3-5-f.eps}}
  \vspace{-2ex}
