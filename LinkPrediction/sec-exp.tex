...
\begin{figure}[tb!]
  ...
  \vspace{1ex}
  % Requires \usepackage{graphicx}
  \subfigure[]{\label{fig_exp_3_r_acc_flickr}\includegraphics[width= 1.6in]{eps-script/3-4-d.eps} }  
  \hspace{1ex}
  \subfigure[]{\label{fig_exp_2_k_acc_flickr}\includegraphics[width= 1.6in]{eps-script/2-1-d.eps} }
  \vspace{-2ex}
...
methods with the top-$(\epsilon, k)$ speeding up and edge sampling techniques,
