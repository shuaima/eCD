...
vs. their counterparts bagging methods with only node sampling technique \cite{liang2016},
...
\marked{ \Node with the top-$(\epsilon, k)$ speeding up and edge sampling techniques (\Nodep),
\Edge with the top-$(\epsilon, k)$ speeding up and edge sampling techniques (\Edgep) and
\Biased with the top-$(\epsilon, k)$ speeding up and edge sampling techniques (\Biasedp)}
...
and Biased Edge Bagging) with edge sampling.}
