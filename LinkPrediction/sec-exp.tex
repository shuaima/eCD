...
\begin{figure*}[tb!]
  ...
  \vspace{1ex}
  % Requires \usepackage{graphicx}
  \subfigure[Digg]{\label{fig_exp_3_s_acc_digg}\includegraphics[width= 1.8in, height=1.2in]{eps-script/3-3-a.eps} }
  \quad\quad
  \subfigure[YouTube]{\label{fig_exp_3_s_acc_youtube}\includegraphics[width= 1.8in, height=1.2in]{eps-script/3-3-b.eps} }
  \quad\quad
  \subfigure[Wikipedia]{\label{fig_exp_3_s_acc_wikipedia}\includegraphics[width= 1.8in, height=1.2in]{eps-script/3-3-c.eps} }
  \subfigure[Digg]{\label{fig_exp_3_s_time_digg}\includegraphics[width= 1.8in, height=1.2in]{eps-script/3-3-e.eps} }
  \quad\quad
  \subfigure[YouTube]{\label{fig_exp_3_s_time_youtube}\includegraphics[width= 1.8in, height=1.2in]{eps-script/3-3-f.eps} }
  \quad\quad
  \subfigure[Wikipedia]{\label{fig_exp_3_s_time_wikipedia}\includegraphics[width= 1.8in, height=1.2in]{eps-script/3-3-g.eps}}
  \vspace{-2ex}
