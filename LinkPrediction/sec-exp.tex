...
node uptake and edge filter techniques (denoted as bagging+ methods)
vs. their counterparts bagging methods with only node uptake technique \cite{liang2016},
...
$\rho$   & \marked{\tabincell{l}{Fraction of the number of edges to be\\
...
\marked{ \Node with top-$(\epsilon, k)$ speeding up and edge filter (\Nodep),
