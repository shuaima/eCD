...
Finally, we have experimentally verified that our ensemble-enabled approach is much more effectice and scalable than existing methods, \eg~direct \NMF, \Aa \cite{adamic}, \RA \cite{zhou2009} and \BIGCLAM \cite{yang-wsdm2013}.
