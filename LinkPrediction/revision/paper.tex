...
Finally, we have experimentally verified that our ensemble-enabled approach is much more accurate and scalable than existing methods, \eg~direct \NMF, \Aa \cite{adamic} and \BIGCLAM \cite{yang-wsdm2013}. \marked{One thing should be noted that the proposed ensemble-enabled approach is not only designed for \NMF, but also applied to any link prediction methods. }
