...
Note that \RA is very similar to \Aa when $|N(z)|$ is small, but
 ...
 \RA performs better than \Aa in the networks with high degree heterogeneity since
...
\marked{Since \RA is suitable for high degree heterogeneity networks \cite{zhou2009},
it performs the best on \Wikipedia which contains some extreme high degree nodes.}
...
links in high-distance regions as well as in short distance.}
...
\marked{more robust than \Aa, \RA and \BIGCLAM. }
...
$1.0\times 10^9$ edges, \marked{while \NMF, \Aa, \RA  and \BIGCLAM could not finish in a day.
Further, \Biasedp speeds up \Biased, \NMF, \Aa, \RA and \BIGCLAM
...
bagging methods also provide the \marked{robustness} advantages for link prediction,
