...
\begin{figure*}[tb!]
  ...
  \vspace{-1ex}
  \caption{Bagging+ vs. Bagging on accuracy and efficiency:  with respect to the number $k$ of predicted links.}\label{fig_exp_1_1}
  \vspace{-2ex}
\end{figure*}
...
\sstab  (2) \Resource \cite{zhou2009}: Algorithm \RA is another
...
\begin{figure*}[tb!]
  ...
  \vspace{-1ex}
  \caption{Accuracy and efficiency comparison with \Aa, \RA and \BIGCLAM: with respect to the number $k$ of predicted links.}\label{fig_exp_2_1}
  \vspace{-2ex}
\end{figure*}
...
\stitle{Exp-1.1: Performance improvements of bagging+ methods}. To evaluate the
...
\subfigure[YouTube]{\label{fig_exp_2_2_size_time_youtube}\includegraphics[width= 1.8in, height=1.2in]{eps-script/2-2-f.eps}}
  ...
  \vspace{-1ex}
  \caption{Accuracy and efficiency comparison with \Aa, \RA and \BIGCLAM: with respect to the network sizes.}\label{fig_exp_2_2}
  \vspace{-2ex}
\end{figure*}
...
%\marked{Moreover, the comparison of accuracy together with its 95\% confidence intervals when $k$ is fixed to its default value is shown in Table \ref{tab_accuracy}.}

The accuracy results tell us that (a) \Biased outperforms other methods on all datasets except \Wikipedia, (b) the accuracy of \Biasedp is very close to that of \Biased, (c) both \Biased and \Biasedp have a higher accuracy than \Aa, \RA and \BIGCLAM, except \RA on \Wikipedia,
...
Indeed, when $k$ is the default value, \Biased improves the accuracy by $(2.5\%, 41.4\%, 113.4\%, 34.1\%)$, $(7.5\%, 45.2\%,$ $ 38.2\%, 46.2\%)$
...
\begin{figure*}[tb!]
  ...
  \vspace{-1ex}
  \caption{Accuracy and efficiency comparison: with respect to the fraction $f$, the fraction $\rho$, the number $r$ of latent factors and
   the tolerant $\epsilon$ of top-($\epsilon, k$) prediction.}\label{fig_exp_3}
  \vspace{-2ex}
\end{figure*}
...
%more accurate than \Aa and \BIGCLAM, which verifies the \marked{robustness} of \NMF.
