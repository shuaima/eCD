...
\marked{Moreover, we also report the accuracy together with its $95\%$ confidence intervals
 in Table \ref{tab_accuracy}.}
...
\hline
\Node & 4.91 $\pm$ (0.059)	& 2.26 $\pm$ (0.124)	& 2.28 $\pm$ (0.056) \\
\Edge & 4.94 $\pm$ (0.115)	& 2.27 $\pm$ (0.034)	& 2.28 $\pm$ (0.034) \\
\Biased & \textbf{4.95 $\pm$ (0.076)}	& \textbf{2.28 $\pm$ (0.159)}	& \textbf{2.31 $\pm$ (0.038)} \\
\hline
\Nodep & 4.92 $\pm$ (0.058)	& 2.15 $\pm$ (0.074)	& 2.25 $\pm$ (0.062) \\
\Edgep & 4.94 $\pm$ (0.047)	& 2.17 $\pm$ (0.078)	& 2.25 $\pm$ (0.014) \\
\Biasedp & \textbf{4.95 $\pm$ (0.096)}	& \textbf{2.25 $\pm$ (0.112)}	& \textbf{2.33 $\pm$ (0.045)} \\
\hline \hline
\end{tabular}
\vspace{-2ex}
\end{table}
...
\marked{The comparison of accuracy together with its 95\% confidence intervals is shown
in Table \ref{tab_accuracy}.}
...
\marked{Since \RA is suitable for high average degree networks \cite{zhou2009}, it performs best on \Wikipedia
which has the largest average degree.}
