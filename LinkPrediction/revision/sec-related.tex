...
\cite{propflow,chen2015} typically treat link prediction as a classification problem, \eg supervised matrix factorization and random walk based approaches \cite{menon,back}.
...
graph streams \cite{zhao2016} and signed networks \cite{song2015kdd}. Some optimizing methods for link recommendation have been proposed to improve the precision at the top of the recommending list \cite{song2015} \marked{ and the link predictability has been discussed in \cite{lv2015}}.
