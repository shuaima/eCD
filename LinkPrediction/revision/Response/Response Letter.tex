...
We have added this survey in the introduction (Section 1) and in the related work (Section 5). Thanks!
...
top-$(\epsilon, k)$ prediction in Section 2.1. Thanks!
...
Moveover, we have removed the proof of Proposition 2. Thanks for the suggestion!
...
Thus, we did not cite the recommended paper directly. Thanks!
...
predicting future links that split by timestamps rather than missing links 
that selected randomly from the network as the testing set [17][24].
...
the link predictability [30] in the related work (Section 5). For the lack of space,
we have cited the surveys [17][31] that introduce the rest.
