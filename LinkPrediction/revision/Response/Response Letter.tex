...
the link predictability [30] in the related work. For the lack of space,
...
in our experiments are more sparse than that used in [S1], which means that it
...
the default values for $k$ in the experimental study according to [35][39].
