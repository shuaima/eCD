...
on most datasets. Even when $k$ is the number of the ground truth links, \Biased improves
...
\sstab (2) 
However, although our ensemble-enabled approach is a general framework that may be applied to any link prediction
methods, the  sampling techniques for generating ensembles should be redesigned for different link prediction
methods, such as \Aa and \RA, to fully employ the advantage of the ensemble-enabled framework for link prediction. 
