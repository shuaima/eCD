...
In the first set of tests, we evaluated the effectiveness and efficiency of our
...
\stitle{Exp-4.2: Impacts of network sizes}. To evaluate the impacts of
...
\begin{figure*}[tb!]
  ...
  \vspace{-1ex}
  \caption{Accuracy and efficiency comparison: with respect to the number $k$ of predicted links.}\label{fig_exp_4_1}
  \vspace{-1ex}
\end{figure*}
...
\begin{figure*}[tb!]
  ...
  \quad\quad
  \subfigure[YouTube]{\label{fig_exp_4_2_size_acc_youtube}\includegraphics[width= 1.8in, height=1.2in]{eps-script/4-2-a.eps} }
  \quad\quad
  \subfigure[Wikipedia]{\label{fig_exp_4_2_size_acc_wikipedia}\includegraphics[width= 1.8in, height=1.2in]{eps-script/4-2-a.eps} }
  \subfigure[Digg]{\label{fig_exp_4_2_size_time_digg}\includegraphics[width= 1.8in, height=1.2in]{eps-script/4-2-e.eps} }
  \quad\quad
  \subfigure[YouTube]{\label{fig_exp_4_2_size_time_youtube}\includegraphics[width= 1.8in, height=1.2in]{eps-script/4-2-e.eps} }
  \quad\quad
  \subfigure[Wikipedia]{\label{fig_exp_4_2_size_time_wikipedia}\includegraphics[width= 1.8in, height=1.2in]{eps-script/4-2-e.eps}}
  \vspace{-1ex}
  \caption{Accuracy and efficiency comparison: with respect to the network sizes.}\label{fig_exp_4_2}
  \vspace{-1ex}
\end{figure*}
...
\begin{figure*}[tb!]
  ...
  \vspace{-1ex}
  \caption{Accuracy and efficiency comparison: with respect to the number $k$ of predicted links.}\label{fig_exp_5_1}
  \vspace{-1ex}
\end{figure*}
...
\begin{figure*}[tb!]
  ...
  %\vspace{-2ex}
  % Requires \usepackage{graphicx}
  \subfigure[Digg]{\label{fig_exp_5_2_size_acc_digg}\includegraphics[width= 1.8in, height=1.2in]{eps-script/4-2-a.eps} }
  \quad\quad
  \subfigure[YouTube]{\label{fig_exp_5_2_size_acc_youtube}\includegraphics[width= 1.8in, height=1.2in]{eps-script/4-2-a.eps} }
  \quad\quad
  \subfigure[Wikipedia]{\label{fig_exp_5_2_size_acc_wikipedia}\includegraphics[width= 1.8in, height=1.2in]{eps-script/4-2-a.eps} }
  \subfigure[Digg]{\label{fig_exp_5_2_size_time_digg}\includegraphics[width= 1.8in, height=1.2in]{eps-script/4-2-e.eps} }
  \quad\quad
  \subfigure[YouTube]{\label{fig_exp_5_2_size_time_youtube}\includegraphics[width= 1.8in, height=1.2in]{eps-script/4-2-e.eps} }
  \quad\quad
  \subfigure[Wikipedia]{\label{fig_exp_5_2_size_time_wikipedia}\includegraphics[width= 1.8in, height=1.2in]{eps-script/4-2-e.eps}}
  \vspace{-1ex}
  \caption{Accuracy and efficiency comparison: with respect to the network sizes.}\label{fig_exp_5_2}
  \vspace{-1ex}
\end{figure*}
...
Exp-4.2, we evaluated the impacts of network sizes.
The results of accuracy and running time are reported in Figures \ref{fig_exp_5_2_size_acc_digg} -- \ref{fig_exp_5_2_size_acc_wikipedia}
...
than other methods on most of the datasets, (b) \Biasedp performs
as well as it counterpart \Biased, and (c) \NMF has a higher accuracy
then \Aa, \RA and \BIGCLAM on most of the datasets. This verifies the
effectiveness of our methods.

The running time results tell us that (a) \Biasedp is the fastest 
method compared with other methods, (b) the bagging+ and bagging 
methods are faster than other methods, and (c) the running time of all methods increase
with the increase of network sizes. This is consistent with the conclusion
in Exp-2.2 and also verifies the efficiency of our methods.
...
\begin{figure*}[tb!]
  ...
  \vspace{-1ex}
  \caption{Accuracy and efficiency comparison: with respect to the number $k$ of predicted links.}\label{fig_exp_7_1}
  \vspace{-1ex}
\end{figure*}
...
\begin{figure*}[tb!]
  ...
  \vspace{-1ex}
  \caption{Accuracy and efficiency comparison: with respect to the network sizes.}\label{fig_exp_7_2}
  \vspace{-1ex}
\end{figure*}
...
fixed $k$ to the number of links in the ground truth data
and fixed other parameters to their default values. 
The results of accuracy and running time are reported in \ref{fig_exp_7_2_size_acc_digg}--\ref{fig_exp_7_2_size_acc_wikipedia}
...
This means that the ensemble-enabled methods are also accurate and robust 
with the increase of network sizes.

The running time results tell us that (a) the ensemble-enabled methods are 
...
which verifies the efficiency of our ensemble-enabled approach.
