...
As a result, the running time of \CFDs is higher than \pCFDs on \hosp, but close to \pCFDs on \dblp.
...
As a result, the running time of \CINDs is close to \pCFDs on \hosp, but is lower on \dblp.
