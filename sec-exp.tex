...
(2) DBLP \textit{data} is from the DBLP Bibliography\footnote{http://dblp.uni-trier.de/xml/}. We first transformed the XML data into four tables: \at{author}, \at{pub}, \at{proceedings}, \at{homepage}. We then create a table \at{wrote} by.

We designed \pCFDs and \pCINDs for the DBLP data, shown below.\\
$\psi _1$: \at{pub}(\at{crossref}, \at{year}; \at{record}='inproceedings') $\subseteq$ \at{proceedings}(\at{key}, \at{year}; nil);\\
