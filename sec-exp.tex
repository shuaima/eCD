...
\begin{figure*}[tb!]
  ...
  \caption{Efficiency of detecting violations: \pCFDs vs. \CFDs}\label{fig_exp1_cfdp}
\end{figure*}
...
For easy of comparison, we deliberately dirty the tuples in \at{hcahps} of \hosp or  \at{paper} of \dblp so that using the \pCFDs and \pCINDs togetehr can detect all the dirty tuples. A clean copy of \hosp and \dblp is also kept to tell whether a tuple is dirty or clean.
...
\begin{figure*}[tb!]
  ...
  \caption{Effectiveness of detecting violations: \pCFDs vs. \CFDs}\label{fig_exp2_cfdp}
\end{figure*}
\begin{figure*}[tb!]
  \centering
  % Requires \usepackage{graphicx}
  ...
  \caption{Effectiveness of detecting violations: \pCINDs vs. \CINDs}\label{fig_exp2_cindp}
\end{figure*}
\begin{figure*}[tb!]
  \centering
  % Requires \usepackage{graphicx}
  ...
  \caption{{Effectiveness of detecting violations: \pCFDs + \pCINDs  vs. \CFDs + \CINDs }}\label{fig_exp2_both}
\end{figure*}

\stitle{Exp-1.3:  \pCFDs + \pCINDs vs. \CFDs + \CINDs}.
Using the same setting as {Exp-1.2}, we evaluate the impacts of $|I_1|$, $|I_2|$ and $noise\%$. The results are reported in Figures~\ref{fig_exp1_both_hosp_I1} and \ref{fig_exp1_both_dblp_I1}, Figures~\ref{fig_exp1_both_hosp_I2} and \ref{fig_exp1_both_dblp_I2} and Figures~\ref{fig_exp1_both_hosp_noise} and \ref{fig_exp1_both_dblp_noise}, respectively. The results show similar findings to {Exp-1.1} and {Exp-1.2}, and are consistent with them.
...
\setitle{Exp-2.1: \pCFDs vs. \CFDs}.

\ni(1) To evaluate the impacts of $|I_1|$, we used the same setting as {Exp-1.1}.(1). The results are reported in Figures~\ref{fig_exp2_cfdp_hosp_I1} and \ref{fig_exp2_cfdp_dblp_I1}, respectively.


\ni(2) To evaluate the impacts of $noise\%$, we used the same setting as {Exp-1.1}.(2).  The results are reported in Figures~\ref{fig_exp2_cfdp_hosp_noise} and \ref{fig_exp2_cfdp_dblp_noise}, respectively.



\setitle{Exp-2.2: \pCINDs vs. \CINDs}.


\ni(1) To evaluate the impacts of $|I_1|$, we used the same setting as {Exp-1.2}.(1).  The results are reported in Figures~\ref{fig_exp2_cindp_hosp_I1} and \ref{fig_exp2_cindp_dblp_I1}, respectively.

\ni(2) To evaluate the impacts of $noise\%$, we used the same setting as {Exp-1.2}.(2). The results are reported in Figures~\ref{fig_exp2_cindp_hosp_noise} and \ref{fig_exp2_cindp_dblp_noise}, respectively.





\setitle{Exp-2.3:  \pCFDs + \pCINDs vs. \CFDs + \CINDs}.


\ni(1) To evaluate the impacts of $|I_1|$, we used the same setting as {Exp-2.2}.(1).  The results are reported in Figures~\ref{fig_exp2_both_hosp_I1} and \ref{fig_exp2_both_dblp_I1}, respectively.

\ni(2) To evaluate the impacts of $noise\%$, we used the same setting as {Exp-2.2}.(2). The results are reported in Figures~\ref{fig_exp2_both_hosp_noise} and \ref{fig_exp2_both_dblp_noise}, respectively.
...
\begin{table*}[tbh!]
%\vspace{-2ex}
 \caption{Effectiveness of detecting violations}
