...
\begin{figure*}[tb!]
  ...
  \centering
  \subfigure[Varying $|I_{1}|$ for HOSP]{\epsfig{file=exp-fig/41a.eps}}
  \quad
  \subfigure[Varying $noise\%$ for HOSP]{\epsfig{file=exp-fig/41b.eps}}
  \quad
  \subfigure[Varying $|I_{1}|$ for DBLP]{\epsfig{file=exp-fig/41c.eps}}
  \quad
  \subfigure[Varying $noise\%$ for DBLP]{\epsfig{file=exp-fig/41d.eps}}
...
\begin{figure*}[tb!]
  ...
  % Requires \usepackage{graphicx}
  \centering
  \subfigure[Varying $|I_{1}|$ for HOSP]{\epsfig{file=exp-fig/42a.eps}}
  \quad
  \subfigure[Varying $noise\%$ for HOSP]{\epsfig{file=exp-fig/42b.eps}}
  \quad
  \subfigure[Varying $|I_{1}|$ for DBLP]{\epsfig{file=exp-fig/42c.eps}}
  \quad
  \subfigure[Varying $noise\%$ for DBLP]{\epsfig{file=exp-fig/42d.eps}}
...
\begin{figure*}[tb!]
  \centering
  % Requires \usepackage{graphicx}
  \subfigure[Varying $|I_{1}|$ for HOSP]{\epsfig{file=exp-fig/43a.eps}}
  \quad
  \subfigure[Varying $noise\%$ for HOSP]{\epsfig{file=exp-fig/43b.eps}}
  \quad
  \subfigure[Varying $|I_{1}|$ for DBLP]{\epsfig{file=exp-fig/43c.eps}}
  \quad
  \subfigure[Varying $noise\%$ for DBLP]{\epsfig{file=exp-fig/43d.eps}}
